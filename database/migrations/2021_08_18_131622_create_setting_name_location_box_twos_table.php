...
class CreateSettingNameLocationBoxTwosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('setting_name_location_box_twos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('setting_name_location_box_twos');
    }
}
