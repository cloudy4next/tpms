...
class CreateLedgerListsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ledger_lists', function (Blueprint $table) {
            $table->id();
            $table->integer('admin_id')->nullable();
            $table->integer('batching_id')->nullable();
            $table->integer('processing_claim_id')->nullable();
            ...
            $table->integer('has_manage_claim')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('ledger_lists');
    }
}
