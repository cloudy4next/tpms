...
class CreateManageClaimTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('manage_claim_transactions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('manage_claim_transactions');
    }
}
