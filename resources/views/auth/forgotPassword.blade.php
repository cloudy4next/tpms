        ...
        <div class="row no-gutters">
            ...
            <div class="col-md-6">
                <div class="sign-in-from">
                    ...
                    @endif
                    <form class="needs-validation mt-3" action="{{route('user.forgot.password.email.submit')}}"
                          method="post" novalidate>
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputEmail1">Please enter the email you created your account
                                with.</label>
