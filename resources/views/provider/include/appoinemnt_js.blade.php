<script>
    ...
    function sc_fetch_clients(){
        ...
        $.ajax({
            type: "POST",
            url: "{{route('provider.get.all.client')}}",
            data: {
                '_token': "{{csrf_token()}}",
            },
    ...
    function sc_fetch_providers(){
        ...
        $.ajax({
            type: "POST",
            url: "{{route('provider.session.get.all.provider')}}",
            data: {
                '_token': "{{csrf_token()}}",
            },
            success: function (data) {
    ...
    function sc_fetch_nb_providers(){
        ...
        $.ajax({
            type: "POST",
            url: "{{route('provider.get.all.employee')}}",
            data: {
                '_token': "{{csrf_token()}}",
            },
            success: function (data) {
    ...
    function sc_fetch_auths(){
        ...
        $.ajax({
            ...
            type: "POST",
            url: "{{route('provider.session.autho.get')}}",
            data: {
                '_token': "{{csrf_token()}}",
                'client_id': sc_c_id,
            },
    ...
    function sc_fetch_act(){
        ...
        $.ajax({
            ...
            type: "POST",
            url: "{{route('provider.session.autho.activity.get')}}",
            data: {
                '_token': "{{csrf_token()}}",
                'auth_id': sc_auth_id,
            },
    ...
    function sc_session_save(){
        ...
        $.ajax({
            type: "POST",
            url: "{{route('provider.session.save')}}",
            data: {
                '_token': "{{csrf_token()}}",
    ...
    $(document).ready(function () {
        ...
        $('#sc_sub_btn').click(function(e){
            ...
            if ($('#bill_switch').prop('checked')==true) { sc_billable = 1; } else { sc_billable = 2; }
...
<script>
    ...
    function get_single_session(id){
        $.ajax({
            type: "POST",
            url: "{{route('provider.appoinment.update.get.details')}}",
            data: {
                '_token': "{{csrf_token()}}",
                'id': id,
            },
    ...
    function su_session_save(){
        ...
        $.ajax({
            type: "POST",
            url: "{{route('provider.appoinment.update')}}",
            data: {
                '_token': "{{csrf_token()}}",
