    ...
    <script>
        ...
        $(document).ready(function () {
            $('#add_service').click(function () {
                ...
                //get all service sub type
                $.ajax({
                    type: "POST",
                    url: "{{route('provider.get.subtype.by.tx')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('provider.get.service.by.tx')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'treatment_type': treatment_type,
                    },
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('provider.get.cpt.codes.by.tx')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'treatment_type': treatment_type,
                    },
            ...
            $('.editActModal').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('provider.get.authdata.by.act')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'act_data': act_data,
                    },
