            ...
            <div class="d-lg-flex">
                ...
                <div class="all_content flex-fill">
                            ...
                            <table class="table table-sm table-bordered c_table">
                                ...
                                @foreach($docuemtnts as $document)
                                    <tr>
                                        ...
                                        <td>{{\Carbon\Carbon::parse($document->exp_date)->format('m/d/Y')}}</td>
                                        <td>
                                            ...
                                            <a href="{{route('provider.client.document.delete',$document->id)}}"
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('provider.client.document.update')}}"
                    ...
                    <div id="addoc" class="collapse mt-2">
                        <form action="{{route('provider.client.upload.document')}}" method="post"
