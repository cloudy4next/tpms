        ...
        <div class="iq-card-body">
            ...
            <div class="d-lg-flex">
                ...
                <div class="all_content flex-fill">
                    <form action="{{route('provider.client.info.update')}}" method="post"
                        ...
                        <div class="row">
                            ...
                            @include('superadmin.client.include.addressSection')
                            @include('superadmin.client.include.phonesection')
                            @include('superadmin.client.include.emailsection')
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-3 col-xl mb-2 pr-2">
                                        ...
                                        <input type="date" class="form-control form-control-sm"
                                               ...
                                               value="{{$client_info->client_date_first_seen}}">
                                    </div>
                                    <div class="col-md-3 col-xl mb-2 pr-2">
                                        <label>Referred By</label>
                                        <select class="form-control form-control-sm" name="client_reffered_by">
                                            <?php
                                            ...
                                            @foreach($employee as $em)
                                                <option
                                                    value="{{$em->id}}" {{$client_info->client_reffered_by == $em->id ? 'selected' : ''}}>{{$em->first_name}} {{$em->middle_name}} {{$em->last_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-3 col-xl mb-2">
                                        <label>Assignment</label>
                                        <select class="form-control form-control-sm" name="asignment">
                                    ...
                                    {{--                                    <div class="col-md-3 col-xl mb-2 pl-2">--}}
                                    {{--                                        <label>Background Color</label>--}}
                                    {{--                                        <input type="color" class="form-control form-control-sm" name="back_color"--}}
                                    {{--                                               value="{{$client_color->back_color}}">--}}
                                    {{--                                    </div>--}}

                                    {{--                                    <div class="col-md-3 col-xl mb-2 pl-2">--}}
                                    {{--                                        <label>Text Color</label>--}}
                                    {{--                                        <input type="color" class="form-control form-control-sm" name="text_color"--}}
                                    {{--                                               value="{{$client_color->text_color}}">--}}
                                    {{--                                    </div>--}}
                                    ...
                                    <div class="col-md-3 col-xl mb-2 pl-2">
                                        ...
                                        <div class="colorPickSelector"
                                             style="background-color: {{$client_color->back_color}} !important;">
                                            <input type="color" class="form-control form-control-sm d-none"
                                                   name="back_color"
                                                   value="{{$client_color->back_color}}">
                                        </div>
                                    </div>
                            ...
                            @include('superadmin.client.include.guarantar_info_section')
                            ...
                            <div class="col-md-3">
                                <div class="preview-sig">
                                    ...
                                    @if (!empty($client_info->signature_image) && file_exists($client_info->signature_image))
                                        <img src="{{asset($client_info->signature_image)}}" id="wizardPicturePreview"
                                             class="img-fluid dyn_img" style="width: 70px;">
                                    @else
                                        <img src="{{asset('assets/dashboard/')}}/images/client/contact.png"
                                             id="wizardPicturePreview" class="img-fluid dyn_img" style="width: 70px;">
                                    @endif
...
@section('js')
    ...
    <script>
        ...
        let color = "{{$client_color->back_color != null ? $client_color->back_color : '#E0EBF5'}}";
...
// Prepare the preview for profile picture
            ...
            $('#delete_sing').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('provider.client.sing.delete')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'client_id': client_id
                    },
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.existsphonedelete').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('provider.delete.exist.client.phone')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'phonid': phonid
                    },
            ...
            $('.deleteexistsemail').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('provider.delete.exist.client.email')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'emailid': emailid
                    },
            ...
            $('.deleteexistsaddress').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('provider.delete.exist.client.address')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'addressid': addressid
                    },
