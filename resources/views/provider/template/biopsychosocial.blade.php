                        ...
                        <div class="box box10">
                            <div class="col-item ">
                                ...
                                <div class="select-area mtb_10">
                                    <ul>
                                        <li>
                                            <input id="substanceyes" type="radio" name="ssubstance" value="1"> <label
                                                for="substanceyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="substanceno" type="radio" name="ssubstance" value="2"> <label
                            ...
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        ...
                                        <li>
                                            <input id="think-2" type="checkbox" name="thindiss" value="1"> <label
