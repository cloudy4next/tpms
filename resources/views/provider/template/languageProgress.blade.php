...
<div class="treatment-plan">
        <div class="content">
            ...
            <form class="theraly-common-page" id="form_27" method="POST">
                    ...
                    <div class="flex-div div_33 mb_30">
                        <div class="col-item">
                            <div class="input-area"> <span>
                                    ...
                                    <input type="text" placeholder="Enter your Name" id="clname" name="clname" value="{{$client->client_full_name}}">
                        ...
                        <div class="col-item">
                            <div class="input-area"> <span>
                                    ...
                                    <input type="date" id="summery-date" name="sdate" value="{{ $cl->schedule_date}}">
                                </span> </div>
                        </div>
                        <div class="col-item">
                            <div class="input-area"> <span>
                                    ...
                                    <input type="text" name="cpt" value="{{$cl->cpt_code}}">
                                </span> </div>
                        </div>
                        <div class="col-item">
                            <div class="input-area"> <span>
                ...
                <section class="section_2">
                    <div class="box box_1">
                        ...
                        <textarea rows="5" placeholder="Enter Background Information..." name="backinfo"></textarea>
                    </div>
                </section>
                <section class="section_3">
                    ...
                    <div class="box box_1 mb_30">
                        ...
                        <textarea rows="5" placeholder="Enter long term goal..." name="ltgoal"></textarea>
                    </div>
                    <div class="box box_2 mb_30">
                        <h3>SHORT TERM GOALS <span class="bracket">(Intermediate Outcomes):</span></h3>
                        <textarea rows="5" placeholder="Enter short term goal..." name="stgoal"></textarea>
                    </div>
                    <div class="box box_3 mb_30">
                        <h3>Intervention Strategies:</h3>
                        <textarea rows="5" placeholder="Enter intervention strategies..." name="intstra"></textarea>
                    </div>
                    <div class="box box_4 mb_30">
                        <h3>Response to Therapy:</h3>
                        <textarea rows="5" placeholder="Enter response to therapy..." name="resth"></textarea>
                    </div>
                    <div class="box box_5 mb_30">
                        <h3>Testing Done During the Semester:</h3>
                        <textarea rows="5" placeholder="Enter testing done during the semester..." name="testsem"></textarea>
                    </div>
                    ...
                    <div class="box box_7 mb_30">
                        ...
                        <textarea rows="5" placeholder="Enter medical necessity..." name="mednec"></textarea>
                    </div>
                    <div class="box box_8 mb_30">
                        <h3>Recommendations:</h3>
                        <textarea rows="5" placeholder="Enter recommendations" name="recomm"></textarea>
                    </div>
                    <div class="box box_9 mb_30">
                        <h3>LONG TERM GOALS:</h3>
                        <textarea rows="5" placeholder="Enter long term goal..." name="ltgoal2"></textarea>
                    </div>
                    <div class="box box_10 mb_30">
                        <h3>SHORT TERM GOALS:</h3>
                        <textarea rows="5" placeholder="Enter short term goal..." name="stgoal2"></textarea>
                    </div>
                    <div class="box box11">
                        <div class="flex-div">
                            <div class="col-item">
            ...
            <form class="pdf_form" action="{{ route('provider.print.form.27')}}" target="_blank" method="POST">
            @csrf
    ...
    $(document).ready(function () {
      ...
      $(document).on('click','.pdf_btn',function(){
        ...
        $(document).on('submit', '#form_27', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('provider.27.form.submit')}}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
