    ...
    <div class="content">
      ...
      <form action="" method="post" id="form_16">
              ...
              <tr>
                <td>
                  <div class="flex-div"><span>
                      ...
                      <input type="text" id="rec_name" name="rec_name" value="{{$client->client_full_name}}">
              ...
              <tr>
                ...
                <td>
                  <div class="flex-div"><span>
                      ...
                      <input type="date" id="dob" name="dob" value="{{$client->client_dob}}">
                    </span></div>
                </td>
              </tr>
              <tr>
            ...
            <li class="list-inline-item">
              <div class="form-check-inline">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" name="radio1" value="1">Initial Assessment
                </label>
              </div>
            </li>
            <li class="list-inline-item">
              <div class="form-check-inline">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" name="radio1" value="2">Reassessment
                </label>
              </div>
            </li>
          </ul>
        ...
        <section class="section_2 mb_30">
          ...
          <p>Preference Assessment completed using parent interview, direct observation conducted on ____________</p>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="psydrug" value="1">Yes
                    </label>
                  </div>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="psydrug" value="2">No
                    </label>
                  </div>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="psydrug" value="3">Recipient Declined N/A, provider is the
                      prescriber
                    </label>
                  </div>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="psydrug" value="4">N/A recipient is not on medications
                    </label>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="pcp" value="1">Yes
                    </label>
                  </div>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="pcp" value="2">No
                    </label>
                  </div>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="pcp" value="3">Recipient Declined
                    </label>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="decline" value="1">Yes
                    </label>
                  </div>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="decline" value="2">No
                    </label>
                  </div>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="decline" value="3">N/A, I did not contact P.C.P.
                    </label>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="bh" value="1">Yes
                    </label>
                  </div>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="bh" value="2">No
                    </label>
                  </div>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="bh" value="3">N/A
                    </label>
                  </div>
                </td>
              </tr>
        ...
        <section class="section_2 mb_30">
          ...
          <p>CLIENT demonstrates medical necessity for services per the Functional Behavior Assessment and as described
            below, demonstrates deficits in verbal behavior, self-care, living skills, safety skills, adaptive living
            skills, and problem behaviors that are functioning as a barrier to further development and places the CLIENT
            at risk of significant disability and jeopardizes safety. The behavior analysis services described in the
            plan are necessary to protect life and prevent significant disability; they are also individualized,
            specific, and consistent with the confirmed diagnosis under treatment, and not more than the patient's
            needs. They are consistent with generally accepted professional medical standards as determined by the
            Medicaid program and not are not experimental or investigational. The services are reflective of the level
            of service that can be safely furnished, and for which there are currently not equally effective and more
            conservative or less costly treatment is available statewide and are furnished in a manner not primarily
        ...
        <section class="section_2 mb_30">
          ...
          <p>I hereby provide my consent to implement the behavior support plan for CLIENT developed by Falls Family
            Center, LLLC on ____________________. I understand that the interventions in this plan have been designed to
            result in the reduction of PROBLEM BEHAVIORS and enhance CLIENT's skills in communication, socialization,
            ...
            participation of the following individuals: CAREGIVER NAME (CAREGIVER RELATIONSHIP TO CLIENT). Commitment of
            these individuals to participate in plan implementation is evidenced by their signatures at the bottom of
            this form. </p>
          <p>The interventions included in this behavior support plan include modifications to CLIENT’s surroundings and
            social conditions to reduce the likelihood of his/her challenging behavior and improve his/her independence,
            systematic instruction to shape and strengthen adaptive skills, and strategies to manage the consequences of
            CLIENT’s behavior so that reinforcement is maximized for positive behavior and withheld or minimized for
            problem behavior. Specific strategies include using visuals/token boards to increase independence, prompting
            to increase spontaneous skills, and shaping socialization to improve relationships.</p>
          <p>I have had an opportunity to review the complete behavior support plan verbally and in written form and get
            clarification in response to any questions I have. I agree to be an active participant in implementing
            and/or supporting the implementation of this behavior intervention plan, participating in training, and
            monitoring to promote its success. I have been made aware of potential risks (including the possibility that
            CLIENT’s behavior may escalate before improving and/or vary across settings based on how the plan is
            implemented, if relevant) and the anticipated benefits of intervention. I understand that these procedures
            can only be implemented as written with my approval. I reserve the right to refuse or discontinue consent to
            the plan or specific intervention practices at any point without repercussions. If I withdraw consent,
            interventions will be discontinued immediately. I recognize the importance of fidelity and consistency, and
