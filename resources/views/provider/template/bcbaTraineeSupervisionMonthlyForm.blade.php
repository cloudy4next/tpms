...
<div class="bcba-sup-monthly">
    ...
    <div class="content">
        ...
        <form action="{{route('provider.btsmf.three.form.submit')}}" method="post" id="btsmf_three_form">
            @csrf
            <section class="section_1 mb_30">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <input type="text" id="no-hour-i" name="nohouri" class="nohouri">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
            ...
            <section class="section_2 mb_30">
                <div class="box box1 mb_30">
                    ...
                    <div class="textarea">
                        <textarea id="topic-feedback" rows="5" name="top_feed" class="top_feed"></textarea>
                    </div>
                </div>
                <div class="box box2">
                    <div class="col-title mb_15">
            ...
            <section class="section_3">
                <div class="box box-last_2">
                    ...
                    <input maxlength="4" type="text" name="bacbid">
                  </span></div>
                        </div>
                        <div class="col-item">
                            <div class="holder-div">
                                <input id="bacb-sign-date" type="date" name="bacbiddate" class="bacbiddate">
                                <br>
                    ...
                    <input maxlength="4" type="text" name="bacbid2">
                        ...
                        <div class="col-item">
                            <div class="holder-div">
                                <input id="suupervisor-sign-date" type="date" name="bacbiddate2" class="bacbiddate2">
                                <br>
        ...
        <form class="pdf_form" action="{{ route('provider.print.form.3')}}" target="_blank" method="POST">
            @csrf
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('submit', '#btsmf_three_form', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('provider.btsmf.three.form.submit')}}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
