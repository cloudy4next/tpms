                                ...
                                <td>
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti" value="1">BCBA 
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti" value="2">Parent/Caregiver
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti" value="3">Behavior Therapist 
                                                    Language
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti" value="4">Learner
                                                    Language
                                                </label>
                                            </div>
                                        </li>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="recm" value="1"></textarea>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="goaladdress" value="2"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="text-primary">Interventions Suggested/Modeled</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="intervent" value="3"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="text-primary">Feedback from Parent/Caregiver</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="feedback" value="4"></textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
