            ...
            <form action="" method="POST" id="form_25">
                ...
                <div class="content">
                            ...
                            <div class="left">
                                    ...
                                    <div class="checkbox-area flex-div">
                                        <ul>
                                            <li class="group group_1">
                                                <input type="checkbox" value="1" id="Consumer" name="consumer"><label
                                                    for="Consumer">Consumer</label>
                                                <input type="hidden" name="sessionid" value="{{$session_id}}">

                                            </li>
                                            <li class="group group_2">
                                                <input type="checkbox" value="1" id="Other" name="pother"><label for="Other">Other</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="checkbox" value="1" id="fosterp" name="pparent"><label for="fosterp">Foster
                                                    Parents</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_4">
                                                <input type="checkbox" value="1" id="parent" name="parent"><label
                                                    for="parent">Parent/Guardian</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="checkbox" value="1" id="staff" name="pgaurdian"><label for="staff">Group Home
                                                    Staff</label>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-item1 col-item mb_30">
                                    ...
                                    <div class="checkbox-area flex-div">
                                        <ul>
                                            <li class="group group_1">
                                                <input type="radio" value="1" id="agitated" name="affect"><label
                                                    for="agitated">Agitated</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" value="2" id="calm" name="affect"><label
                                                    for="calm">Calm</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="radio" value="3" id="flat" name="affect"><label
                                                    for="flat">Flat</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_4">
                                                <input type="radio" value="4" id="n-a" name="affect"><label for="n-a">N/A</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="radio" value="5" id="sad" name="affect"><label for="sad">Sad</label>
                                            </li>
                                            <li class="group group_1">
                                                <input type="radio" value="6" id="angry" name="affect"><label
                                                    for="angry">Angry</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_2">
                                                <input type="radio" value="7" id="defiant" name="affect"><label
                                                    for="defiant">Defiant</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="radio" value="8" id="happy" name="affect"><label
                                                    for="happy">Happy</label>
                                            </li>
                                            <li class="group group_4">
                                                <input type="radio" value="9" id="other" name="affect"><label
                                                    for="other">Other</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_5">
                                                <input type="radio" value="10" id="suicidal" name="affect"><label
                                                    for="suicidal">Suicidal</label>
                                            </li>
                                            <li class="group group_1">
                                                <input type="radio" value="11" id="anxious" name="affect"><label
                                                    for="anxious">Anxious</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" value="12" id="energetic" name="affect"><label
                                                    for="energetic">Energetic</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_3">
                                                <input type="radio" value="13" id="moody" name="affect"><label
                                                    for="moody">Moody</label>
                                            </li>
                                            <li class="group group_4">
                                                <input type="radio" value="14" id="playful" name="affect"><label
                                                    for="playful">Playful</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="radio" value="15" id="tired" name="affect"><label
                            ...
                            <div class="right">
                                <div class="col-item1 col-item mb_30">
                                    ...
                                    <div class="checkbox-area flex-div">
                                        <ul>
                                            <li class="group group_1">
                                                <input type="radio" value="1" id="f2f" name="contacttype"><label for="f2f">Face
                                                    to
                                                    Face</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" value="2" id="phone" name="contacttype"><label
                                                    for="phone">Phone</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="radio" value="3" id="attempts" name="contacttype"><label
                                                    for="attempts">Attempts</label></li>
                                        </ul>
                                        <ul>
                                            <li class="group group_4">
                                                <input type="radio" value="4" id="telehealth" name="contacttype"> <label
                                                    for="telehealth">Telehealth</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="radio" value="5" id="na" name="contacttype"><label
                                                    for="na">N/A</label>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-item1 col-item mb_30">
                                    ...
                                    <div class="checkbox-area">
                                        <ul>
                                            <li class="group group_1"><input type="radio" value="1" id="yes"
                                                    name="stressor"><label for="yes">yes</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" value="2" id="none-reported" name="stressor"><label
                    ...
                    <section class="section_2">
                        <input type="checkbox" value="1" name="imi"> <label><strong>Include Mileage Information?</strong></label>
                        <br>
                        <br>
