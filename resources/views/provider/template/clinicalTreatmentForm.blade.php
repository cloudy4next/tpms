...
<section class="section_1 mb_40">
    <div class="box box_1">
        ...
        <input id="date" type="date" name="date" value="{{ $cl->schedule_date}}">
      </span></div>
            </div>
            <div class="col-item">
                <div class="flex-div"> <span>
        ...
        <input id="start-time" type="time" name="stime" value="{{\Carbon\Carbon::parse($cl->from_time)->format('H:i:s')}}">
      </span></div>
            </div>
            <div class="col-item">
                <div class="flex-div"> <span>
        ...
        <input id="end-time" type="time" name="etime" value="{{\Carbon\Carbon::parse($cl->to_time)->format('H:i:s')}}">
      </span></div>
            </div>
            <div class="col-item">
                <div class="flex-div">
                    ...
                    <div class="check-box-area">
                        <ul>
                            <li>
                                <span>
                                    <input id="home" type="checkbox" name="setting" value="1">
                                </span>
                                <span>
                            ...
                            <li>
                                <span>
                                    <input id="community" type="checkbox" name="community" value="1">
                                </span>
                                <span>
                            ...
                            <li>
                                <span>
                                    <input id="clinic" type="checkbox" name="clinic" value="1">
                                </span>
                                <span>
                            ...
                            <li>
                                <span>
                                    <input id="school" type="checkbox" name="school" value="1">
                                </span>
                                <span>
    ...
    <div class="col-item mb_30">
        <div class="flex-div">
            ...
            <div class="check-box-area">
                <ul>
                    <li><span>
          <input id="language-improvement" type="checkbox" name="langimp" value="1">
        </span><span>
          <label for="language-improvement">Rec. Language Impairment </label>
        </span></li>
                    <li><span>
          <input id="exp-language" type="checkbox" name="explang" value="1">
        </span> <span>
          <label for="exp-language">Exp Language Impairment </label>
        </span></li>
                    <li><span>
          <input id="socials-skills" type="checkbox" name="ssdef" value="1">
        </span> <span>
          <label for="socials-skills">Social Skills Deficits </label>
        </span></li>
                    <li><span>
          <input id="repetitive" type="checkbox" name="repbeh" value="1">
        </span> <span>
          <label for="repetitive">Repetitive Behaviors </label>
        </span></li>
                    <li><span>
          <input id="interests" type="checkbox" name="resint" value="1">
        </span> <span>
          <label for="interests">Restricted Interests </label>
        </span></li>
                    <li><span>
          <input id="hyper" type="checkbox" name="hyper" value="1">
        </span> <span>
          <label for="hyper">Hyper/Hypo-reactivity to sensory input</label>
        </span></li>
                    <li><span>
          <input id="insistence" type="checkbox" name="insist" value="1">
        </span> <span>
          <label for="insistence">Insistence on sameness </label>
        </span></li>
                    <li><span>
          <input id="report-filled" type="checkbox" name="harmself" value="1">
        </span> <span>
          <label for="report-filled">Harm to self or others* *Was an Incident Report filled out within 24
            hours? </label>
                        ...
                        <div class="check-box-area">
                            <ul>
                                <li><span>
                <input id="report-filled-yes" type="radio" name="report" value="1">
              </span><span>
                <label for="report-filled-yes">Yes</label>
              </span></li>
                                <li><span>
                <input id="report-filled-no" type="radio" name="report" value="2">
              </span> <span>
                <label for="report-filled-no">No</label>
              </span></li>
                                <li><span>
                <input id="report-filled-na" type="radio" name="report" value="3">
              </span><span>
    ...
    <div class="col-item mb_30">
        <div class="flex-div">
            ...
            <div class="check-box-area">
                <ul>
                    <li><span>
          <input id="language-communication" type="checkbox" name="lcomm" value="1">
        </span><span>
          <label for="language-communication">Language/Communication </label>
        </span></li>
                    <li><span>
          <input id="acquisition-goal" type="checkbox" name="ttp" value="1">
        </span><span>
          <label for="acquisition-goal">Modify acquisition goal, teaching technique, and/or procedure
          </label>
        </span></li>
                    <li><span>
          <input id="tsocials-skills" type="checkbox" name="socskill" value="1">
        </span><span>
          <label for="tsocials-skills">Social Skills </label>
        </span></li>
                    <li><span>
          <input id="tplay-skills" type="checkbox" name="playskill" value="1">
        </span><span>
          <label for="tplay-skills">Play Skills</label>
        </span></li>
                    <li><span>
          <input id="adaptive-skills" type="checkbox" name="adapskill" value="1">
        </span><span>
          <label for="adaptive-skills">Adaptive Skills </label>
        </span></li>
                    <li><span>
          <input id="self-management" type="checkbox" name="selfman" value="1">
        </span><span>
          <label for="self-management">Executive Functioning Skills <span class="bracket red">
              (self-management, organization, tolerance, and inhibition) </span></label>
                    ...
                    <li><span>
          <input id="moto-skills" type="checkbox" name="motoskill" value="1">
        </span><span>
          <label for="moto-skills">Motor Skills </label>
        </span></li>
                    <li><span>
          <input id="target-safety" type="checkbox" name="tarsafe" value="1">
        </span><span>
          <label for="target-safety">Safety</label>
        </span></li>
                    <li><span>
          <input id="disruptive-behavior" type="checkbox" name="disrupt" value="1">
        </span><span>
          <label for="disruptive-behavior">Disruptive Behavior </label>
        </span></li>
                    <li><span>
          <input id="target-other-describe" type="checkbox" name="taroth" value="1">
        </span><span class="other">
          <label for="target-other-describe">Other- Describe: </label>
          <input type="text" name="tarothdes">
        </span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-item mb_30">
        ...
        apply)</span>:</label>
            ...
            <div class="check-box-area">
                <ul>
                    <li><span>
          <input id="discrete-trial" type="checkbox" name="dtt" value="1">
        </span><span>
          <label for="discrete-trial">Discrete Trial (DTT) </label>
        </span></li>
                    <li><span>
          <input id="tu-net" type="checkbox" name="net" value="1">
        </span><span>
          <label for="tu-net">Natural Environment Teaching (NET)</label>
        </span></li>
                    <li><span>
          <input id="tu-vb" type="checkbox" name="vb" value="1">
        </span><span>
          <label for="tu-vb">Verbal Behavior (VB) </label>
        </span></li>
                    <li><span>
          <input id="tu-shaping" type="checkbox" name="shaping" value="1">
        </span><span>
          <label for="tu-shaping">Shaping</label>
        </span></li>
                    <li><span>
          <input id="cyhaining-task" type="checkbox" name="chaining" value="1">
        </span><span>
          <label for="cyhaining-task">Chaining/Task Analysis </label>
        </span></li>
                    <li><span>
          <input id="tu-bst" type="checkbox" name="bst" value="1">
        </span><span>
          <label for="tu-bst">Behavior Skills Training (BST) </label>
        </span></li>
                    <li><span>
          <input id="incidental-teaching" type="checkbox" name="incteach" value="1">
        </span><span>
          <label for="incidental-teaching">Incidental Teaching </label>
        </span></li>
                    <li><span>
          <input id="prompting-fading" type="checkbox" name="propmt" value="1">
        </span><span>
          <label for="prompting-fading"> Prompting/Fading </label>
        </span></li>
                    <li><span>
          <input id="antecedent-m" type="checkbox" name="antec" value="1">
        </span><span>
          <label for="antecedent-m">Antecedent Modifications</label>
        </span></li>
                    <li><span>
          <input id="Positive-negative" type="checkbox" name="pnrein" value="1">
        </span><span>
          <label for="Positive-negative">Positive/Negative Reinforcement</label>
        </span></li>
                    <li><span>
          <input id="token-economy" type="checkbox" name="tokenecon" value="1">
        </span><span>
          <label for="token-economy">Token Economy</label>
        </span></li>
                    <li><span>
          <input id="diff-reinforential" type="checkbox" name="diffrein" value="1">
        </span><span>
          <label for="diff-reinforential">Differential Reinforcement</label>
        </span></li>
                    <li><span>
          <input id="tu-unishment" type="checkbox" name="nonharm" value="1">
        </span><span>
          <label for="tu-unishment">Non-harmful, safe, caregiver-approved Positive/Negative
            Punishment</label>
        </span></li>
                    <li><span>
          <input id="tu-other-describe" type="checkbox" name="tuother" value="1">
        </span><span class="other">
          <label for="tu-other-describe">Other- Describe: </label>
          <input type="text" name="tuotherdes">
        </span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-item mb_30">
        ...
        apply)</span>:</label>
            ...
            <div class="check-box-area">
                ...
                <ul>
                    <li><span>
          <input id="absence-p-behave" type="checkbox" name="absbeh" value="1">
        </span><span>
          <label for="absence-p-behave">Absence of Problem Behavior </label>
        </span></li>
                    <li><span>
          <input id="decrease-problem" type="checkbox" name="decbeh" value="1">
        </span><span>
          <label for="decrease-problem">Decrease of Problem Behavior </label>
        </span></li>
                    <li><span>
          <input id="mastery-target" type="checkbox" name="mastar" value="1">
        </span><span>
          <label for="mastery-target">Mastery of Targets </label>
        </span></li>
                    <li><span>
          <input id="mastery-goals" type="checkbox" name="masgoal" value="1">
        </span><span>
          <label for="mastery-goals">Mastery of Goals </label>
        </span></li>
                    <li><span>
          <input id="maintainance-mastery-goals" type="checkbox" name="maingoal" value="1">
        </span><span>
          <label for="maintainance-mastery-goals">Maintenance of Mastered Goals </label>
        </span></li>
                    <li><span>
          <input id="rapid-goals" type="checkbox" name="rapidgoal" value="1">
        </span><span>
          <label for="rapid-goals">Rapid Progress Toward Goals </label>
        </span></li>
                    <li><span>
          <input id="steady-goals" type="checkbox" name="steadygoal" value="1">
        </span><span>
          <label for="steady-goals">Steady Progress towards Goals</label>
            ...
            <div class="check-box-area">
                ...
                <ul>
                    <li><span>
          <input id="increase-prob-behave" type="checkbox" name="incbeh" value="1">
        </span><span>
          <label for="increase-prob-behave">Increase in problem behavior </label>
        </span></li>
                    <li><span>
          <input id="bp-ineffective" type="checkbox" name="behplan" value="1">
        </span><span>
          <label for="bp-ineffective">Behavior Plan was Ineffective</label>
        </span></li>
                    <li><span>
          <input id="lack-motivation" type="checkbox" name="lackmot" value="1">
        </span><span>
          <label for="lack-motivation">Lack of Motivation </label>
        </span></li>
                    <li><span>
          <input id="regression-skills" type="checkbox" name="regresskill" value="1">
        </span><span>
...
<section class="section_3 mb_40">
    <div class="box box_1 mb_30">
        ...
        <div class="textarea">
            <textarea id="treatment-plan" rows="5" name="tpdetail"> </textarea>
        </div>
    </div>
    <div class="box box_2 mb_30">
        ...
        <div class="textarea">
            <textarea id="new-behavior" rows="5" name="newbeh"> </textarea>
        </div>
    </div>
    <div class="box box_3 mb_30">
        ...
        <div class="textarea">
            <textarea id="parent-comments" rows="5" name="ptdiss"> </textarea>
        </div>
    </div>
    <div class="box box_4 mb_30">
        ...
        <div class="textarea">
            <textarea id="follow-up" rows="5" name="followup"> </textarea>
        </div>
    </div>
</section>
<section class="section_5 mb_40">
    <div class="col-item mb_30">
        <div class="flex-div">
            ...
            <div class="check-box-area">
                <ul>
                    <li><span>
          <input id="in-person" type="checkbox" name="inperson" value="1">
        </span><span>
          <label for="in-person">In Person</label>
        </span></li>
                    <li><span>
          <input id="art-rbt-remote" type="checkbox" name="remote" value="1">
        </span> <span>
          <label for="art-rbt-remote">Remote</label>
        </span></li>
                    <li><span>
          <input id="art-rbt-group" type="checkbox" name="group" value="1">
        </span> <span>
    ...
    <div class="box box_1 mb_30">
        ...
        <div class="textarea">
            <textarea id="observation-note" rows="5" name="obsnote"> </textarea>
        </div>
    </div>
</section>
<section class="section_6 mb_40">
    ...
    <div class="col-item mb_30">
        <div class="flex-div">
            ...
            <div class="check-box-area">
                <ul>
                    <li><span>
          <input id="art-rbt-data-reviwes" type="checkbox" name="datreview" value="1">
        </span><span>
          <label for="art-rbt-data-reviwes">Data Review</label>
        </span></li>
                    <li><span>
          <input id="art-rbt-observation" type="checkbox" name="observation" value="1">
        </span> <span>
          <label for="art-rbt-observation">Observation</label>
        </span></li>
                    <li><span>
          <input id="art-rbt-protocol" type="checkbox" name="protdemon" value="1">
        </span> <span>
          <label for="art-rbt-protocol">Protocol Demonstration/Modification</label>
        </span></li>
                    <li><span>
          <input id="art-rbt-tmeeting" type="checkbox" name="teammeeting" value="1">
        </span> <span>
          <label for="art-rbt-tmeeting">Team Meeting</label>
        </span></li>
                    <li><span>
          <input id="art-rbt-other" type="checkbox" name="datother" value="1">
        </span><span class="other">
          <label for="art-rbt-other">Other:</label>
          <input type="text" name="datotherexp">
        </span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="box box_1 mb_30">
        ...
        <div class="textarea">
            <textarea id="activities-feedback" rows="5" name="posfeed"> </textarea>
        </div>
    </div>
    <div class="box box_2 mb_30">
        <div class="col-title mb_15">
        ...
        <div class="textarea">
            <textarea id="art-rbt-tech" rows="5" name="teach"> </textarea>
        </div>
    </div>
    <div class="box box_3 mb_30">
        <div class="col-title mb_15">
        ...
        <div class="textarea">
            <textarea id="activities-model" rows="5" name="moddel"> </textarea>
        </div>
    </div>
    <div class="box box_4 mb_30">
        <div class="col-title mb_15">
        ...
        <div class="textarea">
            <textarea id="activities-coach" rows="5" name="coach"> </textarea>
        </div>
    </div>
    <div class="box box_5 mb_30">
        ...
        <div class="textarea">
            <textarea id="activities-review" rows="5" name="review"> </textarea>
        </div>
    </div>
    <div class="box box_6 mb_30">
        <div class="flex-div">
            ...
            <div class="check-box-area">
                <ul>
                    <li><span>
          <input id="io-yes" type="radio" name="ioa" value="1">
        </span><span>
          <label for="io-yes">Yes</label>
        </span></li>
                    <li><span>
          <input id="io-no" type="radio" name="ioa" value="2">
        </span> <span>
        ...
        separate DTT sheet:</span> </label>
            ...
            <div class="textarea">
                <textarea rows="5" name="dttsheet"></textarea>
            </div>
        </div>
    </div>
</section>
<section class="section_7 mb_40">
    ...
    <div class="box box_1 mb_30">
        ...
        <div class="textarea">
            <textarea id="goal-1" rows="5" name="goal1"> </textarea>
        </div>
    </div>
    <div class="box box_2 mb_30">
        <div class="col-title mb_15">
        ...
        <div class="textarea">
            <textarea id="goal-2" rows="5" name="goal2"> </textarea>
        </div>
    </div>
    <div class="box box_3 mb_30">
        <div class="col-title mb_15">
        ...
        <div class="textarea">
            <textarea id="goal-3" rows="5" name="goal3"> </textarea>
        </div>
    </div>
</section>
<section class="section_4 signature-section mb_40">
    ...
    <div class="flex-div row-flex div_33 mb_30">
      ...
      <input id="parent-print-name" type="text" name="parprint">
    </span></div>
        </div>
        <div class="col-item">
            <div class="flex-div"> <span>
      ...
      <input id="parent-sign-date" type="date" name="pardate">
    </span></div>
        </div>
    </div>
    <div class="flex-div row-flex div_33 mb_30">
      ...
      <input id="pm-cm-print-name" type="text" name="pmprint">
    </span></div>
        </div>
        <div class="col-item">
            <div class="flex-div"> <span>
      ...
      <input id="pm-cm-sign-date" type="date" name="pmdate">
    </span></div>
        </div>
    </div>
</section>
...
<!-- signature modal provider -->
        ...
        <form class="pdf_form" action="{{ route('provider.print.form.7')}}" target="_blank" method="POST">
            @csrf
    ...
    $(document).ready(function () {
      ...
      $(document).on('click','.pdf_btn',function(){
        ...
        $(document).on('submit', '#form_7', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('provider.7.form.submit')}}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
