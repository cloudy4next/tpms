...
<div class="bcba-uniq-supervision">
    ...
    <div class="content">
        ...
        <form action="{{route('provider.btusf.form.four.submit')}}" method="post" id="btusf_four_form">
            @csrf
            <section class="section_1 mb_30">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <input type="text" id="time" name="sttime" class="sttime">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="text" id="trainee" name="trainee" class="trainee">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="text" id="restrict-hours" name="restricthours" class="restricthours">
                    </span></div>
                        </td>
                    </tr>
                    <tr>
                      ...
                      <input type="text" id="setting" name="setting" class="setting">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="text" maxlength="5" id="num-client" name="numclient" class="numclient">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="text" id="c-purchaging" name="cpurchaging" class="cpurchaging">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="text" id="unrestrict-hours" name="unrestricthours" class="unrestricthours">
                    </span></div>
                        </td>
                    </tr>
                    <tr>
                      ...
                      <input type="text" id="supervising-bcba" name="supervisingbcba" class="supervisingbcba">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="text" maxlength="5" id="bcba" name="bcba" class="bcba">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="text" id="session-length" name="seslength" class="seslength">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="text" id="no-hs" name="nohs" class="nohs">
                    </span></div>
                        </td>
                    </tr>
                    <!-- <tr>
            ...
            <section class="section_2 mb_30">
                <div class="box box1 mb_30">
                    ...
                    <ul class="checkbox-area">
                        <li>
                            <div class="flex-div"> <span>
                    <input id="person" type="checkbox" name="suptypes1" class="suptypes1" value="1">
                    <label for="person">In person </label>
                  </span></div>
                        </li>
                        <li>
                            <div class="flex-div"> <span>
                    <input id="telehealth" type="checkbox" name="suptypes2" class="suptypes2" value="1">
                    <label for="telehealth">Telehealth</label>
                  </span></div>
                        </li>
                        <li>
                            <div class="flex-div"> <span>
                    <input id="group-meeting" type="checkbox" name="suptypes3" class="suptypes3" value="1">
            ...
            <section class="section_3">
                ...
                <div class="box box1 mb_30">
                    ...
                    <div class="evaluation-of-performance">
                      ...
                      <input type="radio" id="s1" name="arotime" class="arotime" value="1">
                      <label for="s1">S</label>
                    </span> <span>
                      <input type="radio" id="ni1" name="arotime" class="arotime" value="2">
                      <label for="ni1">NI</label>
                    </span> <span>
                      <input type="radio" id="u1" name="arotime" class="arotime" value="3">
                      <label for="u1">U</label>
                    </span> <span>
                      <input type="radio" id="na1" name="arotime" class="arotime" value="4">
                      <label for="na1">N/A</label>
                            ...
                            <li>Maintains professional and courteous interactions with: Clients/consumers Other service
                                ...
                                Coworkers:<br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s2" name="coworkers" class="coworkers" value="1">
                      <label for="s2">S</label>
                    </span> <span>
                      <input type="radio" id="ni2" name="coworkers" class="coworkers" value="2">
                      <label for="ni2">NI</label>
                    </span> <span>
                      <input type="radio" id="u2" name="coworkers" class="coworkers" value="3">
                      <label for="u2">U</label>
                    </span> <span>
                      <input type="radio" id="na2" name="coworkers" class="coworkers" value="4">
                      <label for="na2">N/A</label>
                    </span></div>
                            </li>
                            <li>Maintains appropriate attire & demeanor Initiates professional self-improvement: <br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s3" name="selfimprovement" class="selfimprovement" value="1">
                      <label for="s3">S</label>
                    </span> <span>
                      <input type="radio" id="ni3" name="selfimprovement" class="selfimprovement" value="2">
                      <label for="ni3">NI</label>
                    </span> <span>
                      <input type="radio" id="u3" name="selfimprovement" class="selfimprovement" value="3">
                      <label for="u3">U</label>
                    </span> <span>
                      <input type="radio" id="na3" name="selfimprovement" class="selfimprovement" value="4">
                      <label for="na3">N/A</label>
                    </span></div>
                            </li>
                            <li>Accepts supervisory feedback appropriately: <br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s4" name="appropriately" class="appropriately" value="1">
                      <label for="s4">S</label>
                    </span> <span>
                      <input type="radio" id="ni4" name="appropriately" class="appropriately" value="2">
                      <label for="ni4">NI</label>
                    </span> <span>
                      <input type="radio" id="u4" name="appropriately" class="appropriately" value="3">
                      <label for="u4">U</label>
                    </span> <span>
                      <input type="radio" id="na4" name="appropriately" class="appropriately" value="4">
                      <label for="na4">N/A</label>
                    </span></div>
                            </li>
                            <li>Seeks supervision appropriately/ asks questions when needed: <br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s5" name="seeks" class="seeks" value="1">
                      <label for="s5">S</label>
                    </span> <span>
                      <input type="radio" id="ni5" name="seeks" class="seeks" value="2">
                      <label for="ni5">NI</label>
                    </span> <span>
                      <input type="radio" id="u5" name="seeks" class="seeks" value="3">
                      <label for="u5">U</label>
                    </span> <span>
                      <input type="radio" id="na5" name="seeks" class="seeks" value="4">
                      <label for="na5">N/A</label>
                    </span></div>
                            </li>
                            <li>Timely submission of tasks assigned: <br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s6" name="submission" class="submission" value="1">
                      <label for="s6">S</label>
                    </span> <span>
                      <input type="radio" id="ni6" name="submission" class="submission" value="2">
                      <label for="ni6">NI</label>
                    </span> <span>
                      <input type="radio" id="u6" name="submission" class="submission" value="3">
                      <label for="u6">U</label>
                    </span> <span>
                      <input type="radio" id="na6" name="submission" class="submission" value="4">
                      <label for="na6">N/A</label>
                    </span></div>
                            </li>
                            <li>Communicates effectively:<br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s7" name="communicates" class="communicates" value="1">
                      <label for="s7">S</label>
                    </span> <span>
                      <input type="radio" id="ni7" name="communicates" class="communicates" value="2">
                      <label for="ni7">NI</label>
                    </span> <span>
                      <input type="radio" id="u7" name="communicates" class="communicates" value="3">
                      <label for="u7">U</label>
                    </span> <span>
                      <input type="radio" id="na7" name="communicates" class="communicates" value="4">
                    ...
                    healthcare providers, caregivers etc)</span>:<br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s8" name="sensitivity" class="sensitivity" value="1">
                      <label for="s8">S</label>
                    </span><span>
                      <input type="radio" id="ni8" name="sensitivity" class="sensitivity" value="2">
                      <label for="ni8">NI</label>
                    </span> <span>
                      <input type="radio" id="u8" name="sensitivity" class="sensitivity" value="3">
                      <label for="u8">U</label>
                    </span> <span>
                      <input type="radio" id="na8" name="sensitivity" class="sensitivity" value="4">
                      <label for="na8">N/A</label>
                    </span></div>
                            </li>
                            <li>Acquisition of target behavior-analytic skills:<br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s9" name="behanalytic" class="behanalytic" value="1">
                      <label for="s9">S</label>
                    </span> <span>
                      <input type="radio" id="ni9" name="behanalytic" class="behanalytic" value="2">
                      <label for="ni9">NI</label>
                    </span> <span>
                      <input type="radio" id="u9" name="behanalytic" class="behanalytic" value="3">
                      <label for="u9">U</label>
                    </span> <span>
                      <input type="radio" id="na9" name="behanalytic" class="behanalytic" value="4">
            ...
            <section class="section_4 mb_30">
                <div class="box box1 mb_30">
                    ...
                    <div class="textarea">
                        <textarea id="topic-feedback" name="feeds" cols="feeds" rows="5"></textarea>
                    </div>
                </div>
                <div class="box box2">
                    <div class="col-title mb_15">
                    ...
                    <div class="textarea">
                        <textarea id="needs" rows="5" name="tlic" class="tlic"></textarea>
                    </div>
                </div>
            </section>
            <section class="section_3">
                <div class="box box-last_2">
                    ...
                    <input maxlength="4" type="text" name="bacb" class="bacb">
                  </span></div>
                        </div>
                        <div class="col-item">
                            <div class="holder-div">
                                <input id="bacb-sign-date" type="date" name="bacbdate" class="bacbdate">
                                <br>
                    ...
                    <input maxlength="4" type="text" name="bacb2">
                  </span></div>
                        </div>
                        <div class="col-item">
                            <div class="holder-div">
                                <input id="suupervisor-sign-date" type="date" name="bacbdate2" class="bacbdate2">
                                <br>
        ...
        <form class="pdf_form" action="{{ route('provider.print.form.4')}}" target="_blank" method="POST">
            @csrf
...
<script>
    ...
    $(document).on('submit', '#btusf_four_form', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('provider.btusf.form.four.submit')}}",
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
