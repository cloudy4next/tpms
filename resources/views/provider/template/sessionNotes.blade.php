              ...
              <tr>
                ...
                <td>
                  <div class="flex-div"><span>
                      ...
                      <input type="time" id="stime" name="stime" value="{{\Carbon\Carbon::parse($cl->from_time)->format('H:i:s')}}">
                    </span></div>
                </td>
                <td>
                  <div class="flex-div"><span>
                      ...
                      <input type="time" id="etime" name="etime" value="{{\Carbon\Carbon::parse($cl->to_time)->format('H:i:s')}}">
                    </span></div>
                </td>
              </tr>
              <tr>
...
if($cl->location=="03") $location='School';
if($cl->location=="11") $location='Office';
if($cl->location=="12") $location='Home';
if($cl->location=="99") $location='Others';
if($cl->location=="02") $location='Telehealth';
if($cl->location=="53") $location='Community Mental Health Center';


?>
                      <input type="text" id="sl" name="sl" value="{{$location}}">
                    </span></div>
                </td>
                <td>
                  <div class="flex-div"><span>
                      ...
                      <input type="text" id="pxcode" name="pxcode" value="{{$cl->cpt_code}}">
                    </span></div>
                </td>
              </tr>
              <tr>
                <td colspan="3">
                  ...
                  <textarea rows="1" class="form-control" name="scd" value="{{$cl->activity_type}}"></textarea>
                </td>
              </tr>
            </tbody>
          </table>
            ...
            <tr>
              ...
              <td>
                <div class="flex-div">
                  ...
                  <input type="text" id="pname" name="pname" value="{{$provider->full_name}}">
                </div>
              </td>
            </tr>
            <tr>
              <td>
                <div class="flex-div">
                  ...
                  <input type="text" id="pcr" name="pcr" value="{{$cred}}">
                </div>
              </td>
              <td>
                <div class="flex-div">
                  <label for="pnpi">Provider NPI:</label>
                  <input type="text" id="pnpi" name="pnpi" value="{{$provider->individual_npi}}">
                </div>
              </td>
            </tr>
          </table>
        ...
        <section class="section_2 mb_30">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="skill" value="1">Skill Acquisition
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="social" value="1">Social Skill Acquisition
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="role" value="1">Role Play
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="prem" value="1">Premack Principle
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="stimu" value="1">Stimulus Prompts
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="modeling" value="1">Video Modeling
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="shaping" value="1">Shaping
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="contract" value="1">Behavior Contract
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="timer" value="1">Timer
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="tboard" value="1">Token Board
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="selfm" value="1">Self Monitor
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="dtt" value="1">DTT
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="antm" value="1">Antecedent Manipulation
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="selfmn" value="1">Self Management
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="diffrein" value="1">Differential Reinforcement
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="fct" value="1">FCT
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="vaid" value="1">Visual Aid
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="errorlearn" value="1">Errorless Learning
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="net" value="1">NET
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="chaining" value="1">Chaining
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="others" value="1">Others
            </label>
          </div>
            ...
            <tr>
              <td>
                <div class="flex-div">
                  ...
                  <input type="text" id="provider_name" name="provider_name" value="{{$provider->full_name}}"></div>
              </td>
              <td>
                <div class="flex-div">
                  <label for="pcredent">Provider Credentials :</label>
                  <input type="text" id="pcredent" name="pcredent" value="{{$cred}}">
                </div>
              </td>
            </tr>
          </table>
      ...
      <form class="pdf_form" action="{{ route('provider.print.form.13')}}" target="_blank" method="POST">
            @csrf
    ...
    $(document).ready(function () {
      ...
      $(document).on('click','.pdf_btn',function(){
        ...
        $(document).on('submit', '#form_13', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('provider.13.form.submit')}}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
