            ...
            <div class="top-part" style="margin-top:10px;">
                <div class="row1 flex-div mb_30">
                    <div class="client-name"><label>Client Name:</label>
                        <input type="text" placeholder="Enter Your Name..." name="clname"  value="{{$client->client_full_name}}">
                        <input type="hidden" placeholder="Enter Your Name..." name="sessionid" value="{{$session_id}}">
                    </div>
                    <div class="date"><label>Date:</label> <input type="date" name="stdate" value="{{ $cl->schedule_date}}"></div>
                </div>
                <div class="row2 mb_30"><span><label>Type of Treatment Plan:</label></span> <span>
                        <input type="checkbox" id="initial" name="init" value="1"> <label for="initial">initial</label>
                    ...
                    <tr>
                        <td rowspan="2">
                            <div class="flex-div first"><span><label>Goal 1:</label></span> <span> <textarea
                                        rows="1" placeholder="Enter Goal 1..." name="gl1"></textarea></span></div>
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="flex-div"><span><label>Objective 1:</label></span> <span><textarea
                                        rows="1" placeholder="Enter Objective..." name="gl1obj"></textarea></span></div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="flex-div"><span><label>Intervention 1:</label></span> <span><textarea
                                        rows="1" placeholder="Enter Intervention" name="gl1inter"></textarea></span>
                            </div>
                        </td>
                    </tr>
                    </tbody>
            ...
            <section class="section_2">
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td rowspan="2">
                            <div class="flex-div first"><span><label>Goal 2:</label></span> <span> <textarea
                                        rows="1" placeholder="Enter Goal 2..." name="gl2"></textarea></span></div>
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="flex-div"><span><label>Objective 1:</label></span> <span><textarea
                                        rows="1" placeholder="Enter Objective..." name="gl2obj"></textarea></span></div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="flex-div"><span><label>Intervention 1:</label></span> <span><textarea
                                        rows="1" placeholder="Enter Intervention" name="gl2inter"></textarea></span>
                            </div>
                        </td>
                    </tr>
                    </tbody>
            ...
            <section class="section_3">
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td rowspan="2">
                            <div class="flex-div first"><span><label>Goal 3:</label></span> <span> <textarea
                                        rows="1" placeholder="Enter Goal 3..." name="gl3"></textarea></span></div>
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="flex-div"><span><label>Objective 1:</label></span> <span><textarea
                                        rows="1" placeholder="Enter Objective..." name="gl3obj"></textarea></span></div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="flex-div"><span><label>Intervention 1:</label></span> <span><textarea
                                        rows="1" placeholder="Enter Intervention" name="gl3inter"></textarea></span>
                            </div>
                        </td>
                    </tr>
                    </tbody>
            ...
            <section class="section_4">
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td rowspan="2">
                            <div class="flex-div first"><span><label>Goal 4:</label></span> <span> <textarea
                                        rows="1" placeholder="Enter Goal 4..." name="gl4"></textarea></span></div>
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="flex-div"><span><label>Objective 1:</label></span> <span><textarea
                                        rows="1" placeholder="Enter Objective..." name="gl4obj"></textarea></span></div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="flex-div"><span><label>Intervention 1:</label></span> <span><textarea
                                        rows="1" placeholder="Enter Intervention" name="gl4inter"></textarea></span>
                            </div>
                        </td>
                    </tr>
                    </tbody>
