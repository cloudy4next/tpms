...
$auth=Client_authorization::where('client_id',$client->id)->first();
$diag='';
if($auth->diagnosis_one!=null) $diag.=$auth->diagnosis_one;
if($auth->diagnosis_two!=null) $diag.=','.$auth->diagnosis_two;
if($auth->diagnosis_three!=null) $diag.=','.$auth->diagnosis_three;
if($auth->diagnosis_four!=null) $diag.=','.$auth->diagnosis_four;
$ins=$auth->uci_id;
...
<div class="parent-training">
    ...
    <div class="content">
              ...
              <tr>
                <td>
                  <div class="flex-div"><span>
                      ...
                      <input type="text" id="diag" name="diag" value="{{ $diag}}">
                    </span></div>
                </td>
                <td colspan="2">
                  <div class="flex-div"><span>
                      ...
                      <input type="text" id="insured" name="insured" value="{{$ins}}">
                    </span></div>
                </td>
              </tr>
            </tbody>
              ...
              <tr>
                <td>
                  <div class="flex-div"><span>
                      ...
                      <input type="text" id="p_name" name="p_name" value="{{$provider->full_name}}">
                    </span></div>
                </td>
                <td>
                  <div class="flex-div"><span>
                      ...
                      <input type="text" id="cred" name="cred" value="{{$cred}}">
                    </span></div>
                </td>
              </tr>
            </tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="flex-div"><span>
                      ...
                      <input type="text" id="clname2" name="clname2" value="{{$client->client_full_name}}">
                    </span></div>
                </td>
                <td>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="bcbarad" value="1">BCBA
                    </label>
                  </div>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="bcbarad" value="2">RBT
                    </label>
                  </div>
                  <div class="form-check-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input" name="bcbarad" value="3">Other
                    </label>
                  </div>
                  <input type="text" class="border border-primary" placeholder="Explain.." name="otherexp">
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <section class="section_2 mb_30">
          ...
          <ul class="list-inline">
            <li class="list-inline-item">
              <div class="form-check-inline">
                <label class="form-check-label">
                  <input type="checkbox" class="form-check-input" name="in_person" value="1">In Person
                </label>
              </div>
            </li>
            <li class="list-inline-item">
              <div class="form-check-inline">
                <label class="form-check-label">
                  <input type="checkbox" class="form-check-input" name="remote" value="1">Remote
                </label>
              </div>
            </li>
          </ul>
              ...
              <tr>
                <td>
                  <div class="flex-div"><span>
                      ...
                      <input type="text" id="pfn" name="pfn" value="{{$provider->full_name}}">
                    </span></div>
                </td>
                <td>
                  <div class="flex-div"><span>
                    <label for="pcred">Provider Credentials:</label>
                      ...
                      <input type="text" id="pcred" name="pcred" value="{{$cred}}">
                    </span></div>
                </td>
              </tr>
            </tbody>
      ...
      <form class="pdf_form" action="{{ route('provider.print.form.12')}}" target="_blank" method="POST">
            @csrf
    ...
    $(document).ready(function () {
      ...
      $(document).on('click','.pdf_btn',function(){
        ...
        $(document).on('submit', '#form_12', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('provider.12.form.submit')}}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
