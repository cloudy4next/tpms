            ...
            <div class="top-part" style="margin-top:10px;">
                <div class="row1 flex-div mb_30">
                    <div class="client-name"><label>Client Name:</label> <input type="text"
                                                                                ...
                                                                                name="clname" value="{{$client->client_full_name}}">
                        <input type="hidden" placeholder="Enter Your Name..." name="sessionid" value="{{$session_id}}">
                    </div>
                    <div class="date"><label>DOS:</label> <input type="date" name="stdate" value="{{ $cl->schedule_date}}"></div>
                </div>
                <div class="row1 flex-div mb_30">
                    <div class="client-name"><label>Therapist:</label> <input type="text"
                                                                              placeholder="Enter Your Name..."
                                                                              name="terp"></div>
                    <div class="date"><label>Start Time:</label> <input type="time" name="sttitme" value="{{\Carbon\Carbon::parse($cl->from_time)->format('H:i:s')}}"></div>
                    <div class="date"><label>End Time:</label> <input type="time" name="endtime" value="{{\Carbon\Carbon::parse($cl->to_time)->format('H:i:s')}}"></div>
                </div>
                <div class="mb_30">
                ...
                <table cellpadding="0" cellspacing="0">
                        ...
                        <td rowspan="3">
                            <div class="flex-div first"><span><label>Location:</label></span> <span>
											<textarea class="form-control"
                                                      placeholder="Enter Location..." name="location"></textarea></span>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="flex-div">
										<span><label>Location of
											...
											<textarea class="form-control"
                                                      placeholder="Enter Location of Service..." name="los"></textarea></span>
                            </div>
                        </td>
                        <td>
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="spyn" value="1">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="spyn" value="2">No
                                </label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="cpins" value="1">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="cpins" value="2">No
                                </label>
                            </div>
                        </td>
                        <td>
