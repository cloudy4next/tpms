                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="subjective">{{$data->subjective}}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="text-primary">Objective</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="objective">{{$data->objective}}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="text-primary">Assessment</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="assessment">{{$data->assessment}}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="text-primary">Plan</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="plan">{{$data->plan}}</textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
