...
<div class="therapist-session-note">
    ...
    <div class="content">
        ...
        <form action="{{route('provider.tcsn.six.form.submit')}}" method="post" id="tcsn_six_form">
            @csrf
            <section class="section_1">
                <div class="box box_1">
                    ...
                    <input id="clname" type="text" name="clname" value="{{$form_six->clname}}">
                    ...
                    <input id="date" type="date" name="stdate" value="{{$form_six->stdate}}">
                  </span></div>
                        </div>
                        <div class="col-item">
                            <div class="flex-div"> <span>
                    ...
                    <input id="start-time" type="time" name="sttime" value="{{\Carbon\Carbon::parse($form_six->sttime)->format('H:i:s')}}">
                  </span></div>
                        </div>
                        <div class="col-item">
                            <div class="flex-div"> <span>
                    ...
                    <input id="end-time" type="time" name="endtime" value="{{\Carbon\Carbon::parse($form_six->endtime)->format('H:i:s')}}">
                  </span></div>
                        </div>
                        <div class="col-item">
                            <div class="flex-div">
                                ...
                                <div class="check-box-area">
                                    <ul>
                                        <li><span>
                          <input id="home" type="checkbox" name="setting1"
                                 {{$form_six->setting1 == 1 ? 'checked' : ''}} value="1">
                        </span><span>
                          <label for="home">Home</label>
                        </span></li>
                                        <li><span>
                          <input id="center" type="checkbox" name="setting2"
                                 {{$form_six->setting2 == 1 ? 'checked' : ''}} value="1">
                        </span> <span>
                          <label for="center">Center</label>
                        </span></li>
                                        <li><span>
                          <input id="community" type="checkbox" name="setting3"
                                 {{$form_six->setting3 == 1 ? 'checked' : ''}} value="1">
                        </span> <span>
                        ...
                        <div class="col-item">
                            <div class="flex-div">
                                ...
                                <div class="check-box-area">
                                    <ul>
                                        <li><span>
                          <input id="pclient" type="checkbox" name="pepresent1"
                                 {{$form_six->pepresent1 == 1 ? 'checked' : ''}} value="1">
                        </span><span>
                          <label for="pclient">Client</label>
                        </span></li>
                                        <li><span>
                          <input id="ptherapist" type="checkbox" name="pepresent2"
                                 {{$form_six->pepresent2 == 1 ? 'checked' : ''}} value="1">
                        </span> <span>
                          <label for="ptherapist">Therapist</label>
                        </span></li>
                                        <li><span>
                          <input id="pparent" type="checkbox" name="pepresent3"
                                 {{$form_six->pepresent3 == 1 ? 'checked' : ''}} value="1">
                        </span> <span>
                          <label for="pparent">Parent</label>
                        </span></li>
                                        <li><span>
                          <input id="pcaregiver" type="checkbox" name="pepresent4"
                                 {{$form_six->pepresent4 == 1 ? 'checked' : ''}} value="1">
                        </span><span>
                          <label for="pcaregiver">Caregiver</label>
                        </span></li>
                                        <li><span>
                          <input id="pbcba" type="checkbox" name="pepresent5"
                                 {{$form_six->pepresent5 == 1 ? 'checked' : ''}} value="1">
                        </span> <span>
                          <label for="pbcba">BCBA</label>
                        </span></li>
                                        <li><span>
                          <input id="pother" type="checkbox" name="pepresent6"
                                 {{$form_six->pepresent6 == 1 ? 'checked' : ''}} value="1">
                        </span> <span>
                          <label for="pother">Other:</label>
                          <input type="text" name="pepresentiotr" value="{{$form_six->pepresentiotr}}">
                        </span></li>
                                    </ul>
                                </div>
                            </div>
            ...
            <section class="section_2 mb_40">
                <div class="box box_1">
                    ...
                    apply)</span></td>
                            <td>
                                <div class="flex-div"> <span>
                      <input id="aggression" type="checkbox" name="dangerousbehave1"
                             {{$form_six->dangerousbehave1 == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="aggression">Aggression</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                      <input id="non-c" type="checkbox" name="dangerousbehave2"
                             {{$form_six->dangerousbehave2 == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="non-c">Non-compliance</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                      <input id="leaving-area" type="checkbox" name="dangerousbehave3"
                             {{$form_six->dangerousbehave3 == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="leaving-area">Leaving area</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                      <input id="inattention" type="checkbox" name="dangerousbehave4"
                             {{$form_six->dangerousbehave4 == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="inattention">Inattention</label>
                        ...
                        <tr>
                            <td>
                                <div class="flex-div"> <span>
                      <input id="diff-to-motive" type="checkbox" name="dangerousbehave5"
                             {{$form_six->dangerousbehave5 == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="diff-to-motive">Difficult to motivate</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                      <input id="obsessive" type="checkbox" name="dangerousbehave6"
                             {{$form_six->dangerousbehave6 == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="obsessive">Obsessive/preservative</label>
                            ...
                            <td colspan="2">
                                <div class="flex-div"> <span>
                      <input id="dangerous-other" type="checkbox" name="dangerousbehave7"
                             {{$form_six->dangerousbehave7 == 1 ? 'checked' : ''}} value="1">
                    </span><span class="other">
                      <label for="dangerous-other">Other:</label>
                      <input type="text" name="dangerousbehaveotr" value="{{$form_six->dangerousbehaveotr}}">
                    </span></div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="4">
                                <div class="flex-div">
                                    ...
                                    <div class="check-box-area">
                                        <ul>
                                            <li><span>
                            <input id="challange-b-yes" type="radio" name="chabehaviors"
                                   {{$form_six->chabehaviors == 1 ? 'checked' : ''}} value="1">
                          </span><span>
                            <label for="challange-b-yes">Yes</label>
                          </span></li>
                                            <li><span>
                            <input id="challange-b-no" type="radio" name="chabehaviors"
                                   {{$form_six->chabehaviors == 1 ? 'checked' : ''}} value="2">
                          </span> <span>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                      <input id="dtt" type="checkbox" name="dtt" {{$form_six->dtt == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="dtt">Discrete trial training (DTT)</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                      <input id="net" type="checkbox" name="net" {{$form_six->net == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="net">Natural Environment Training (NET)</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                      <input id="mt" type="checkbox" name="mt" {{$form_six->mt == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="mt">Mand training <span class="red bracket">(requests)</span></label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                      <input id="ta" type="checkbox" name="ta" {{$form_six->ta == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="ta">Task analysis (TA)</label>
                        ...
                        <tr>
                            <td>
                                <div class="flex-div"> <span>
                      <input id="bip" type="checkbox" name="bip" {{$form_six->bip == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="bip">Behavior Intervention Plan (BIP)</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                      <input id="shaping" type="checkbox" name="shaping"
                             {{$form_six->shaping == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="shaping">Shaping</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                      <input id="bst" type="checkbox" name="bst" {{$form_six->bst == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="bst">Behavior Skills Training (BST)</label>
                            ...
                            <td colspan="2">
                                <div class="flex-div"> <span>
                      <input id="iu-other" type="checkbox" name="iuotrcheck"
                             {{$form_six->iuotrcheck == 1 ? 'checked' : ''}} value="1">
                    </span><span class="other">
                      <label for="iu-other">Other:</label>
                      <input type="text" name="iuotrchecktxt" value="{{$form_six->iuotrchecktxt}}">
                    </span></div>
                            </td>
                        </tr>
                    </table>
                    <table class="table_2" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                        <input id="communication" type="checkbox" name="prarcom"
                               {{$form_six->prarcom == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        <label for="communication">Communication</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                        <input id="p-reports" type="checkbox" name="proarpair"
                               {{$form_six->proarpair == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        <label for="p-reports">Pairing/Rapport</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                        <input id="social-link" type="checkbox" name="proarscoial"
                               {{$form_six->proarscoial == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        ...
                        <tr>
                            <td>
                                <div class="flex-div"> <span>
                        <input id="self-care" type="checkbox" name="proarsc"
                               {{$form_six->proarsc == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        <label for="self-care">Adaptive/Self-care</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                        <input id="play-skill" type="checkbox" name="proarpsk"
                               {{$form_six->proarpsk == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        <label for="play-skill">Play Skills</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                        <input id="fluency" type="checkbox" name="proarflu"
                               {{$form_six->proarflu == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        ...
                        <tr>
                            <td>
                                <div class="flex-div"> <span>
                        <input id="tolerance" type="checkbox" name="proartnc"
                               {{$form_six->proartnc == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        <label for="tolerance">Tolerance of Novelty/Changes</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                        <input id="regulation" type="checkbox" name="proarsmr"
                               {{$form_six->proarsmr == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        <label for="regulation">Self-Management/Regulation</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                        <input id="program-other" type="checkbox" name="proarotr"
                               {{$form_six->proarotr == 1 ? 'checked' : ''}} value="1">
                      </span><span class="other">
                        <label for="program-other">Other:</label>
                        <input type="text" name="proarotrtxt" value="{{$form_six->proarotrtxt}}">
                      </span></div>
                            </td>
                        </tr>
                        </tbody>
                    ...
                    <table class="table_3">
                        ...
                        <tr>
                            <td>
                                <div class="flex-div"> <span>
                        <input id="f-correct" type="checkbox" name="ensession1"
                               {{$form_six->ensession1 == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        <label for="f-correct">Few correct</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                        <input id="s-correct" type="checkbox" name="ensession2"
                               {{$form_six->ensession2 == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        <label for="s-correct">Some correct</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                        <input id="m-correct" type="checkbox" name="ensession3"
                               {{$form_six->ensession3 == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        <label for="m-correct">Most correct</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                        <input id="all-correct" type="checkbox" name="ensession4"
                               {{$form_six->ensession4 == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                        <label for="all-correct">all correct</label>
                            ...
                            <td>
                                <div class="flex-div"> <span>
                        <input id="none-correct" type="checkbox" name="ensession5"
                               {{$form_six->ensession5 == 1 ? 'checked' : ''}} value="1">
                      </span><span>
                ...
                <table cellpadding="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      if for problem behavior)</span>:</label>
                            <br>
                            <textarea rows="2" id="motivating" type="text"
                                      name="motivating"> {!! $form_six->motivating !!}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td><label for="well">What went well?</label>
                            <br>
                            <textarea rows="2" id="well" type="text" name="well">{!! $form_six->well !!}</textarea>
                        </td>
                        <td><label for="struggle">What was a struggle?</label>
                            <br>
                            <textarea rows="2" id="struggle" type="text"
                                      name="struggle">{!! $form_six->struggle !!}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td><label for="help">What do you need or need help with?</label>
                            <br>
                            <textarea rows="2" id="help" type="text" name="help"> {!! $form_six->help !!}</textarea>
                        </td>
                        <td><label>If this was a supervision session check the appropriate box</label>
                            <br>
                            <div class="flex-div"> <span>
                      <input id="my-q" type="checkbox" name="supsession1"
                             {{$form_six->supsession1 == 1 ? 'checked' : ''}} value="1">
                    </span> <span>
                      <label for="my-q">My questions can wait until next supervision session</label>
                    </span></div>
                            <div class="flex-div"> <span>
                      <input id="clarification" type="checkbox" name="supsession2"
                             {{$form_six->supsession2 == 1 ? 'checked' : ''}} value="1">
                    </span> <span>
                      <label for="clarification">I still need more clarification on some things before my next
                        session</label>
                    </span></div>
                            <div class="flex-div"> <span>
                      <input id="concerns-q" type="checkbox" name="supsession3"
                             {{$form_six->supsession3 == 1 ? 'checked' : ''}} value="1">
                    </span> <span>
                      <label for="concerns-q">All of my questions/concerns were addressed</label>
                    </span></div>
                            <div class="flex-div"> <span>
                      <input id="supervision-na" type="checkbox" name="supsession4"
                             {{$form_six->supsession4 == 1 ? 'checked' : ''}} value="1">
                    </span> <span>
                    ...
                    <tr>
                        <td colspan="2"><label for="therapist-comments">Therapist Communication/Comments:</label>
                            ...
                            <textarea rows="2" id="therapist-comments" type="text"
                                      name="thcomts">{!! $form_six->thcomts !!} </textarea>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <section class="section_4">
                <div class="flex-div row-flex div_33 mb_30">
                  ...
                  <input id="print-name" type="text" name="priame1" value="{{$form_six->priame1}}">
                </span></div>
                    </div>
                    <div class="col-item">
                        <div class="flex-div"> <span>
                  ...
                  <input id="therapist-sign-date" type="date" name="thersigndate1" value="{{$form_six->thersigndate1}}">
                </span></div>
                    </div>
                </div>
                <div class="box box1">
                    <div class="col-title mb_15">
                        ...
                        <div class="check-box-area">
                            <ul>
                                <li><span>
                      <input id="pcq-yes" type="radio" name="pcqrbt"
                             {{$form_six->pcqrbt == 1 ? 'checked' : ''}} value="1">
                    </span><span>
                      <label for="pcq-yes">Yes</label>
                    </span></li>
                                <li><span>
                      <input id="pcq-no" type="radio" name="pcqrbt"
                             {{$form_six->pcqrbt == 1 ? 'checked' : ''}} value="1">
                    </span> <span>
                    ...
                    <div class="textarea mb_30">
                        <textarea rows="5" name="pcqrbtexp">{!! $form_six->pcqrbtexp !!}</textarea>
                    </div>
                </div>
                <div class="flex-div row-flex div_33 mb_30">
                    <div class="col-item">
                  ...
                  <input id="parent-print-name" type="text" name="prname2" value="{{$form_six->prname2}}">
                </span></div>
                    </div>
                    <div class="col-item">
                        <div class="flex-div"> <span>
                  ...
                  <input id="parent-sign-date" type="date" name="thersigndate2" value="{{$form_six->thersigndate2}}">
                </span></div>
                    </div>
                </div>
            </section>
        ...
        <form class="pdf_form" action="{{ route('provider.print.form.6')}}" target="_blank" method="POST">
            @csrf
...
<script>
    ...
    $(document).on('submit', '#tcsn_six_form', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('provider.tcsn.six.form.submit')}}",
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
