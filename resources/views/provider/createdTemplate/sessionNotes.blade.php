    ...
    <div class="content">
        ...
        <form action="" method="POST" id="form_13">
            ...
            <section class="section_1 mb_30">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <input type="time" id="stime" name="stime" value="{{\Carbon\Carbon::parse($data->stime)->format('H:i:s')}}">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="time" id="etime" name="etime" value="{{\Carbon\Carbon::parse($data->etime)->format('H:i:s')}}">
                    </span></div>
                        </td>
                    </tr>
                    <tr>
                      ...
                      <input type="number" id="units" name="units" value="{{ $data->units }}">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="text" id="sl" name="sl" value="{{ $data->sl }}">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="text" id="pxcode" name="pxcode" value="{{ $data->pxcode }}">
                    </span></div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div class="flex-div">
                                ...
                                <input type="text" id="on" name="on" value="{{ $data->on }}"></div>
                        </td>
                        <td>
                            <div class="flex-div">
                    ...
                    <tr>
                        <td>
                            <div class="flex-div">
                                ...
                                <input type="text" id="pcr" name="pcr" value="{{ $data->pcr }}">
                            </div>
                        </td>
                        <td>
                            <div class="flex-div">
                                <label for="pnpi">Provider NPI:</label>
                                <input type="text" id="pnpi" name="pnpi" value="{{ $data->pnpi }}">
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <section class="section_2 mb_30">
                ...
                <textarea rows="1" class="form-control" placeholder="Explain.."
                          name="other2">{{ $data->other2}}</textarea>
            </section>
            <section class="section_2 mb_30">
                <div class="col-title mb_30">
                        ...
                        <td class="text-left">
                            ...
                            <div class="textarea">
                                <textarea id="activities" rows="5"
                                          name="sessionnotes">{{$data->sessionnotes}}</textarea>
                            </div>
                        </td>
                    </tr>
                </table>
                        ...
                        <td>
                            <div class="flex-div">
                                ...
                                <input type="text" id="provider_name" name="provider_name"
                                       value="{{ $data->provider_name }}"></div>
                        </td>
                        <td>
                            <div class="flex-div">
                                <label for="pcredent">Provider Credentials :</label>
                                <input type="text" id="pcredent" name="pcredent" value="{{ $data->pcredent }}">
                            </div>
                        </td>
                    </tr>
                </table>
