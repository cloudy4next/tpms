            ...
            <section class="section_1 mb_30">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <input type="text" id="child-name" name="childname" value="{{$form_two->childname}}"
                             class="childname">
                      <input type="hidden" id="childname" name="sessionid" class="sessionid" value="{{$session_id}}">
                    </span></div>
                        </td>
                        <td colspan="2">
                            <div class="flex-div"><span>
                      ...
                      <input type="text" id="attendens" name="attendens" value="{{$form_two->childname}}"
                             class="attendens">
                    </span></div>
                        </td>
                    </tr>
                    <tr>
                      ...
                      <input type="time" id="start-time" name="starttime" class="starttime" value="{{\Carbon\Carbon::parse($data->starttime)->format('H:i:s')}}">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="time" id="end-time" name="endtime" class="endtime" value="{{\Carbon\Carbon::parse($data->endtime)->format('H:i:s')}}">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="date" id="date" name="stdate" value="{{$form_two->stdate}}" class="stdate">
                    </span></div>
                        </td>
                    </tr>
                    </tbody>
                    ...
                    <tr>
                        <td>
                            <input id="1st-row" type="checkbox" checked="checked" name="goals1"
                                   {{$form_two->goals1 == 1 ? 'checked' :''}} class="goals1"
                                   value="1">
                        </td>
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "{{route('provider.dsptn.two.by.ajax')}}",
            data: {
                '_token': "{{csrf_token()}}",
                'sessionid': sessionid,
            },
