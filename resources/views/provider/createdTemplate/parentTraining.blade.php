            ...
            <section class="section_1 mb_30">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <input type="text" id="diag" name="diag" value="{{ $data->diag }}">
                    </span></div>
                        </td>
                        <td colspan="2">
                            <div class="flex-div"><span>
            ...
            <section class="section_1 mb_30">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <input type="text" id="p_name" name="p_name" value="{{ $data->p_name }}">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
                      ...
                      <input type="text" id="cred" name="cred" value="{{ $data->cred }}">
                    </span></div>
                        </td>
                    </tr>
                    </tbody>
            ...
            <section class="section_1 mb_30">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <input type="text" id="clname2" name="clname2" value="{{ $data->clname2 }}">
                    </span></div>
                        </td>
                        <td>
