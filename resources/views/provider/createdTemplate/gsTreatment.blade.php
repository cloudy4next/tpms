...
<head>
    ...
    <title>Treatment Plan Form</title>
    <link rel="stylesheet" href="{{asset('assets/dashboard//')}}/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{asset('assets/dashboard//')}}/css/custom.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css">
    <link rel="stylesheet" href="{{asset('assets/dashboard/template/tem23/')}}/css/custom-23.css">
...
<div class="treatment-plan">
        <div class="content">
            ...
            <form action="" method="POST" id="form_23">
                @csrf
                                ...
                                <td>
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task" value="1" {{$data->task == 1 ? 'checked' : ''}}>Analyzing Data
                                        ...
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task" value="2" {{$data->task == 2 ? 'checked' : ''}}>Modifying Program
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task" value="3" {{$data->task == 3 ? 'checked' : ''}}>Modifying/Adding Goals
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task" value="4" {{$data->task == 4 ? 'checked' : ''}}>Developing BIP
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task" value="5" {{$data->task == 5 ? 'checked' : ''}}>Developing Plan
                                                </label>
                                            </div>
                                        </li>
                                    </ul>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="taskdes">{{$data->taskdes}}</textarea>
                                </td>
                            </tr>
            ...
            <form class="pdf_form" action="{{ route('provider.print.form.23')}}" target="_blank" method="POST">
            @csrf
...
<script>
    $(document).ready(function () {
      ...
      $(document).on('click','.pdf_btn',function(){
        ...
        $(document).on('submit', '#form_23', function (e) {
            e.preventDefault();
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('provider.23.form.submit')}}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
