...
<div class="treatment-plan">
        <div class="content">
                                ...
                                <td>
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="defict" value="1" {{$data->defict == 1 ? 'checked' : ''}}>Social
                                                </label>
                                        ...
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="defict" value="2" {{$data->defict == 2 ? 'checked' : ''}}>Play Skills
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="defict" value="3" {{$data->defict == 3 ? 'checked' : ''}}>Expressive
                                                    Language
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="defict" value="4" {{$data->defict == 4 ? 'checked' : ''}}>Receptive
                                                    Language
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="defict" value="5" {{$data->defict == 5 ? 'checked' : ''}}>Maladaptive
                                                    Behaviors
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="defict" value="6" {{$data->defict == 6 ? 'checked' : ''}}>Restrictive
            ...
            <form class="pdf_form" action="{{ route('provider.print.form.22')}}" target="_blank" method="POST">
            @csrf
    ...
    $(document).ready(function () {
      ...
      $(document).on('click','.pdf_btn',function(){
        ...
        $(document).on('submit', '#form_22', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('provider.22.form.submit')}}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
