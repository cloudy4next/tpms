...
<div class="treatment-plan">
        <div class="content">
            ...
            <form action="" method="POST" id="form_20">
                @csrf
                                ...
                                <td>
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    ...
                                                    <input type="radio" class="form-check-input" name="task" value="1" {{$data->task == 1 ? 'checked' : ''}}>Direct
                                                    Assessment
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task" value="2" {{$data->task == 2 ? 'checked' : ''}}>Indirect
                                                    Assessment
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task" value="3" {{$data->task == 3 ? 'checked' : ''}}>Creating Goals
                                                    Language
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task" value="4" {{$data->task == 4 ? 'checked' : ''}}>Creating
                                        ...
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task" value="5" {{$data->task == 5 ? 'checked' : ''}}>Creating
                                                    Report
                                                    Language
                                                </label>
                                            </div>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="assesstool">{{$data->assesstool}}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="text-primary">Description of Tasks Completed</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="destask">{{$data->destask}}</textarea>
                                </td>
                            </tr>
            ...
            <form class="pdf_form" action="{{ route('provider.print.form.20')}}" target="_blank" method="POST">
            @csrf
...
<script>
    $(document).ready(function () {
      ...
      $(document).on('click','.pdf_btn',function(){
        ...
        $(document).on('submit', '#form_20', function (e) {
            e.preventDefault();
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('provider.20.form.submit')}}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
