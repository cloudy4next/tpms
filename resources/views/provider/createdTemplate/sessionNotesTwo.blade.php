<?php
  ...
  $facility=\App\Models\setting_name_location::select('facility_name')->where('admin_id',$admin_id)->first();

  $app=\App\Models\Appoinment::select('id','schedule_date','from_time','to_time','client_id')->where('id',$session_id)->first();
  if($app){
    $client=\App\Models\Client::select('client_full_name','client_dob','client_city','client_state','client_street','client_zip')->where('id',$app->client_id)->first();
...
<div class="flex-div"> <span>
                ...
                <input id="birth-date" type="date" name="birth_date" value="{{$client_dob}}">
                </span> </div>
    </div>
...
<div class="flex-div"> <span>
    ...
    <div class="col-item mb_30">
      <div class="flex-div"> <span>
                ...
                <input id="session-date" type="date" name="session_date" value="{{\Carbon\Carbon::parse($app->schedule_date)->format('Y-m-d')}}">
                </span> </div>
    </div>
      <div class="col-item mb_30">
<div class="flex-div"> <span>
...
<div class="flex-div"> <span>
    ...
    <div class="col-item mb_30">
      <div class="flex-div"> <span>
                ...
                <input id="start-time" type="time" name="start_time" value="{{\Carbon\Carbon::parse($app->from_time)->format('H:i:s')}}"> 
                </span> </div>
    </div>
      <div class="col-item mb_30">
<div class="flex-div"> <span>
                ...
                <span>
               <input id="end-time" type="time" name="end_time" value="{{\Carbon\Carbon::parse($app->to_time)->format('H:i:s')}}">
                </span> </div>
    </div>
  </div>

<div class="flex-row flex-row_4 mb_30">
 <label for="service-loc">Service location full address: **Must include number, street, city, state, zip code**</label>  
...
<div class="flex-row flex-row_6 mb_30">
 <label for="entire_age">Parent/Guardian present during session: Someone over the age of 18 must be present during entire session.</label>  
...
<div class="flex-div">
 <h3>Location of Parent meeting if RBT is working 1:1 with client during same timeframe: </h3>   <br>
<div class="check-box-area">
                <ul>
                  <li><span>
                      <input id="timeframe-yes" type="radio" name="timeframe_rbt" value="1">
                    </span><span>
                      <label for="timeframe-yes">Room A</label>
                    </span></li>
                  <li><span>
                      <input id="timeframe-no" type="radio" name="timeframe_rbt" value="2">
                    </span> <span>
...
<div class="flex-row flex-row_8 mb_30">
 <label for="authorized-aba">Name of the authorized ABA supervisor: Full Name and credentials  (example Jane Doe, BCBA)</label>  
...
<div class="box">
<h3 style="text-style:normal;"><span class="red">Code used for this session: </span> **If you more than one code during session you must complete a note for each code.</h3> <br>
<h3 class="red">If supervision is being conducted do not use this form. You must use supervision form related to your credentialing.</h3>
</div>
</div>
...
<span>
<label for="analystcodes">Board Certified Behavior Analyst Codes</label>
</span>
</div>
    </th>
    <th>
...
<span>
<label for="techniciancodes">Registered Behavior Technician Codes</label>
</span>
</div>
    </th>
  </tr>
...
<div class="flex-div"> 
<span>
<input id="abadirect" type="checkbox" name="abadirect" value="ABA Direct Therapy by BCBA 97153">
</span>
<span>
<label for="abadirect">ABA Direct Therapy by BCBA 97153</label>
  ...
  <div class="flex-div"> 
<span>
<input id="RBT97153" type="checkbox" name="RBT97153" value="ABA Direct Therapy by RBT 97153">
</span>
<span>
...
<tr>
  ...
  <div class="flex-div"> 
<span>
<input id="Modification-97155" type="checkbox" name="modification_97155" value="Behavior Modification-97155">
</span>
<span>
<label for="Modification-97155">Behavior Modification-97155</label>
  ...
  <div class="flex-div"> 
<span>
<input id="H2019-Direct" type="checkbox" name="direct_h2" value="H2019-Direct BlueCare clients Only">
</span>
<span>
...
<div class="flex-row flex-row_11 mb_30">
 ...
 <h3>Stressor(s)/Extraordinary Events/ Significant Changes since last session with provider filling out this note: </h3><span class="red"><strong>Circle responses to all the following:</strong> </span>   <br>
...
<div class="check-box-area">
                <ul>
                  <li><span>
                      <input id="medication_yes" type="radio" name="medication" value="1">
                    </span><span>
                      <label for="medication_yes">Yes</label>
                    </span></li>
                  <li><span>
                      <input id="medication_no" type="radio" name="medication" value="2">
                    </span> <span>
...
<div class="check-box-area">
                <ul>
                  <li><span>
                      <input id="living_situation_yes" type="radio" name="living_situation" value="1">
                    </span><span>
                      <label for="living_situation_yes">Yes</label>
                    </span></li>
                  <li><span>
                      <input id="living_situation_no" type="radio" name="living_situation" value="2">
                    </span> <span>
...
<div class="check-box-area">
                <ul>
                  <li><span>
                      <input id="Insurance_yes" type="radio" name="insurance" value="1">
                    </span><span>
                      <label for="Insurance_yes">Yes</label>
                    </span></li>
                  <li><span>
                      <input id="Insurance_no" type="radio" name="insurance" value="2">
                    </span> <span>
...
<div class="check-box-area">
                <ul>
                  <li><span>
                      <input id="Illness_yes" type="radio" name="illness" value="1">
                    </span><span>
...
<div class="check-box-area">
                <ul>
                  <li><span>
                      <input id="NONE" type="radio" name="other_notable_change" value="1">
                    </span><span>
                      <label for="NONE">NONE</label>
                    </span></li>
                  <li><span>
                      <input id="family-activities" type="radio" name="other_notable_change" value="2">
                    </span> <span>
                      <label for="family-activities">or: Home family activities</label>
                    </span></li>

                     <li><span>
                      <input id="Inappropriate" type="radio" name="other_notable_change" value="3">
                    </span> <span>
                      <label for="Inappropriate">Inappropriate behaviors in school</label>
                    </span></li>

                    <li><span>
                      <input id="Inappropriate-community" type="radio" name="other_notable_change" value="4">
                    </span> <span>
                      <label for="Inappropriate-community">Inappropriate behaviors in community</label>
                    </span></li>
...
<div class="box">
<label style="text-style:normal;"> <span class="red">If yes to any changes above, please list in detail changes and impact on client. Medications changes noted by RBT must be communicated to BCBA on date of session.</span> <span style="color: #000;">(This section is required if YES.)</span></label>  <br>
...
<div class="flex-div">
<label> Danger to: <span style="color:#000">(circle or highlight response)</span> </label>   <br>
<div class="check-box-area">
                <ul>
                  <li><span>
                  ...
                  <li><span>
                    ...
                    <li><span>
                      <input id="danger-property" type="radio" name="danger" value="4">
                    </span> <span>
...
<div class="flex-div">
<label>If selected any option besides none select appropriate response: Danger = Yes you must select one of the following: </label>   <br>
<div class="check-box-area">
                <ul>
                  <li><span>
                      <input id="ideation-danger" type="radio" value="1" name="response_danger">
                    </span><span>
                      <label for="ideation-danger">Ideation</label>
                    </span></li>
                  <li><span>
                      <input id="plan-danger" type="radio" value="2" name="response_danger">
                    </span> <span>
                      <label for="plan-danger">Plan  </label>
                    </span></li>
                  <li><span>
                      <input id="attempt-danger" type="radio" value="3" name="response_danger">
                    </span> <span>
                      <label for="attempt-danger">Attempt  </label>
                    </span></li>
                    <li><span>
                      <input id="intent-danger" type="radio" value="4" name="response_danger">
                    </span> <span>
                      <label for="intent-danger">Intent </label>
                    </span></li>
                    <li><span>
                      <input id="other-danger" type="radio" value="5" name="response_danger">
                    </span> <span>
...
<div class="box">
<label style="text-style:normal; border-bottom: 1px solid #ddd; padding-bottom: 10px;"> <span class="red">***If YES selected you must notify your supervising BCBA immediately. The BCBA will contact the office if warranted. </span></label>  <br>
...
<div class="flex-row flex-row_15 mb_30">
<div class="box">
<label style="text-style:normal;"> Disposition of client upon arrival: Must be more than "same" and one-word answers:</label>  <br>
<textarea id="client_dispo" style="margin-top: 10px;" rows="2" cols="100vw" name="client_dispo"></textarea>  
<label>Activities/Goals/Objectives worked on during this session: (Must follow treatment plan.)</label>
</div>
</div>
...
<div class="flex-div"> 
<span>
<input id="Social-Skill" type="checkbox" value="Social Skill Acquisition" name="social_skill">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="roleplay" type="checkbox" value="Role Play" name="roleplay">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="tokenboard" type="checkbox" value="Token Board" name="tokenboard">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="visualaid" type="checkbox" value="Visual Aid" name="visualaid">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="Premack" type="checkbox" value="Premack Principle" name="premack">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="selfmonitor" type="checkbox" value="Self Monitor" name="selfmonitor">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="Errorless" type="checkbox" value="Errorless Learning" name="errorless">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="Stimulus" type="checkbox" value="Stimulus Prompts" name="stimulus">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="videomodeling" type="checkbox" value="Video Modeling" name="videomodeling">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="Antecedent" type="checkbox" value="Antecedent Manipulation" name="antecedent">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="Chaining" type="checkbox" value="Chaining" name="chaining">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="Shaping" type="checkbox" value="Shaping" name="shaping">
</span>
<span>
...
<div class="flex-div"> 
<span>
<input id="selfmanagement" type="checkbox" value="Self Management" name="selfmanagement">
</span>
<span>
...
<div class="flex-row flex-row_17 mb_30">
 ...
 <label style="color:#333;" for="Goals/Targets"> <span class="red">1)</span> Goals/Targets- Must include goal from treatment plan and must be identical to what is written in the treatment plan. Trials Ran etc. Examples: matching and identifying</label>  
...
<div class="flex-row flex-row_18 mb_30">
 <label style="color:#333;" for="Approach/ Measures"> <span class="red">2)</span> Treatment Approach/ Measures: How did you work on goal(s) from #1? What tools/techniques/supplies did you use? <span class="red"> This section must be more than a sentence or two.</span></label>  
...
<h4 class="red"><span style="font-weight:600;">Form is only valid for processioning if all areas are complete and correct.</span> <span style="font-weight: normal; font-size: 16px;">If parts of this form are incomplete you will be asked to send corrections before billing can be submitted. </span> <span style="color:#000; font-size: 16px;">This is a medical record and is not to be shared without permission from {{$facility->facility_name}}</span></h4>
</div>
            ...
            <input type="hidden" id="hidden_obj" value="{{$obj}}">
            <form class="pdf_form" action="{{ route('provider.print.form.61')}}" target="_blank" method="POST">
            @csrf
    ...
    $(document).ready(function () {
      ...
      $(document).on('click','.pdf_btn',function(){
        ...
        $(document).on('submit', '#form_61', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('provider.61.form.submit')}}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
