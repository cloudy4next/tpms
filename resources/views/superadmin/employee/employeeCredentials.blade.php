            ...
            <div class="d-lg-flex">
                ...
                <div class="all_menu">
                    <ul class="nav flex-column employee_menu">
                        ...
                        <li class="nav-item">
                            <a class="active" href="{{route('superadmin.emaployee.credentials',$employee->id)}}">Credentials</a>
                        </li>
                        <li class="nav-item">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="list-inline">
                                                            ...
                                                            <li class="list-inline-item">
                                                                <a href="{{route('superadmin.emaployee.credentials.delete',$credlist->id)}}"
                                                                   title="Delete"><i
                                                ...
                                                <div class="modal fade" id="credential_modal{{$credlist->id}}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form
                                                                action="{{route('superadmin.emaployee.credentials.update')}}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="list-inline">
                                                            ...
                                                            <li class="list-inline-item">
                                                                <a href="{{route('superadmin.employee.clearance.delete',$cellist->id)}}"
                                                                   title="Delete"><i
                                                                        class="ri-delete-bin-6-line text-danger"></i></a>
                                                            </li>
                                                        </ul>
                                                ...
                                                <div class="modal fade" id="clearance_modal{{$cellist->id}}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form
                                                                action="{{route('superadmin.employee.clearance.update')}}"
                                                                method="post" autocomplete="off"
                                                                enctype="multipart/form-data">
                                                                @csrf
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="list-inline">
                                                            ...
                                                            <li class="list-inline-item">
                                                                <a href="{{route('superadmin.employee.qualification.delete',$qualist->id)}}"
                                                                   title="Delete"><i
                                                                        class="ri-delete-bin-6-line text-danger"></i></a>
                                                            </li>
                                                        </ul>
                                                ...
                                                <div class="modal fade" id="qual_modal{{$qualist->id}}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form
                                                                action="{{route('superadmin.employee.qualification.update')}}"
                                                                method="post" autocomplete="off">
                                                                @csrf
    ...
    <div class="modal fade" id="credential_add" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{route('superadmin.emaployee.credentials.save')}}" method="post"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
    ...
    <div class="modal fade" id="clearance_add" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{route('superadmin.employee.clearance.save')}}" method="post"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
    ...
    <div class="modal fade" id="qual_add" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{route('superadmin.employee.qualification.save')}}" method="post"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
