                            ...
                            <div class="left">
                                    ...
                                    <div class="checkbox-area flex-div">
                                        <ul>
                                            <li class="group group_1">
                                                <input type="checkbox" id="Consumer" name="consumer"><label
                                                    for="Consumer">Consumer</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="checkbox" id="Other" name="pother"><label for="Other">Other</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="checkbox" id="fosterp" name="pparent"><label for="fosterp">Foster
                                                    Parents</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_4">
                                                <input type="checkbox" id="parent"><label
                                                    for="parent">Parent/Guardian</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="checkbox" id="staff" name="pgaurdian"><label for="staff">Group Home
                                                    Staff</label>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-item1 col-item mb_30">
                                    ...
                                    <div class="checkbox-area flex-div">
                                        <ul>
                                            <li class="group group_1">
                                                <input type="radio" id="agitated" name="affect"><label
                                                    for="agitated">Agitated</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" id="calm" name="affect"><label
                                                    for="calm">Calm</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="radio" id="flat" name="affect"><label
                                                    for="flat">Flat</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_4">
                                                <input type="radio" id="n-a" name="affect"><label for="n-a">N/A</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="radio" id="sad" name="affect"><label for="sad">Sad</label>
                                            </li>
                                            <li class="group group_1">
                                                <input type="radio" id="angry" name="affect"><label
                                                    for="angry">Angry</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_2">
                                                <input type="radio" id="defiant" name="affect"><label
                                                    for="defiant">Defiant</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="radio" id="happy" name="affect"><label
                                                    for="happy">Happy</label>
                                            </li>
                                            <li class="group group_4">
                                                <input type="radio" id="other" name="affect"><label
                                                    for="other">Other</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_5">
                                                <input type="radio" id="suicidal" name="affect"><label
                                                    for="suicidal">Suicidal</label>
                                            </li>
                                            <li class="group group_1">
                                                <input type="radio" id="anxious" name="affect"><label
                                                    for="anxious">Anxious</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" id="energetic" name="affect"><label
                                                    for="energetic">Energetic</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_3">
                                                <input type="radio" id="moody" name="affect"><label
                                                    for="moody">Moody</label>
                                            </li>
                                            <li class="group group_4">
                                                <input type="radio" id="playful" name="affect"><label
                                                    for="playful">Playful</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="radio" id="tired" name="affect"><label
                            ...
                            <div class="right">
                                <div class="col-item1 col-item mb_30">
                                    ...
                                    <div class="checkbox-area flex-div">
                                        <ul>
                                            <li class="group group_1">
                                                <input type="radio" id="f2f" name="contacttype"><label for="f2f">Face
                                                    to
                                                    Face</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" id="phone" name="contacttype"><label
                                                    for="phone">Phone</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="radio" id="attempts" name="contacttype"><label
                                                    for="attempts">Attempts</label></li>
                                        </ul>
                                        <ul>
                                            <li class="group group_4">
                                                <input type="radio" id="telehealth" name="contacttype"> <label
                                                    for="telehealth">Telehealth</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="radio" id="na" name="contacttype"><label
                                                    for="na">N/A</label>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-item1 col-item mb_30">
                                    ...
                                    <div class="checkbox-area">
                                        <ul>
                                            <li class="group group_1"><input type="radio" id="yes"
                                                    name="stressor"><label for="yes">yes</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" id="none-reported" name="stressor"><label
                                                    for="none-reported">None Reported</label>
                                            </li>
                                        </ul>
                                        <div class="inner"><label>if yes, please explain:</label><br>
                                            <textarea rows="1" name="stressexp"></textarea></div>
                                    </div>
                                </div>
                                <div class="col-item1 col-item mb_30">
                                    <h3>Comments:</h3>
                                    <div class="inner">
                                        <textarea rows="1" name="stresscomm"></textarea></div>
                                </div>
                            </div>
                        </div>
                    </section>
                    <section class="section_2">
                        <input type="checkbox" name="imi"> <label><strong>Include Mileage Information?</strong></label>
                        <br>
                        <br>
                            ...
                            <div class="col-item">
                                ...
                                <div class="inner">
                                    <select name="objselect">
                                        <option value="Objective1">Objective1</option>
                                        <option value="Objective2">Objective2</option>
                                        <option value="Objective3">Objective3</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-item">
                                <p><strong>Intervention:</strong></p>
                                <div class="inner" name="interselect">
                                    <select>
                    ...
                    <section class="section_3 section-common mb_30">
                        <div class="flex-div">
                            <div class="col-item">
                                ...
                                <div class="inner">
                                    <textarea rows="5" name="nonbill"></textarea></div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="section_10">
                        <div class="flex-div full-width">
                            <div class="col-item1  col-item mb_30">
                                ...
                                <div class="tabs"> <textarea rows="1" name="additional"></textarea></div>
                            </div>
                        </div>
                    </section>
