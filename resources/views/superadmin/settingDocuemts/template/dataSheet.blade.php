                        ...
                        <table>
                          <tr>
                            <td><label for="cname">Client:</label>
                              <input type="text" id="cname" name="clname"></td>
                        ...
                        <table cellpadding="0">
                          <tbody>
                            <tr>
                              ...
                              <td><input type="text" name="hr4_2"></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
                        ...
                        <table cellpadding="0">
                          <tbody>
                            <tr>
                              ...
                              <td><input type="text" name="hr4_3"></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
                      ...
                      <table cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td> <span><input name="b_10" type="text" style="width:30px; height:30px;"></span> <span class="plus">+</span>
                              10
                            </td>
                          </tr>
                          <tr>
                            <td> <span><input name="b_11" type="text" style="width:30px; height:30px;"></span> <span class="plus">+</span>
                              11
                            </td>
                            <td> <span><input name="b_12" type="text" style="width:30px; height:30px;"></span> <span class="plus">+</span>
                              12
                            </td>
                            <td> <span><input name="b_13" type="text" style="width:30px; height:30px;"></span> <span class="plus">+</span>
                              13
                            </td>
                            <td> <span><input name="b_14" type="text" style="width:30px; height:30px;"></span> <span class="plus">+</span>
                              14
                            </td>
                            <td> <span><input name="b_15" type="text" style="width:30px; height:30px;"></span> <span class="plus">+</span>
                              15
                            </td>
                          </tr>
                          <tr>
