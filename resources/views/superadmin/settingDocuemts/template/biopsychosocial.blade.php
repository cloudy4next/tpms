                ...
                <div class="content">
                        ...
                        <div class="box box3">
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="yes" type="radio" name="absences" value="1"> <label for="yes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="no" type="radio" name="absences" value="2"> <label for="no">No</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="ryes" type="radio" name="retained" value="1"> <label for="ryes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="rno" type="radio" name="retained" value="2"> <label for="rno">No</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="eyes" type="radio" name="classes" value="1"> <label for="eyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="eno" type="radio" name="classes" value="2"> <label for="eno">No</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="box box8">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="iprob" type="checkbox" name="lhistinfo" value="1"> <label
                                                for="iprob">Informal
                                                Probation</label>
                                        </li>
                                        <li>
                                            <input id="cws" type="checkbox" name="lhistwel" value="1"> <label for="cws">Child
                                                Welfare
                                                Services</label>
                                        </li>
                                        <li>
                                            <input id="rs-order" type="checkbox" name="lhistrestrain" value="1"> <label
                                                for="rs-order">Restraining Order</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="fprob" type="checkbox" name="lhistformal" value="1"> <label
                                                for="fprob">Formal
                                                Probation</label>
                                        </li>
                                        <li>
                                            <input id="conservatorship" type="checkbox" name="lhistconserv" value="1"> <label
                                                for="conservatorship">Conservatorship</label>
                                        </li>
                                        <li>
                                            <input id="non-report" type="checkbox" name="lhistnone" value="1"> <label
                                                for="non-report">None reported</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="parole" type="checkbox" name="lhistparole" value="1"> <label
                                                for="parole">Parole</label>
                                        </li>
                                        <li>
                                            <input id="dui" type="checkbox" name="lhistdui" value="1"> <label for="dui">D. U.
                                                I.</label>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="box box10">
                            <div class="col-item ">
                                ...
                                <div class="select-area mtb_10">
                                    <ul>
                                        <li>
                                            <input id="substanceyes" type="radio" name="substance" value="1"> <label
                                                for="substanceyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="substanceno" type="radio" name="substance" value="2"> <label
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="caffeine" type="checkbox" name="caffeine" value="1"> <label
                                                for="caffeine">Caffeine</label>
                                        </li>
                                        <li>
                                            <input id="p-medicine" type="checkbox" name="prescr" value="1"> <label
                                                for="p-medicine">Prescription Medication</label>
                                        </li>
                                        <li>
                                            <input id="hallucinogens" type="checkbox" name="halluc" value="1"> <label
                                                for="hallucinogens">Hallucinogens</label>
                                        </li>
                                        <li>
                                            <input id="sedatives" type="checkbox" name="sdativ" value="1"> <label
                                                for="sedatives">Sedatives</label>
                                        </li>
                                        <li>
                                            <input id="barbituates" type="checkbox" name="barbit" value="1"> <label
                                                for="barbituates">Barbituates</label>
                                        </li>
                                        <li>
                                            <input id="methadone" type="checkbox" name="methad" value="1"> <label
                                                for="methadone">Methadone</label>
                                        </li>
                                        <li>
                                            <input id="other" type="checkbox" name="subother" value="1"> <label
                                                for="other">Other</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="tobacco" type="checkbox" name="tobacco" value="1"> <label
                                                for="tobacco">Tobacco</label>
                                        </li>
                                        <li>
                                            <input id="alcohol" type="checkbox" name="alcohol" value="1"> <label
                                                for="alcohol">Alcohol</label>
                                        </li>
                                        <li>
                                            <input id="marijuana" type="checkbox" name="mariju" value="1"> <label
                                                for="marijuana">Marijuana</label>
                                        </li>
                                        <li>
                                            <input id="tranqulizers" type="checkbox" name="tranqu" value="1"> <label
                                                for="tranqulizers">Tranqulizers</label>
                                        </li>
                                        <li>
                                            <input id="methamphetamines" type="checkbox" name="metham" value="1"> <label
                                                for="methamphetamines">Methamphetamines</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="Over-the-counter" type="checkbox" name="overcount" value="1"> <label
                                                for="Over-the-counter">Over-the-counter Medication</label>
                                        </li>
                                        <li>
                                            <input id="inhalants" type="checkbox" name="inhalant" value="1"> <label
                                                for="inhalants">Inhalants</label>
                                        </li>
                                        <li>
                                            <input id="stimulants" type="checkbox" name="stimul" value="1"> <label
                                                for="stimulants">Stimulants</label>
                                        </li>
                                        <li>
                                            <input id="cocaine" type="checkbox" name="cocain" value="1"> <label
                        ...
                        <div class="box box1 flex-div mb_0">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="unremarkable" type="checkbox" name="unremark" value="1"> <label
                                                for="unremarkable">Unremarkable</label>
                                        </li>
                                        <li>
                                            <input id="unkempt" type="checkbox" name="unkempt" value="1"> <label
                                                for="unkempt">Unkempt</label>
                                        </li>
                                        <li>
                                            <input id="atclothing" type="checkbox" name="atypical" value="1"> <label
                            ...
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="person" type="checkbox" name="person" value="1"> <label
                                                for="person">Person</label>
                                        </li>
                                        <li>
                                            <input id="place" type="checkbox" name="place" value="1"> <label
                                                for="place">Place</label>
                                        </li>
                                        <li>
                                            <input id="odate" type="checkbox" name="oridate" value="1"> <label
                                                for="odate">Date</label>
                                        </li>
                                        <li>
                                            <input id="situation" type="checkbox" name="situation" value="1"> <label
                            ...
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="poor" type="checkbox" name="insightpoor" value="1"> <label
                                                for="poor">Poor</label>
                                        </li>
                                        <li>
                                            <input id="average" type="checkbox" name="insightaverage" value="1"> <label
                                                for="average">Average</label>
                                        </li>
                                        <li>
                                            <input id="good" type="checkbox" name="insightgood" value="1"> <label
                                                for="good">Good</label>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="jpoor" type="checkbox" name="judgpoor" value="1"> <label
                                                for="jpoor">Poor</label>
                                        </li>
                                        <li>
                                            <input id="javerage" type="checkbox" name="judgaver" value="1"> <label
                                                for="javerage">Average</label>
                                        </li>
                                        <li>
                                            <input id="jgood" type="checkbox" name="judggood" value="1"> <label
                        ...
                        <div class="box box3">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="unremarkable" type="checkbox" name="motorun" value="1"> <label
                                                for="unremarkable">Unremarkable</label>
                                        </li>
                                        <li>
                                            <input id="restless" type="checkbox" name="motorrest" value="1"> <label
                                                for="restless">Restless</label>
                                        </li>
                                        <li>
                                            <input id="withdrawn" type="checkbox" name="motorwith" value="1"> <label
                                                for="withdrawn">Withdrawn</label>
                                        </li>
                                        <li>
                                            <input id="s-speech" type="checkbox" name="motorslurr" value="1"> <label
                    ...
                    <section class="section_7 mb_30">
                        ...
                        <div class="select-area">
                            <ul>
                                <li>
                                    <input id="limits" type="checkbox" name="limit" value="1"> <label for="limits">All within normal
                                        limits</label>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="box box1">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="affeft1" type="checkbox" name="affun" value="1"> <label
                                                for="affeft1">Unremarkable</label>
                                        </li>
                                        <li>
                                            <input id="affeft2" type="checkbox" name="affcrit" value="1"> <label for="affeft2">Self
                                                Critical</label>
                                        </li>
                                        <li>
                                            <input id="affeft3" type="checkbox" name="affflat" value="1"> <label
                                                for="affeft3">Flat</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="affeft4" type="checkbox" name="affangr" value="1"> <label
                                                for="affeft4">Angry</label>
                                        </li>
                                        <li>
                                            <input id="affeft5" type="checkbox" name="affeuph" value="1"> <label
                                                for="affeft5">Euphoric</label>
                                        </li>
                                        <li>
                                            <input id="affeft6" type="checkbox" name="affsilly" value="1"> <label
                                                for="affeft6">Silly</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="affeft7" type="checkbox" name="affirri" value="1"> <label
                                                for="affeft7">Irritable</label>
                                        </li>
                                        <li>
                                            <input id="affeft8" type="checkbox" name="affdepr" value="1"> <label
                                                for="affeft8">Depressed</label>
                                        </li>
                                        <li>
                                            <input id="affeft9" type="checkbox" name="affhope" value="1"> <label
                        ...
                        <div class="box box2">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="d-like1" type="checkbox" name="depnone" value="1"> <label
                                                for="d-like1">None</label>
                                        </li>
                                        <li>
                                            <input id="d-like2" type="checkbox" name="dephypo" value="1"> <label
                                                for="d-like2">Hypoactive</label>
                                        </li>
                                        <li>
                                            <input id="d-like3" type="checkbox" name="depfati" value="1"> <label
                                                for="d-like3">Fatigue</label>
                                        </li>
                                        <li>
                                            <input id="d-like4" type="checkbox" name="depfee" value="1"> <label
                                                for="d-like4">Feelings
                                                of Worthlessness</label>
                                        </li>
                                        <li>
                                            <input id="d-like5" type="checkbox" name="depguilt" value="1"> <label
                                                for="d-like5">Guilt
                                                Feelings</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="d-like6" type="checkbox" name="dephelpless" value="1"> <label
                                                for="d-like6">Feelings
                                                of Helpless/Hopeless</label>
                                        </li>
                                        <li>
                                            <input id="d-like7" type="checkbox" name="depirrit" value="1"> <label
                                                for="d-like7">Irritability</label>
                                        </li>
                                        <li>
                                            <input id="d-like8" type="checkbox" name="deppoor" value="1"> <label
                                                for="d-like8">Poor
                                                Concentration</label>
                                        </li>
                                        <li>
                                            <input id="d-like9" type="checkbox" name="depsadn" value="1"> <label
                                                for="d-like9">Sadness</label>
                                        </li>
                                        <li>
                                            <input id="d-like10" type="checkbox" name="depsexual" value="1"> <label
                                                for="d-like10">Change
                                    ...
                                    <ul>
                                        <li>
                                            <input id="d-like11" type="checkbox" name="deploss" value="1"> <label
                                                for="d-like11">Loss
                                                of Ability to Enjoy (Anhedonia)</label>
                                        </li>
                                        <li>
                                            <input id="d-like12" type="checkbox" name="depwithdraw" value="1"> <label
                                                for="d-like12">Withdrawn</label>
                                        </li>
                                        <li>
                                            <input id="d-like13" type="checkbox" name="depself" value="1"> <label
                                                for="d-like13">Self-Blame/Self-Criticism</label>
                                        </li>
                                        <li>
                                            <input id="d-like14" type="checkbox" name="depinter" value="1"> <label
                                                for="d-like14">Loss
                                                of Interest</label>
                                        </li>
                                        <li>
                                            <input id="d-like15" type="checkbox" name="depcry" value="1"> <label
                        ...
                        <div class="box box4">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="think-1" type="checkbox" name="thinun" value="1"> <label
                                                for="think-1">Unremarkable</label>
                                        </li>
                                        <li>
                                            <input id="think-2" type="checkbox" name="thindis" value="1"> <label
                                                for="think-2">Distracted</label>
                                        </li>
                                        <li>
                                            <input id="think-3" type="checkbox" name="thindel" value="1"> <label
                                                for="think-3">Delusions</label>
                                        </li>
                                        <li>
                                            <input id="think-4" type="checkbox" name="thinhyp" value="1"> <label
                                                for="think-4">Hypochondriasis</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="think-5" type="checkbox" name="thindis" value="1"> <label
                                                for="think-5">Disorganized</label>
                                        </li>
                                        <li>
                                            <input id="think-6" type="checkbox" name="thinsus" value="1"> <label
                                                for="think-6">Suspicious</label>
                                        </li>
                                        <li>
                                            <input id="think-7" type="checkbox" name="thinobs" value="1"> <label
                                                for="think-7">Obsessions</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="think-8" type="checkbox" name="thinfli" value="1"> <label
                                                for="think-8">Flight of
                                                Ideas</label>
                                        </li>
                                        <li>
                                            <input id="think-9" type="checkbox" name="thinconf" value="1"> <label
                                                for="think-9">Confused</label>
                                        </li>
                                        <li>
                                            <input id="think-10" type="checkbox" name="thingrand" value="1"> <label
                        ...
                        <div class="box box6">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="att-1" type="checkbox" name="attun" value="1"> <label
                                                for="att-1">Unremarkable</label>
                                        </li>
                                        <li>
                                            <input id="att-2" type="checkbox" name="attego" value="1"> <label
                                                for="att-2">Egocentric</label>
                                        </li>
                                        <li>
                                            <input id="att-3" type="checkbox" name="attsar" value="1"> <label
                                                for="att-3">Sarcastic</label>
                                        </li>
                                        <li>
                                            <input id="att-4" type="checkbox" name="attres" value="1"> <label
                                                for="att-4">Resistant</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="att-5" type="checkbox" name="attcont" value="1"> <label
                                                for="att-5">Controlling</label>
                                        </li>
                                        <li>
                                            <input id="att-6" type="checkbox" name="atthost" value="1"> <label
                                                for="att-6">Hostile</label>
                                        </li>
                                        <li>
                                            <input id="att-7" type="checkbox" name="attneg" value="1"> <label
                                                for="att-7">Negativistic</label>
                                        </li>
                                        <li>
                                            <input id="att-8" type="checkbox" name="attpass" value="1"> <label
                                                for="att-8">Passive</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="att-9" type="checkbox" name="attaggr" value="1"> <label
                                                for="att-9">Passive-Aggressive</label>
                                        </li>
                                        <li>
                                            <input id="att-10" type="checkbox" name="attsedu" value="1"> <label
                        ...
                        <div class="box box2">
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="imyes" type="radio" name="immunizations" value="1"> <label
                                                for="imyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="imno" type="radio" name="immunizations" value="2"> <label
                                                for="imno">No</label>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="box box4">
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="satisfiedna" type="radio" name="satisfied" value="1"> <label
                                                for="satisfiedna">N/A</label>
                                        </li>
                                        <li>
                                        <li>
                                            <input id="satisfiedyes" type="radio" name="satisfied" value="2"> <label
                                                for="satisfiedyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="satisfiedno" type="radio" name="satisfied" value="3"> <label
                            ...
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="diagnosedna" type="radio" name="diagnosed" value="1"> <label
                                                for="diagnosedna">N/A</label>
                                        </li>
                                        <li>
                                            <input id="diagnosedyes" type="radio" name="diagnosed" value="2"> <label
                                                for="diagnosedyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="diagnosedno" type="radio" name="diagnosed" value="3"> <label
                            ...
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="referralna" type="radio" name="referral" value="1"> <label
                                                for="referralna">N/A</label>
                                        </li>
                                        <li>
                                            <input id="referralyes" type="radio" name="referral" value="2"> <label
                                                for="referralyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="referralno" type="radio" name="referral" value="3"> <label
                        ...
                        <div class="box box3">
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area mtb_10">
                                    <ul>
                                        <li>
                                            <input id="technologyes" type="radio" name="technology" value="1"> <label
                                                for="technologyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="technologno" type="radio" name="technology" value="2"> <label
                    ...
                    <section class="section_15">
                        ...
                        <div class="box box3">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="rservices-1" type="checkbox" name="rscomm" value="1"> <label
                                                for="rservices-1">Community referrals made, no further services
                                                needed</label>
                                        </li>
                                        <li>
                                            <input id="rservices-2" type="checkbox" name="rsmed" value="1"> <label
                                                for="rservices-2">Medication assessment</label>
                                        </li>
                                        <li>
                                            <input id="rservices-3" type="checkbox" name="rsind" value="1"> <label
                                                for="rservices-3">Individual therapy</label>
                                        </li>
                                        <li>
                                            <input id="rservices-4" type="checkbox" name="rsfam" value="1"> <label
                                                for="rservices-4">Family therapy</label>
                                        </li>
                                        <li>
                                            <input id="rservices-5" type="checkbox" name="rstesting" value="1"> <label
                                                for="rservices-5">Testing</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="rservices-6" type="checkbox" name="rscare" value="1"> <label
                                                for="rservices-6">By primary care physician</label>
                                        </li>
                                        <li>
                                            <input id="rservices-7" type="checkbox" name="rsbtl" value="1"> <label
                                                for="rservices-7">Brief therapy Long-term</label>
                                        </li>
                                        <li>
                                            <input id="rservices-8" type="checkbox" name="rscoll" value="1"> <label
                                                for="rservices-8">Collateral</label>
                                        </li>
                                        <li>
                                            <input id="rservices-9" type="checkbox" name="rsreha" value="1"> <label
                                                for="rservices-9">Day rehab/treatment</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="rservices-10" type="checkbox" name="rsasoc" value="1"> <label
                                                for="rservices-10">By ASOC or CSOG psychiatrist</label>
                                        </li>
                                        <li>
                                            <input id="rservices-11" type="checkbox" name="rsltt" value="1"> <label
                                                for="rservices-11">Long-term therapy</label>
                                        </li>
                                        <li>
                                            <input id="rservices-12" type="checkbox" name="rsgrou" value="1"> <label
                                                for="rservices-12">Group</label>
                                        </li>
                                        <li>
                                            <input id="rservices-13" type="checkbox" name="rsother" value="1"> <label
                        ...
                        <div class="box box4">
                            ...
                            <textarea rows="5" name="referral"></textarea>
                        </div>
                        <div class="box box5">
                ...
                <div class="section_bottom m-0">
                    <div class="button-row flex-div">
                        <div class="save-prog"><button type="button"><span class="cloud-icon"><i
                                ...
                                Save</button></div>
                        <div class="print" class="pdf_btn"><button type="button"><span class="print-icon"><i
