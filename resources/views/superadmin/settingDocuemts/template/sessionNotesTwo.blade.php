...
<div class="flex-div"> <span>
                ...
                <span>
                <textarea id="home-address" rows="1" cols="30" placeholder="Please Fill Home Address" name="home_address"></textarea>
                </span> </div>
    </div>
  </div>
...
<div class="col-item">
<h4 style="margin-bottom: 0px;" class="red">Provider Signature: Must be signed using signing software or printed and signed-cannot be a typed signature: <span style="color:#000; font-size: 16px; font-weight: normal;">By signing you are agreeing that what you are submitting is and accurate.</span></h4> 
...
<h4 class="red"><span style="font-weight:600;">Form is only valid for processioning if all areas are complete and correct.</span> <span style="font-weight: normal; font-size: 16px;">If parts of this form are incomplete you will be asked to send corrections before billing can be submitted. </span> <span style="color:#000; font-size: 16px;">This is a medical record and is not to be shared without permission from XXXXXXXXXXXXXXXXXXXXXXXXXX</span></h4>
</div>
