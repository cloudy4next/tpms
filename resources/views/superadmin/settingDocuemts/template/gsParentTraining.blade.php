                                ...
                                <td>
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti">BCBA 
                                        ...
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti">Parent/Caregiver
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti">Behavior Therapist 
                                                    Language
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti">Learner
                                                    Language
                                                </label>
                                            </div>
                                        </li>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="recm"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="intervent"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="text-primary">Feedback from Parent/Caregiver</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="feedback"></textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
