            ...
            <section class="section_1 mb_30">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <input type="text" id="session-length" name="session-length">
                    </span></div>
                        </td>
                        <td>
                            <div class="flex-div"><span>
            ...
            <section class="section_2 mb_30">
                <div class="box box1 mb_30">
                    ...
                    <ul class="checkbox-area">
                        <li>
                            <div class="flex-div"> <span>
                    <input id="person" type="checkbox" name="supervision-types">
                    <label for="person">In person </label>
                  </span></div>
                        </li>
                        <li>
                            <div class="flex-div"> <span>
                    <input id="telehealth" type="checkbox" name="supervision-types">
                    <label for="telehealth">Telehealth</label>
                  </span></div>
                        </li>
                        <li>
                            <div class="flex-div"> <span>
                    <input id="group-meeting" type="checkbox" name="supervision-types">
            ...
            <section class="section_3">
                ...
                <div class="box box1 mb_30">
                    ...
                    <div class="evaluation-of-performance">
                      ...
                      <input type="radio" id="s1" name="arrives-on-time">
                      <label for="s1">S</label>
                    </span> <span>
                      <input type="radio" id="ni1" name="arrives-on-time">
                      <label for="ni1">NI</label>
                    </span> <span>
                      <input type="radio" id="u1" name="arrives-on-time">
                      <label for="u1">U</label>
                    </span> <span>
                      <input type="radio" id="na1" name="arrives-on-time">
                      <label for="na1">N/A</label>
                            ...
                            <li>Maintains professional and courteous interactions with: Clients/consumers Other service
                                ...
                                Coworkers:<br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s2" name="coworkers">
                      <label for="s2">S</label>
                    </span> <span>
                      <input type="radio" id="ni2" name="coworkers">
                      <label for="ni2">NI</label>
                    </span> <span>
                      <input type="radio" id="u2" name="coworkers">
                      <label for="u2">U</label>
                    </span> <span>
                      <input type="radio" id="na2" name="coworkers">
                      <label for="na2">N/A</label>
                    </span></div>
                            </li>
                            <li>Maintains appropriate attire & demeanor Initiates professional self-improvement: <br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s3" name="self-improvement">
                      <label for="s3">S</label>
                    </span> <span>
                      <input type="radio" id="ni3" name="self-improvement">
                      <label for="ni3">NI</label>
                    </span> <span>
                      <input type="radio" id="u3" name="self-improvement">
                      <label for="u3">U</label>
                    </span> <span>
                      <input type="radio" id="na3" name="self-improvement">
                      <label for="na3">N/A</label>
                    </span></div>
                            </li>
                            <li>Accepts supervisory feedback appropriately: <br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s4" name="appropriately">
                      <label for="s4">S</label>
                    </span> <span>
                      <input type="radio" id="ni4" name="appropriately">
                      <label for="ni4">NI</label>
                    </span> <span>
                      <input type="radio" id="u4" name="appropriately">
                      <label for="u4">U</label>
                    </span> <span>
                      <input type="radio" id="na4" name="appropriately">
                      <label for="na4">N/A</label>
                    </span></div>
                            </li>
                            <li>Seeks supervision appropriately/ asks questions when needed: <br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s5" name="seeks">
                      <label for="s5">S</label>
                    </span> <span>
                      <input type="radio" id="ni5" name="seeks">
                      <label for="ni5">NI</label>
                    </span> <span>
                      <input type="radio" id="u5" name="seeks">
                      <label for="u5">U</label>
                    </span> <span>
                      <input type="radio" id="na5" name="seeks">
                      <label for="na5">N/A</label>
                    </span></div>
                            </li>
                            <li>Timely submission of tasks assigned: <br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s6" name="submission">
                      <label for="s6">S</label>
                    </span> <span>
                      <input type="radio" id="ni6" name="submission">
                      <label for="ni6">NI</label>
                    </span> <span>
                      <input type="radio" id="u6" name="submission">
                      <label for="u6">U</label>
                    </span> <span>
                      <input type="radio" id="na6" name="submission">
                      <label for="na6">N/A</label>
                    </span></div>
                            </li>
                            <li>Communicates effectively:<br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s7" name="Communicates">
                      <label for="s7">S</label>
                    </span> <span>
                      <input type="radio" id="ni7" name="Communicates">
                      <label for="ni7">NI</label>
                    </span> <span>
                      <input type="radio" id="u7" name="Communicates">
                      <label for="u7">U</label>
                    </span> <span>
                      <input type="radio" id="na7" name="Communicates">
                    ...
                    healthcare providers, caregivers etc)</span>:<br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s8" name="sensitivity">
                      <label for="s8">S</label>
                    </span><span>
                      <input type="radio" id="ni8" name="sensitivity">
                      <label for="ni8">NI</label>
                    </span> <span>
                      <input type="radio" id="u8" name="sensitivity">
                      <label for="u8">U</label>
                    </span> <span>
                      <input type="radio" id="na8" name="sensitivity">
                      <label for="na8">N/A</label>
                    </span></div>
                            </li>
                            <li>Acquisition of target behavior-analytic skills:<br>
                                <div class="select-area"> <span>
                      <input type="radio" id="s9" name="behavior-analytic">
                      <label for="s9">S</label>
                    </span> <span>
                      <input type="radio" id="ni9" name="behavior-analytic">
                      <label for="ni9">NI</label>
                    </span> <span>
                      <input type="radio" id="u9" name="behavior-analytic">
                      <label for="u9">U</label>
                    </span> <span>
                      <input type="radio" id="na9" name="behavior-analytic">
