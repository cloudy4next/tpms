            ...
            <form action="{{route('superadmin.setting.forms.builder.save')}}" method="post"
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" id="form_title" class="form-control form-control-sm" placeholder="Enter form title" value="{{$title}}">
                    </div>
                    <div class="col-md-3">
            ...
            var formBuilder= $(fbEditor).formBuilder().promise.then(formBuilder => {
                ...
                $(document).on('click', '.save-template', function () {
                    ...
                    if(form_title==''){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{ route('superadmin.setting.forms.builder.edit.save') }}",
                            data: {
                                '_token': "{{ csrf_token() }}",
                                'formHtml': htmldata,
