                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="chatbox" role="tabpanel">
                        ...
                        <div class="chat-footer p-3 bg-white">
                            ...
                            <form class="d-flex align-items-center" action="{{ route('superadmin.send.msg') }}" id="upload_form" enctype="multipart/form-data">
                                @csrf
                                <div class="chat-attagement d-flex">
                                    {{-- <a href="javascript:void();"><i class="fa fa-smile-o pr-3 emojionearea-button"
                                    aria-hidden="true"></i></a> --}}
                                        <a href="javascript:void();" id="upload">
                                            <i class="fa fa-paperclip pr-3" aria-hidden="true"></i>
                                        </a>
                                        <a href="javascript:void();" id="attach_client" title="Attach Patient Profile" data-toggle="modal" data-target="#attach_patient_modal">
                                            <i class="ri-user-add-line pr-3" aria-hidden="true"></i>
                                        </a>
...
@endsection
@include('superadmin.chat.include.chat_js')