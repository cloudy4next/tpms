...
@section('superadmin')
        ...
        <div class="iq-card-body">
            <div class="d-flex justify-content-between">
                <div class="align-self-center mb-2">
                    <h2 class="common-title m-0">Schedule Not Rendered</h2>
                </div>
                <div class="align-self-center mb-2">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-bordered c_table" id="export_table">
                    ...
                    <tbody>
                    @foreach($not_rendered as $not_red)
                        <?php
                        $client_name = \App\Models\Client::select('client_first_name', 'client_last_name')
                            ->where('id', $not_red->client_id)
                            ->first();

                        $pro = \App\Models\Employee::select('id', 'admin_id', 'full_name')->where('id', $not_red->provider_id)->first();
                        ...
                        <tr>
                            ...
                            <td>{{\Carbon\Carbon::parse($not_red->schedule_date)->format('m/d/Y')}}</td>
                        </tr>
                    @endforeach
    ...
    <input type="hidden" value="NotRendered_" id="fileName">
