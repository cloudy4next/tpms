        ...
        <div class="iq-card-body">
            ...
            <div class="d-lg-flex">
                ...
                <div class="all_content flex-fill">
                    <form action="{{route('superadmin.client.info.update')}}" method="post"
...
// Prepare the preview for profile picture
            ...
            $('#delete_sing').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('superadmin.client.sing.delete')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'client_id': client_id
                    },
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.existsphonedelete').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('superadmin.delete.exist.client.phone')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'phonid': phonid
                    },
            ...
            $('.deleteexistsemail').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('superadmin.delete.exist.client.email')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'emailid': emailid
                    },
            ...
            $('.deleteexistsaddress').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('superadmin.delete.exist.client.address')}}",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'addressid': addressid
                    },
