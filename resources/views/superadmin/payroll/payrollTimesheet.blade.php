    ...
    <div class="iq-card">
        <div class="iq-card-body">
            ...
            <div class="d-flex mb-4">
                ...
                <div class="mr-3 choose-staff">
                    <label>Staff</label>
                    <select class="form-control form-control-sm staff_provider multiselect" multiple required>
                ...
                <div class="d-flex actiondiv">
                    <div class="mr-3">
                        <select class="form-control form-control-sm timesheet_action">
                            ...
                            <option value="2">Delete Timesheet Statement</option>
...
@endsection
@include('superadmin.payroll.include.timesheetinc')
