    ...
    <div class="iq-card">
        <div class="iq-card-body">
            ...
            <ul class="nav nav-tabs mb-2">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('superadmin.completed.payroll')}}">Processed Payroll<span class="badge badge-warning ml-2">Step - 3</span></a>
                </li>
            </ul>
            <div class="tab-content">
                ...
                <div class="d-flex my-3">
                    ...
                    <div class="mr-3 align-self-end view-btn">
                        <button type="button" class="btn btn-sm btn-primary mr-2 process-btn" id="completedpayroll">
                            View
                        </button>
                    </div>
                    ...
                    <div class="d-flex actiondiv">
                        <div class="mr-3">
                            <select class="form-control form-control-sm process_action">
                                ...
                                <option value="1">Revert(Acceptance Pending)</option>
                                <option value="2">Revert(Acceptance Approved)</option>
                            </select>
                        </div>
...
@endsection
@include('superadmin.payroll.include.processedLastPayrollInc')
