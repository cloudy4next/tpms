                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="currstatus"></textarea>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="goaltarget"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="goaladdress"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="text-primary">Techniques Attempted During Session</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="techattempt"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="text-primary">Response to Treatment/Outcomes</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="restreat"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="text-primary">Progress Toward Treatment Goals</label>
                                    <textarea class="form-control" rows="3" placeholder="Enter here..." name="progressdata"></textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                            ...
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input"
                                                        name="render_prov" value="1">Rendering Provider
                                                </label>
                                            </div>
                                        </li>
                                    </ul>
