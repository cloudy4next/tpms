            ...
            <form action="" method="POST" id="form_9">
                ...
                <section class="section_1 mb_30">
                        ...
                        <div class="col-item">
                            <div class="input-area">
                                <span><label for="clname">Client Name: </label></span> <span><input type="text"
                                        id="clname" name="clname" value="{{ $client->client_full_name }}"></span>
                        ...
                        <div class="col-item">
                            <div class="input-area">
                                <span><label for="dob">DOB: </label></span> <span><input type="date"
                                        id="dob" name="dob" value="{{ $client->client_dob }}"></span>
                            </div>
                        </div>
                    </div>
                    <div class="flex-div mb_30">
                        <div class="col-item">
                            <div class="input-area">
                                <span><label for="adate">Date of Assessment: </label></span> <span><input
                                        type="date" name="doa" value="{{ $cl->schedule_date }}"></span>
                            </div>
                        </div>
                        <div class="col-item">
                            <div class="input-area">
                    ...
                    <div class="flex-div mb_30 grade">
                        <div class="col-item">
                            <div class="input-area">
                                <span><label>Insurance/Id#: </label></span> <span><input type="text"
                                        name="insid"></span>
                            </div>
                        </div>
                        <div class="col-item">
                ...
                <section class="section_2">
                    ...
                    <div class="box box1 mb_30">
                        ...
                        <div class="select-area">
                            <ul>
                                ...
                                <li>
                                    <input id="thistory2" type="radio" name="psyserv" value="2"> <label
                                        for="thistory2">No</label>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="box box2 mb_30">
                        ...
                        <div class="select-area">
                            <ul>
                                <li>
                                    <input id="thistory3" type="radio" name="prepsy" value="1"> <label
                                        for="thistory3">No</label>
                                </li>
                                <li>
                                    <span><input id="thistory4" type="radio" name="prepsy" value="2"> <label
                                            for="thistory4">Yes,</label></span>
                                </li>
                            </ul>
                    ...
                    <div class="box mb_30">
                        ...
                        <div class="select-area">
                            <ul>
                                <li>
                                    <input id="thistory5" type="radio" name="psymed" value="1"> <label
                                        for="thistory5">No</label>
                                </li>
                                <li class="flex-div">
                                    <span><input id="thistory6" type="radio" name="psymed" value="2"> <label
                                            for="thistory6">Yes</label> </span>
                                </li>
                            </ul>
                            <p class="font_600">If yes, please list</p>
                            <textarea name="preslist"></textarea>
                            <p class="font_600">Prescribed by:</p>
                            <textarea name="presby"></textarea>
                        </div>
                    </div>
                </section>
                <section class="section_4">
                    ...
                    <div class="box mb_30">
                        ...
                        <div class="select-area">
                            <ul>
                                <li>
                                    <input id="weight-change1" type="radio" name="wchange" value="1"> <label
                                        for="weight-change1">Yes</label>
                                </li>
                                <li>
                    ...
                    <div class="box mb_30 input-box">
                        ...
                        <div class="select-area">
                            <ul>
                                <li>
                                    <input id="romantic-relation1" type="radio" name="romrel" value="1">
                                    <label for="romantic-relation1">No</label>
                                </li>
                                <li class="flex-div">
                                    <span><input id="romantic-relation2" type="radio" name="romrel"
                                            value="2"> <label for="romantic-relation2">Yes </label></span>
                                </li>
                            </ul>
                    ...
                    <div class="box mb_30 input-box">
                        ...
                        <div class="select-area">
                            <ul>
                                ...
                                <li class="flex-div">
                                    <span><input id="cn-employed2" type="radio" name="curremp" value="2">
                                        <label for="cn-employed2">Yes </label></span>
                                </li>
                            </ul>
                            <div class="flex-div">
                            ...
                            <p><span>
                                    <textarea rows="5" name="workstress"></textarea>
                                </span></p>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="box input-box">
                        <div class="select-area">
                            <ul>
                                ...
                                <li class="flex-div">
                                    <span><input id="religious2" type="radio" name="religious" value="2">
                                        <label for="religious2">Yes
                                        </label></span>
                                </li>
                            </ul>
                    ...
                    <div class="table-box">
                        <table>
                            <thead>
                                ...
                                <tr>
                                    <td><span class="chekmark"><input type="checkbox" name="diagassess"
                                                value="1"></span> Diagnostic Assessment</td>
                                    <td><span class="chekmark"><input type="checkbox" name="nurse"
                                                value="1"></span> Nursing Assessment & Care
                                    </td>
                                    <td><span class="chekmark"><input type="checkbox" name="psytest"
                                                value="1"></span> Psychological Testing</td>
                                    <td><span class="chekmark"><input type="checkbox" name="psytreat"
                                                value="1"></span> Psychiatric Treatment</td>
                                </tr>
                                <tr>
                                    <td><span class="chekmark"><input type="checkbox" name="medadmin"
                                                value="1"></span> Medication Administration
                                    </td>
                                    <td><span class="chekmark"><input type="checkbox" name="commsupport"
                                                value="1"></span> Community Support
                                        Individual
                                    </td>
                                    <td><span class="chekmark"><input type="checkbox" name="indout"
                                                value="1"></span> Individual Outpatient
                                        Services
                                    </td>
                                    <td><span class="chekmark"><input type="checkbox" name="outser"
                                                value="1"></span> Family Outpatient Services
                                    </td>
                                </tr>
                                <tr>
                                    <td><span class="chekmark"><input type="checkbox" name="groupout"
                                                value="1"></span> Group Outpatient Services
                                    </td>
                                    <td><span class="chekmark"><input type="checkbox" name="intenfam"
                                                value="1"></span> Intensive Family
                                        Intervention
                                    </td>
                                    <td><span class="chekmark"><input type="checkbox" name="stab"
                                                value="1"></span> Crisis Stabilization</td>
                                    <td><span class="chekmark"><input type="checkbox" name="struct"
                                                value="1"></span> Structured Activity
                                        Supports
                                    </td>
                                </tr>
                                <tr>
                                    <td><span class="chekmark"><input type="checkbox" name="psyassess"
                                                value="1"></span>Psychical Assessment</td>
                                    <td><span class="chekmark"><input type="checkbox" name="behass"
                                                value="1"></span> Behavior Assistant</td>
                                    <td><span class="chekmark"><input type="checkbox" name="otherr"
                                                value="1"></span> Other</td>
                                    <td><span class="chekmark"><input type="checkbox" name="otherr2"
                                                value="1"></span> Other</td>
                                </tr>
                            </thead>
                        </table>
