                                ...
                                <td>
                                    <div class="flex-div"><span>
                                            ...
                                            <input type="time" id="stime" name="stime"
                                                value="{{ \Carbon\Carbon::parse($cl->from_time)->format('H:i:s') }}">
                                        </span></div>
                                </td>
                                <td>
                                    <div class="flex-div"><span>
                                            ...
                                            <input type="time" id="etime" name="etime"
                                                value="{{ \Carbon\Carbon::parse($cl->to_time)->format('H:i:s') }}">
                                        </span></div>
                                </td>
                            </tr>
                            <tr>
                ...
                <section class="section_2 mb_30">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="skill" value="1">Skill
                            Acquisition
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="social" value="1">Social
                            Skill Acquisition
                        </label>
                    </div>
                    <div class="form-check">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="prem" value="1">Premack
                            Principle
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="stimu" value="1">Stimulus
                            Prompts
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="modeling" value="1">Video
                            Modeling
                        </label>
                    </div>
                    <div class="form-check">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="contract" value="1">Behavior
                            Contract
                        </label>
                    </div>
                    <div class="form-check">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="tboard" value="1">Token
                            Board
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="selfm" value="1">Self
                            Monitor
                        </label>
                    </div>
                    <div class="form-check">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="antm" value="1">Antecedent
                            Manipulation
                        </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="selfmn" value="1">Self
                            Management
                        </label>
                    </div>
                    <div class="form-check">
