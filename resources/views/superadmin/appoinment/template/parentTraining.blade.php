...
$diag = '';
if ($auth->diagnosis_one != null) {
    $diag .= $auth->diagnosis_one;
}
if ($auth->diagnosis_two != null) {
    $diag .= ',' . $auth->diagnosis_two;
}
if ($auth->diagnosis_three != null) {
    $diag .= ',' . $auth->diagnosis_three;
}
if ($auth->diagnosis_four != null) {
    $diag .= ',' . $auth->diagnosis_four;
}
$ins = $auth->uci_id;
