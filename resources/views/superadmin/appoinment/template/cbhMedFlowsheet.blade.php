...
<head>
    ...
    <title>MEDICATION FLOWSHEET</title>
      ...
      <form action="#">
        ...
        <div class="top-part">
          <table cellpadding="0" cellspacing="0" class="extra">
            <tbody>
              <tr>
                <td colspan="8"><label>Patient Name:</label>
                  <input type="text" placeholder="Enter Here...">
                </td>
                <td><label>Allergies:</label>
                  <input type="text" placeholder="Enter Here...">
                </td>
              </tr>
              <tr class="text-center">
                ...
                <td colspan="3"><label>MEDICATION</label>
                </td>
                <td colspan="4"><label>REFILLS</label>
                </td>
              </tr>
              <tr class="text-center">
                ...
                <td colspan="3"><label>Dosage/Direction/Amount</label>
                </td>
                <td colspan="4"><label>Date/Amount/Initials</label>
                </td>
              </tr>
              <tr class="text-center">
                <td><input type="date">
                ...
                <td colspan="3"><input type="text" placeholder="Enter Here...">
                </td>
                <td></td>
                <td> </td>
                <td> </td>
