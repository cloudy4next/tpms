...
<body>
    <div class="parent-training">
        ...
        <div class="content">
            ...
            <form action="{{ route('superadmin.dsptn.two.form.submit') }}" method="post" id="form_2">
                @csrf
                            ...
                            <tr>
                                <td>
                                    <div class="flex-div"><span>
                                            ...
                                            <input type="text" id="child-name" name="childname" class="childname"
                                                value="{{ $client->client_full_name }}">
                                            <input type="hidden" id="childname" name="sessionid"
                                                value="{{ $session_id }}">
                                        </span></div>
                                </td>
                                <td colspan="2">
                ...
                <section class="section_2 mb_30">
                    ...
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <input id="1st-row" type="checkbox" name="goals1" class="goals1" value="1">
                            </td>
                ...
                <li class="list-inline-item">
                    <a href="#" data-target="#signatureModal" data-toggle="modal">Provider Signature<i
                ...
                <section class="section_bottom">
                    <div class="button-row flex-div">
                        <div class="save-prog">
                            <button type="submit" id="submit_btn"><span class="cloud-icon"><i
                                        class="fas fa-cloud"></i></span>Save<i
                                    class='fas fa-spinner bx-loader align-middle ml-2 btnloading'
