...
<head>
    ...
    <title>No Show Progress Note</title>
    ...
    <div class="content">
      ...
      <form action="#">
        <div class="page-title mb_40">
          <h1> No Show Progress Note</h1>
        </div>
        <div class="top-part">
          <table cellpadding="0" cellspacing="0">
            <tbody>
              <tr>
                <td><label>Name of Client: </label> <input type="text" placeholder="Enter Here..."></td>
                <td><label>DOB:</label> <input type="text" placeholder="Enter Here..."></td>
              </tr>
              <tr>
                <td><label>MR #: </label> <input type="text" placeholder="Enter Here..."></td>
                <td><label>Date of Service: </label> <input type="date"></td>
              </tr>
              <tr>
                <td><label>Service Provider Name: </label> <input type="text" placeholder="Enter Here..."></td>
                <td>
                  <div class="flex-div">
                    <span><label>Credentials</label></span> <span>
        ...
        <div class="top-part">
          ...
          <div class="form-check-inline">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="yn">The Client/family no showed/no call for today’s
              appointment.
            </label>
          </div>
          <div class="form-check-inline d-block">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="yn"> Therapeutic Behavioral On-Site Services
              (H2019 HO)
            </label>
          </div>
          <div class="form-check-inline d-block">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="yn"> Individual /Family Therapy (H2019 HR)
            </label>
          </div>
        </div>
        <div class="top-part mt-5">
          <label> Staff: <a href="#" data-target="#signatureModal" data-toggle="modal">Add Signature<i class="fa fa-signature"></i></a></label>
        </div>
