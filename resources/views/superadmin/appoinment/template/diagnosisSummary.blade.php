...
<body>
    <div class="treatment-plan">
        <div class="content">
                    ...
                    <div class="flex-div div_33 mb_30">
                        ...
                        <div class="col-item">
                            <div class="input-area"> <span>
                                    ...
                                    <input type="date" id="dob" name="dob" name="dob"
                        ...
                        <div class="col-item">
                            <div class="input-area"> <span>
                                    ...
                                    <input type="date" id="daydate" name="date" name="sdate"
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.29') }}" target="_blank" method="POST">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_29', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('superadmin.29.form.submit') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
