...
<body>
    <div class="treatment-plan">
        <div class="content">
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="1">Analyzing Data
                                        ...
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="3">Modifying/Adding Goals
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.23') }}" target="_blank" method="POST">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_23', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('superadmin.23.form.submit') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
