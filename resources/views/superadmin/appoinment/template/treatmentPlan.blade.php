...
<body>
    <div class="treatment-plan">
        <div class="content">
            ...
            <form action="{{ route('superadmin.tp.eight.form.submit') }}" method="post" id="tp_eight_from">
                @csrf
                ...
                <div class="top-part" style="margin-top:10px;">
                    ...
                    <div class="row2 mb_30"><span><label>Type of Treatment Plan:</label></span> <span>
                            <input type="checkbox" id="initial" name="init" value="1"> <label
                                for="initial">initial</label>
                            <input type="checkbox" id="ongoing" name="ongoing" value="1"><label
                ...
                <section class="section_1">
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td rowspan="2">
                                    <div class="flex-div first"><span><label>Goal 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Goal 1..." name="gl1"></textarea>
                                        </span></div>
                                </td>
                                <td><label>Open Date:</label><input type="date" name="gl1opendt"></td>
                            </tr>
                            <tr>
                                <td><label>Target Date:</label> <input type="date" name="gl1trdat"></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Objective 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Objective..." name="gl1obj"></textarea>
                                        </span></div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Intervention 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Intervention" name="gl1inter"></textarea>
                                        </span>
                                    </div>
                                </td>
                            </tr>
                ...
                <section class="section_2">
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td rowspan="2">
                                    <div class="flex-div first"><span><label>Goal 2:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Goal 2..." name="gl2"></textarea>
                                        </span></div>
                                </td>
                                <td><label>Open Date:</label><input type="date" name="gl2opdt"></td>
                            </tr>
                            <tr>
                                <td><label>Target Date:</label> <input type="date" name="gl2trdt"></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Objective 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Objective..." name="gl2obj"></textarea>
                                        </span></div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Intervention 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Intervention" name="gl2inter"></textarea>
                                        </span>
                                    </div>
                                </td>
                            </tr>
                ...
                <section class="section_3">
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td rowspan="2">
                                    <div class="flex-div first"><span><label>Goal 3:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Goal 3..." name="gl3"></textarea>
                                        </span></div>
                                </td>
                                <td><label>Open Date:</label><input type="date" name="gl3opdt"></td>
                            </tr>
                            <tr>
                                <td><label>Target Date:</label> <input type="date" name="gl3trdt"></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Objective 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Objective..." name="gl3obj"></textarea>
                                        </span></div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Intervention 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Intervention" name="gl3inter"></textarea>
                                        </span>
                                    </div>
                                </td>
                            </tr>
                ...
                <section class="section_4">
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td rowspan="2">
                                    <div class="flex-div first"><span><label>Goal 4:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Goal 4..." name="gl4"></textarea>
                                        </span></div>
                                </td>
                                <td><label>Open Date:</label><input type="date" name="gl4opdt"></td>
                            </tr>
                            <tr>
                                <td><label>Target Date:</label> <input type="date" name="gl4trdt"></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Objective 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Objective..." name="gl4obj"></textarea>
                                        </span></div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Intervention 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Intervention" name="gl4inter"></textarea>
                                        </span>
                                    </div>
                                </td>
                            </tr>
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.8') }}" target="_blank" method="POST">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#tp_eight_from', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('superadmin.tp.eight.form.submit') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
