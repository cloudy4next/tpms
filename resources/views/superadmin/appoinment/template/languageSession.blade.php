                                    ...
                                    <td>
                                        <div class="flex-div"><span><label for="clname">Client’s Name:</label></span>
                                            <span><input type="text" id="clname" name="clname"
                                                    value="{{ $client->client_full_name }}"></span>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex-div"><span><label for="dos">Date of
                                                    session:</label></span>
                                            <span><input type="date" id="dos" name="dos1"></span>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div><span><label>Short-term goals Addressed:</label> <br></span>
                                            <span>
                                                <textarea rows="5" placeholder="Enter short-term goals..." name="stg1"></textarea>
                                            </span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <div><span><label>Activity, progress & carryover:</label> <br></span>
                                            <span>
                                                <textarea rows="5" placeholder="Enter Activity, progress & carryover..." name="apc1"></textarea>
                                            </span>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="flex-div"><span><label for="dos">Date of
                                                    session:</label></span>
                                            <span><input type="date" id="dos" name="dos2"></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex-div"><span><label>CPT Code:</label></span> <span><input
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div><span><label>Short-term goals Addressed:</label> <br></span>
                                            <span>
                                                <textarea rows="5" placeholder="Enter short-term goals..." name="stg2"></textarea>
                                            </span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <div><span><label>Activity, progress & carryover:</label> <br></span>
                                            <span>
                                                <textarea rows="5" placeholder="Enter Activity, progress & carryover..." name="apc2"></textarea>
                                            </span>
                                        </div>
                                    </td>
                                </tr>
