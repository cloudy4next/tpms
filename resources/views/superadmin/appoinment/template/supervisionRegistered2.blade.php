                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="a_2"
                                        value="1">A-2 Implement
                                    continuous measurement procedures (e.g.,
                                    frequency, duration)
                                </label>
                            </div>
                            <div class="form-check">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_1"
                                        value="1">C-1 Identify the
                                    essential components of a written
                                    skill
                                    acquisition plan
                                </label>
                            </div>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_3"
                                        value="1">C-3 Use
                                    contingencies of reinforcement (e.g.,
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_5"
                                        value="1">C-5 Implement
                                    naturalistic teaching procedures (e.g.,
                                    incidental teaching)
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_6"
                                        value="1">C-6 Implement task
                                    analyzed chaining procedures.
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_7"
                                        value="1">C-7 Implement
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="d_3"
                                        value="1">D-3 Implement
                                    interventions based on modification of
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="d_6"
                                        value="1">D-6 Implement
                                    crisis/emergency procedures according to
                                    protocol
                                </label>
                            </div>
                        </li>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="e_1"
                                        value="1">E-1 Effectively
                                    communicate with a supervisor in an
                                    ongoing manner
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="e_2"
                                        value="1">E-2 Actively seek
                                    clinical direction from supervisor
                                    in
                                    a timely manner
                                </label>
                            </div>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="e_4"
                                        value="1">E-4 Generate
                                    objective session notes for service
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="f_2"
                                        value="1">F-2 Respond
                                    appropriately to feedback and maintain or
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="f_3"
                                        value="1">F-3 Communicate
                                    with stakeholders (e.g., family,
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="f_4"
                                        value="1">F-4 Maintain
                                    professional boundaries (e.g., avoid dual
