        ...
        <form action="{{route('superadmin.tcsn.six.form.submit')}}" method="post" id="tcsn_six_form">
            ...
            <section class="section_1">
                <div class="box box_1">
                    ...
                    <input id="start-time" type="time" name="sttime" value="{{\Carbon\Carbon::parse($data->sttime)->format('H:i:s')}}">
                  </span></div>
                        </div>
                        <div class="col-item">
                            <div class="flex-div"> <span>
                    ...
                    <input id="end-time" type="time" name="endtime" value="{{\Carbon\Carbon::parse($data->endtime)->format('H:i:s')}}">
                  </span></div>
                        </div>
                        <div class="col-item">
                            <div class="flex-div">
