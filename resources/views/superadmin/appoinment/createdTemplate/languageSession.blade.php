...
<body>
    <div class="treatment-plan">
        <div class="content">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex-div"><span><label for="clname">Client’s Name:</label></span>
                                            <span><input type="text" id="clname" name="clname"
                                                    value="{{ $data->clname }}"></span>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex-div"><span><label>ICD-10 Code:</label></span> <span><input
                                                    type="text" name="icd" value="{{ $data->icd }}"></span>
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
                    ...
                    <section class="section_2 mb_40">
                        <table cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="flex-div"><span><label for="dos">Date of
                                                    session:</label></span>
                                            <span><input type="date" id="dos" name="dos1"
                                                    value="{{ $data->dos1 }}"></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex-div"><span><label>CPT Code:</label></span> <span><input
                                                    type="text" name="cpt1" value="{{ $data->cpt1 }}"></span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <div><span><label>Short-term goals Addressed:</label> <br></span>
                                            <span>
                                                <textarea rows="5" placeholder="Enter short-term goals..." name="stg1">{{ $data->stg1 }}</textarea>
                                            </span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <div><span><label>Activity, progress & carryover:</label> <br></span>
                                            <span>
                                                <textarea rows="5" placeholder="Enter Activity, progress & carryover..." name="apc1">{{ $data->apc1 }}</textarea>
                                            </span>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="flex-div"><span><label for="dos">Date of
                                                    session:</label></span>
                                            <span><input type="date" id="dos" name="dos2"
                                                    value="{{ $data->dos2 }}"></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex-div"><span><label>CPT Code:</label></span> <span><input
                                                    type="text" name="cpt2" value="{{ $data->cpt2 }}"></span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <div><span><label>Short-term goals Addressed:</label> <br></span>
                                            <span>
                                                <textarea rows="5" placeholder="Enter short-term goals..." name="stg2">{{ $data->stg2 }}</textarea>
                                            </span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <div><span><label>Activity, progress & carryover:</label> <br></span>
                                            <span>
                                                <textarea rows="5" placeholder="Enter Activity, progress & carryover..." name="apc2">{{ $data->apc2 }}</textarea>
                                            </span>
                                        </div>
                                    </td>
                                </tr>
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.28') }}" target="_blank" method="POST">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_28', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('superadmin.28.form.submit') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
