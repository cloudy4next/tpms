...
<body>
    <div class="treatment-plan">
        <div class="content">
                                ...
                                <td>
                                    <ul class="list-inline">
                                        ...
                                        <li class="list-inline-item">
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" name="render_prov"
                                                        value="1"
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.19') }}" target="_blank" method="POST">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_19', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('superadmin.19.form.submit') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
