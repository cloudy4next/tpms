...
<body>
    <div class="parent-training">
        ...
        <div class="content">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="a_1"
                                        {{ $data->a_1 == 1 ? 'checked' : '' }} value="1">A-1 Prepare for data
                                    collection
                                </label>
                            </div>
                            <div class="form-check">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="a_3"
                                        {{ $data->a_3 == 1 ? 'checked' : '' }} value="1">A-3 Implement
                                    discontinuous
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="a_4"
                                        {{ $data->a_4 == 1 ? 'checked' : '' }} value="1">A-4 Implement
                                    permanent-product
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="a_5"
                                        {{ $data->a_5 == 1 ? 'checked' : '' }} value="1">A-5 Enter data and
                                    update graphs
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="a_6"
                                        {{ $data->a_6 == 1 ? 'checked' : '' }} value="1">A-6 Describe behavior
                                    and
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="b_1"
                                        {{ $data->b_1 == 1 ? 'checked' : '' }} value="1">B-1 Conduct preference
                                    assessments
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="b_2"
                                        {{ $data->b_2 == 1 ? 'checked' : '' }} value="1">B-2 Assist with
                                    individualized
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="b_3"
                                        {{ $data->b_3 == 1 ? 'checked' : '' }} value="1">B-3 Assist with
                                    functional
                                    assessment procedures
                                </label>
                            </div>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_1"
                                        {{ $data->c_1 == 1 ? 'checked' : '' }} value="1">C-1 Identify the
                                    essential
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_2"
                                        {{ $data->c_2 == 1 ? 'checked' : '' }} value="1">C-2 Prepare for the
                                    session as
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_4"
                                        {{ $data->c_4 == 1 ? 'checked' : '' }} value="1">C-4 Implement
                                    discrete-trial
                                    teaching procedures
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_5"
                                        {{ $data->c_5 == 1 ? 'checked' : '' }} value="1">C-5 Implement
                                    naturalistic
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_6"
                                        {{ $data->c_6 == 1 ? 'checked' : '' }} value="1">C-6 Implement task
                                    analyzed
                                    chaining procedures.
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_7"
                                        {{ $data->c_7 == 1 ? 'checked' : '' }} value="1">C-7 Implement
                                    discrimination
                                    training
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_8"
                                        {{ $data->c_8 == 1 ? 'checked' : '' }} value="1">C-8 Implement stimulus
                                    control
                                    transfer procedures
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_9"
                                        {{ $data->c_9 == 1 ? 'checked' : '' }} value="1">C-9 Implement prompt and
                                    prompt
                                    fading procedures
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_10"
                                        {{ $data->c_10 == 1 ? 'checked' : '' }} value="1">C-10 Implement
                                    generalization and
                                    maintenance
                                    procedures
                                </label>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_11"
                                        {{ $data->c_11 == 1 ? 'checked' : '' }} value="1">C-11 Implement shaping
                                    procedures
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="c_12"
                                        {{ $data->c_12 == 1 ? 'checked' : '' }} value="1">C-12 Implement token
                                    economy
                                    procedures
                                </label>
                            </div>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="d_1"
                                        {{ $data->d_1 == 1 ? 'checked' : '' }} value="1">D-1 Identify essential
                                    components
                                    of a written
                                    behavior
                                    reduction plan
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="d_2"
                                        {{ $data->d_2 == 1 ? 'checked' : '' }} value="1">D-2 Describe common
                                    functions of
                                    behavior
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="d_3"
                                        {{ $data->d_3 == 1 ? 'checked' : '' }} value="1">D-3 Implement
                                    interventions based
                                    on modification of
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="d_4"
                                        {{ $data->d_4 == 1 ? 'checked' : '' }} value="1">D-4 Implement
                                    differential
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="d_6"
                                        {{ $data->d_6 == 1 ? 'checked' : '' }} value="1">D-6 Implement
                                    crisis/emergency
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="e_1"
                                        {{ $data->e_1 == 1 ? 'checked' : '' }} value="1">E-1 Effectively
                                    communicate with a
                                    supervisor in an
                                    ongoing manner
                                </label>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="e_2"
                                        {{ $data->e_2 == 1 ? 'checked' : '' }} value="1">E-2 Actively seek
                                    clinical
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="e_3"
                                        {{ $data->e_3 == 1 ? 'checked' : '' }} value="1">E-3 Report other
                                    variables that
                                    might affect the
                                    client
                                    in a timely manner
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="e_4"
                                        {{ $data->e_4 == 1 ? 'checked' : '' }} value="1">E-4 Generate objective
                                    session
                                    notes for service
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="e_5"
                                        {{ $data->e_5 == 1 ? 'checked' : '' }} value="1">E-5 Comply with
                                    applicable legal,
                                    regulatory, and
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="f_1"
                                        {{ $data->f_1 == 1 ? 'checked' : '' }} value="1">F-1 Describe the BACB’s
                                    RBT
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="f_2"
                                        {{ $data->f_2 == 1 ? 'checked' : '' }} value="1">F-2 Respond
                                    appropriately to
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="f_3"
                                        {{ $data->f_3 == 1 ? 'checked' : '' }} value="1">F-3 Communicate with
                                    stakeholders
                                    (e.g., family,
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="f_4"
                                        {{ $data->f_4 == 1 ? 'checked' : '' }} value="1">F-4 Maintain
                                    professional
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="f_5"
                                        {{ $data->f_5 == 1 ? 'checked' : '' }} value="1">F-5 Maintain client
                                    dignity
                                </label>
                            </div>
                        </li>
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.15') }}" target="_blank" method="POST">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_15', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('superadmin.15.form.submit') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
