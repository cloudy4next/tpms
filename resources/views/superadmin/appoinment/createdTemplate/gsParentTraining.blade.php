...
<body>
    <div class="treatment-plan">
        <div class="content">
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti"
                                                        value="1" {{ $data->parti == 1 ? 'checked' : '' }}>BCBA
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti"
                                                        value="2"
                                                        {{ $data->parti == 2 ? 'checked' : '' }}>Parent/Caregiver
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti"
                                                        value="3"
                                                        {{ $data->parti == 3 ? 'checked' : '' }}>Behavior Therapist
                                                    Language
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="parti"
                                                        value="4" {{ $data->parti == 4 ? 'checked' : '' }}>Learner
                                                    Language
                                                </label>
                                            </div>
                                        </li>
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.21') }}" target="_blank" method="POST">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_21', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('superadmin.21.form.submit') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
