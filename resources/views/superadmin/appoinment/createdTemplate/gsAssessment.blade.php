...
<body>
    <div class="treatment-plan">
        <div class="content">
                                    ...
                                    <ul class="list-inline">
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    ...
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="1" {{ $data->task == 1 ? 'checked' : '' }}>Direct
                                                    Assessment
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="2" {{ $data->task == 2 ? 'checked' : '' }}>Indirect
                                                    Assessment
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="3" {{ $data->task == 3 ? 'checked' : '' }}>Creating
                                                    Goals
                                                    Language
                                                </label>
                                            </div>
                                        ...
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="4" {{ $data->task == 4 ? 'checked' : '' }}>Creating
                                        ...
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="5" {{ $data->task == 5 ? 'checked' : '' }}>Creating
                                                    Report
                                                    Language
                                                </label>
                                            </div>
                ...
                <section class="section_2">
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td>
                                    <label class="text-primary">Assessment Tools Used (Specify Indirect or
                                        Direct)</label>
                                            ...
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" name="client"
                                                        value="1" {{ $data->client == 1 ? 'checked' : '' }}>Client
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.20') }}" target="_blank" method="POST">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_20', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('superadmin.20.form.submit') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
