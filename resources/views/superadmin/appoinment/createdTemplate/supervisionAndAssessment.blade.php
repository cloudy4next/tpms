...
$app = \App\Models\Appoinment::select('id', 'schedule_date', 'from_time', 'to_time', 'client_id')
    ...
    ->first();
if ($app) {
    $client = \App\Models\Client::select('client_full_name', 'client_dob')
        ...
        <div class="content">
            ...
            <form action="" method="POST" id="form_60">
                ...
                <div class="page-title mb_40">
                    <h1>SUPERVISION NON-BILLABLE BRCT
                    </h1>
                    <br>
                </div>
                                ...
                                <td>
                                    <div class="flex-div"><span>
                                            ...
                                            <input type="date" id="dob" name="dob"
                                                value=" value="{{ $client_dob == '' ? '' : \Carbon\Carbon::parse($client_dob)->format('Y-m-d') }}"">
                                        </span></div>
                                </td>
                            </tr>
                            <tr>
                ...
                <section>
                    <div class="box box2">
                        ...
                        <p>1) Refrains from speaking about client during session and in front of client <span
                                class="red">*</span></p>
                    ...
                    <div class="box box2">
                        ...
                        <p> 4) Sd presented only 1 time before either a response or prompt? (No repeated Sds)? <span
                                class="red">*</span></p>
                        <div class="check-box-area">
                            <ul>
                                <li> <span>
                        ...
                        <p> 8) Appropriate ratio of easy (mastered) vs. difficult (acquisition) tasks? 80/20 rule? <span
                                class="red">*</span></p>
                        <div class="check-box-area">
                            <ul>
                                <li> <span>
                        ...
                        <p> 10) RBT maintains appropriate pace of instruction (inter-trial intervals no more than 3
                            seconds) <span class="red">*</span></p>
                        <div class="check-box-area">
                            <ul>
                                <li> <span>
                                        <input id="rbt_maintains_yes" type="radio" name="rbt_maintains"
                                            value="1" >
                                    </span> <span>
                                        <label for="rbt_maintains_yes">Yes</label>
                                    </span></li>
                                <li><span>
                                        <input id="rbt_maintains_no" type="radio" name="rbt_maintains"
                                            value="2" >
                                    </span> <span>
                        ...
                        <p> 12) Updates maintenance targets and practices them within trials <span
                                class="red">*</span></p>
                        <div class="check-box-area">
                            <ul>
                                <li> <span>
                        ...
                        <div class="box box3">
                            ...
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="immediately_yes" type="radio" name="immediately"
                                                value="1" >
                                        </span> <span>
                                            <label for="immediately_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="immediately_no" type="radio" name="immediately"
                                                value="2" >
                                        </span> <span>
                            ...
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="rbt_maintain_yes" type="radio" name="rbt_maintain"
                                                value="1" >
                                        </span> <span>
                                            <label for="rbt_maintain_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="rbt_maintain_no" type="radio" name="rbt_maintain"
                                                value="2" >
                                        </span> <span>
                            ...
                            <p> 3) Was the reinforcement schedule appropriate for the learner? <span
                                    class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="reinforcement_yes" type="radio" name="reinforcement"
                                                value="1" >
                                        </span> <span>
                                            <label for="reinforcement_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="reinforcement_no" type="radio" name="reinforcement"
                                                value="2" >
                                        </span> <span>
                            ...
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="rbt_utilize_yes" type="radio" name="rbt_utilize"
                                                value="1" >
                                        </span> <span>
                                            <label for="rbt_utilize_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="rbt_utilize_no" type="radio" name="rbt_utilize"
                                                value="2" >
                                        </span> <span>
                                            <label for="rbt_utilize_no">No</label>
                                        </span></li>
                                    <li><span>
                                            <input id="rbt_utilize_na" type="radio" name="rbt_utilize"
                                                value="3" >
                                        </span> <span>
                            ...
                            <p> 6) RBT paired behavior-specific praise with tangible reinforcers? <span
                                    class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="behavior-specific_yes" type="radio" name="behavior-specific"
                                                value="1" >
                                        </span> <span>
                                            <label for="behavior-specific_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="behavior-specific_no" type="radio" name="behavior-specific"
                                                value="2" >
                                        </span> <span>
                            ...
                            <p> 7) Reinforcers were delivered contingent upon correct responses, attending, and lack of
                                inappropriate behavior? <span class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="inappropriate_yes" type="radio" name="inappropriate"
                                                value="1" >
                                        </span> <span>
                                            <label for="inappropriate_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="inappropriate_no" type="radio" name="inappropriate"
                                                value="2" >
                                        </span> <span>
                        ...
                        <div class="box box4">
                            <div class="col-title mb_15">
                                <h3>
                                    <label><b>Consequences: Prompting and Error Correction and Errorless
                                            Teaching</b></label>
                                </h3>
                            </div>
                            ...
                            <p> 2) Was there only a 3 second delay between the Sd and the response or prompt <span
                                    class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                            ...
                            <p> 3) Are transfer trials presented after each prompted response?<span
                                    class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="trial_presented_no" type="radio" name="trial_presented"
                                                value="1" >
                                        </span> <span>
                                            <label for="trial_presented_no">No</label>
                                        </span></li>
                                    <li><span>
                                            <input id="trial_presented_other" type="radio" name="trial_presented"
                                                value="2" >
                                        </span> <span>
                            ...
                            <p> 4) RBT uses prompts that reliably evoke the appropriate response? <span
                                    class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                            ...
                            <p> 5) Are prompts varied depending on the skill being taught? <span
                                    class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="prompt_verified_yes" type="radio" name="prompt_verified"
                                                value="1" >
                                        </span> <span>
                                            <label for="prompt_verified_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="prompt_verified_no" type="radio" name="prompt_verified"
                                                value="2" >
                                        </span> <span>
                            ...
                            <p> 6) Were prompts progressively and systematically faded? <span class="red">*</span>
                            </p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="progressively_yes" type="radio" name="progressively"
                                                value="1" >
                                        </span> <span>
                                            <label for="progressively_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="progressively_no" type="radio" name="progressively"
                                                value="2" >
                                        </span> <span>
                            ...
                            <p> 7) Are correction procedures implemented correctly? (Re-states Sd with 0 second time
                                delay after error/no response?) <span class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="implemented_yes" type="radio" name="implemented"
                                                value="1" >
                                        </span> <span>
                                            <label for="implemented_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="implemented_no" type="radio" name="implemented"
                                                value="2" >
                                        </span> <span>
                            ...
                            <p> 8) Was every instruction followed by a consequence (reinforcement, prompt, or correction
                                procedure)? <span class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="consequence_yes" type="radio" name="consequence"
                                                value="1" >
                                        </span> <span>
                                            <label for="consequence_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="consequence_no" type="radio" name="consequence"
                                                value="2" >
                                        </span> <span>
                        ...
                        <div class="box box5">
                            ...
                            <p> 1) Problem behavior protocols utilized correctly as outlined in Catalyst/BIP <span
                                    class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="behavior-protocols_yes" type="radio"
                                                name="behavior-protocols" value="1" >
                                        </span> <span>
                                            <label for="behavior-protocols_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="behavior-protocols_no" type="radio"
                                                name="behavior-protocols" value="2" >
                                        </span> <span>
                                            <label for="behavior-protocols_no">No</label>
                                        </span></li>
                                </ul>
                            </div>
                            <p> 2) Implements antecedent strategies appropriately when unwanted behaviors are not
                                occurring? <span class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                            ...
                            <p> 3) Utilizes appropriate behavior intervention when behavior occurs? <span
                                    class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="intervention_yes" type="radio" name="intervention"
                                                value="1" >
                                        </span> <span>
                                            <label for="intervention_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="intervention_no" type="radio" name="intervention"
                                                value="2" >
                                        </span> <span>
                            ...
                            <p> 4) Provides positive reinforcement for an appropriate behavior following behavior
                                intervention? <span class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="positive-reinforcement_yes" type="radio"
                                                name="reinforcement" value="1" >
                                        </span> <span>
                                            <label for="positive-reinforcement_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="positive-reinforcement_no" type="radio" name="reinforcement"
                                                value="2" >
                                        </span> <span>
                        ...
                        <div class="box box6">
                            ...
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="begins-session_yes" type="radio" name="begins-session"
                                                value="1" >
                                        </span> <span>
                                            <label for="begins-session_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="begins-session_no" type="radio" name="begins-session"
                                                value="2" >
                                        </span> <span>
                            ...
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="ends-session_yes" type="radio" name="ends-session"
                                                value="1" >
                                        </span> <span>
                                            <label for="ends-session_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="ends-session_no" type="radio" name="ends-session"
                                                value="2" >
                                        </span> <span>
                            ...
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="objective-notes_yes" type="radio" name="objective-notes"
                                                value="1" >
                                        </span> <span>
                                            <label for="objective-notes_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="objective-notes_no" type="radio" name="objective-notes"
                                                value="2" >
                                        </span> <span>
                            ...
                            <p> 4) All supervisory recommendations are being followed/implemented? <span
                                    class="red">*</span></p>
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="supervisory_yes" type="radio" name="supervisory"
                                                value="1" >
                                        </span> <span>
                                            <label for="supervisory_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="supervisory_no" type="radio" name="supervisory"
                                                value="2" >
                                        </span> <span>
                        ...
                        <div class="box box7">
                            ...
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="targets-mastered" type="radio" name="plan-validity"
                                                value="1" >
                                        </span> <span>
                                            <label for="targets-mastered">Targets mastered out during session by
                                                BCBA</label>
                                        </span></li>
                                    <li><span>
                                            <input id="targets-added" type="radio" name="plan-validity"
                                                value="2" >
                                        </span> <span>
                                            <label for="targets-added">Targets added during session by BCBA</label>
                                        </span></li>
                                    <li><span>
                                            <input id="plan-appropriate" type="radio" name="plan-validity"
                                                value="3" >
                                        </span> <span>
                            ...
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="modeling-rbt" type="radio" name="clinic-director"
                                                value="1" >
                                        </span> <span>
                                            <label for="modeling-rbt">Modeling done for RBT for accurate implementation
                                                of plan</label>
                                        </span></li>
                                    <li><span>
                                            <input id="rbt-implementing" type="radio" name="clinic-director"
                                                value="2" >
                                        </span> <span>
                                            <label for="rbt-implementing">RBT implementing plan without
                                                direction</label>
                                        </span></li>
                                </ul>
                            </div>
                            ...
                            <div class="check-box-area">
                                <ul>
                                    <li> <span>
                                            <input id="data-collect_yes" type="radio" name="data-collection"
                                                value="1" >
                                        </span> <span>
                                            <label for="data-collect_yes">Yes</label>
                                        </span></li>
                                    <li><span>
                                            <input id="data-collect_no" type="radio" name="data-collection"
                                                value="2" >
                                        </span> <span>
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.60') }}" target="_blank" method="POST">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_60', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('superadmin.60.form.submit') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
