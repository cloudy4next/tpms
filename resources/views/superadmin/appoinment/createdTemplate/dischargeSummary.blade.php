                            ...
                            <div class="row1"> <span class="sr-number">1)</span>
                                <div class="date">
                                    <div class="start-date"><span><label>Session Date:</label> <input type="date"
                                                name="sdate" value="{{ $data->sdate }}"></span></div>
                                    <div class="discharge-date"><label>Discharge Date:</label> <input type="date"
                                            name="disdate" value="{{ $data->disdate }}"></div>
                        ...
                        <div class="colitem-2 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="Enter the living situation at discharge..." name="livsit">{{ $data->livsit }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="fill-area"><input type="text" placeholder="Enter Needs..."
                                                name="needs" value="{{ $data->needs }}"></div>
                                    </div>
                                    <div class="inner">
                                        <div class="lable-text">
                                        ...
                                        <div class="fill-area"><input type="text" placeholder="Enter Abilities..."
                                                name="abilities" value="{{ $data->abilities }}">
                                        </div>
                                    </div>
                                    <div class="inner">
                                        <div class="lable-text">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="Enter Services and support did Resilient Focused Family Therapy Provide, while in care..."
                                            name="incare">{{ $data->incare }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="colitem-5 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="Enter Significant findings..." name="sigfind">{{ $data->sigfind }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="colitem-6 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="Enter Summary of goals achieved..." name="summgoal">{{ $data->summgoal }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="colitem-7 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="Enter Summary of goals not achieved..." name="summnot">{{ $data->summnot }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="colitem-8 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="Enter Current support system..." name="currss">{{ $data->currss }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="colitem-9 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="Enter Overall Recommendations..." name="overrec">{{ $data->overrec }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="Enter outside organization did you refer client too? If not referred out, please explain..."
                                            name="outsideorg">{{ $data->outsideorg }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea
                                            ...
                                            name="planser">{{ $data->planser }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="colitem-12 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="Enter Any medical needs post discharge?..." name="medneed">{{ $data->medneed }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="colitem-13 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="Enter the reason for discontinuing services..." name="discont">{{ $data->discont }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="colitem-14 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="Enter Summary of Discharge..." name="summdis">{{ $data->summdis }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
