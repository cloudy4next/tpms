                            ...
                            <tr>
                                <td rowspan="2">
                                    <div class="flex-div first"><span><label>Goal 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Goal 1..." name="gl1">{!! $form_eight->gl1 !!}</textarea>
                                        </span></div>
                                </td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Objective 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Objective..." name="gl1obj">{!! $form_eight->gl1obj !!}</textarea>
                                        </span></div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Intervention 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Intervention" name="gl1inter">{!! $form_eight->gl1inter !!}</textarea>
                                        </span>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td rowspan="2">
                                    <div class="flex-div first"><span><label>Goal 2:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Goal 2..." name="gl2">{!! $form_eight->gl2 !!}</textarea>
                                        </span></div>
                                </td>
                                <td><label>Open Date:</label><input type="date" name="gl2opdt"
                                        value="{{ $form_eight->gl2opdt }}">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Objective 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Objective..." name="gl2obj">{!! $form_eight->gl2obj !!}</textarea>
                                        </span></div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Intervention 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Intervention" name="gl2inter">{!! $form_eight->gl2inter !!}</textarea>
                                        </span>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td rowspan="2">
                                    <div class="flex-div first"><span><label>Goal 3:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Goal 3..." name="gl3">{!! $form_eight->gl3 !!}</textarea>
                                        </span></div>
                                </td>
                                <td><label>Open Date:</label><input type="date" name="gl3opdt"
                                        value="{{ $form_eight->gl3opdt }}">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Objective 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Objective..." name="gl3obj">{!! $form_eight->gl3obj !!}</textarea>
                                        </span></div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Intervention 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Intervention" name="gl3inter">{!! $form_eight->gl3inter !!}</textarea>
                                        </span>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td rowspan="2">
                                    <div class="flex-div first"><span><label>Goal 4:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Goal 4..." name="gl4">{!! $form_eight->gl4 !!}</textarea>
                                        </span></div>
                                </td>
                                <td><label>Open Date:</label><input type="date" name="gl4opdt"
                                        value="{{ $form_eight->gl4opdt }}">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Objective 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Objective..." name="gl4obj">{!! $form_eight->gl4obj !!}</textarea>
                                        </span></div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex-div"><span><label>Intervention 1:</label></span> <span>
                                            <textarea rows="1" placeholder="Enter Intervention" name="gl4inter">{!! $form_eight->gl4inter !!}</textarea>
                                        </span>
                                    </div>
                                </td>
                            </tr>
