                            ...
                            <tr>
                                <td>
                                    <div class="flex-div"><span>
                                            ...
                                            <input type="text" id="clname" name="tr_name" class="tr_name"
                                                value="{{ $form_one->tr_name }}">
                                            <input type="hidden" id="clname" name="sessionid" class="sessionid"
                                                value="{{ $session_id }}">
                                        </span>
                                    </div>
                                </td>
                                <td>
                                    <div class="flex-div"><span>
                                            ...
                                            <input type="time" id="start-time" name="starttm" class="tr_name"
                                                value="{{ \Carbon\Carbon::parse($form_one->starttm)->format('H:i:s') }}">
                                        </span></div>
                                </td>
                                <td>
                                    <div class="flex-div"><span>
                                            ...
                                            <input type="date" id="date" name="stdate" class="stdate"
                                                value="{{ $form_one->stdate }}">
                                        </span></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="flex-div"><span>
                                            ...
                                            <input type="text" id="supervisor" name="supervisor"
                                                value="{{ $form_one->supervisor }}" class="supervisor">
                                        </span></div>
                                </td>
                                <td>
                                    <div class="flex-div"><span>
                                            ...
                                            <input type="time" id="end-time" name="endtime" class="endtime"
                                                value="{{ \Carbon\Carbon::parse($form_one->endtime)->format('H:i:s') }}">
                                        </span></div>
                                </td>
                                <td></td>
                            </tr>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input id="experience" type="text" name="exptyp"
                                                    value="{{ $form_one->exptyp }}" class="exptyp"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex-div select-area"><span>
                                                        <input id="restricted" type="radio" name="actcat"
                                                            class="actcat"
                                                            {{ $form_one->actcat == 1 ? 'checked' : '' }}
                                                            value="1">
                                                        <label for="restricted">Restricted</label>
                                                    </span> <span>
                                                        <input id="unrestricted" type="radio" name="actcat"
                                                            {{ $form_one->actcat == 2 ? 'checked' : '' }}
                                                            class="actcat" value="2">
                                                        <label for="unrestricted">Unrestricted</label>
                                                    </span></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="textarea-part" colspan="2"><label
                                                    for="activity-note">Activity Note <span class="bracket">(client
                                                        Initials):</span></label>
                                                <br>
                                                <div class="textarea">
                                                    <textarea id="activity-note" name="actnote" class="actnote" rows="5">{!! $form_one->actnote !!}</textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input id="total-hours" type="time" name="tlhrs"
                                                    value="{{ \Carbon\Carbon::parse($form_one->tlhrs)->format('H:i:s') }}"
                                                    class="tlhrs"></td>
                                        </tr>
                                        <tr>
                                            <td><label for="total-contacts">Total Number of Contacts:</label></td>
                                            <td><input id="total-contacts" type="text" maxlength="4"
                                                    name="tlcon" value="{{ $form_one->tlcon }}" class="tlcon">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="group2" type="text" name="group2"
                                                    value="{{ $form_one->group2 }}" class="group2"></td>
                                        </tr>
                                        <tr>
                                            <td><label for="trainee-with-clnt">Total number of Observations of the
                                                    Trainee with
                                                    Clients:</label>
                                            </td>
                                            <td><input id="trainee-with-clnt" type="text" name="traineewithclnt"
                                                    value="{{ $form_one->traineewithclnt }}" class="traineewithclnt">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <table>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="flex-div select-area"> <span>
                                                    <input id="person" type="radio" name="formate"
                                                        {{ $form_one->formate == 1 ? 'checked' : '' }} class="formate"
                                                        value="1">
                                                    <label for="person">person</label>
                                                </span> <span>
                                                    <input id="online" type="radio" name="formate"
                                                        {{ $form_one->formate == 2 ? 'checked' : '' }} class="formate"
                                                        value="2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex-div select-area"><span>
                                                    <input id="supervision-type" type="radio"
                                                        name="supervisiontype"
                                                        {{ $form_one->supervisiontype == 1 ? 'checked' : '' }}
                                                        class="supervisiontype" value="1">
                                                    <label for="supervision-type">Individual</label>
                                                </span> <span>
                                                    <input id="supervision-group" type="radio"
                                                        name="supervisiontype"
                                                        {{ $form_one->supervisiontype == 2 ? 'checked' : '' }}
                                                        class="supervisiontype" value="2">
                                    ...
                                    <tr>
                                        ...
                                        <td><input id="bst-task" type="text" name="bsttask"
                                                value="{{ $form_one->bsttask }}" class="bsttask"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <div class="textarea-part">
                                                <label for="summery-supervision">Summary of Supervision
                                                    Activities:</label>
                                                <br>
                                                <div class="textarea">
                                                    <textarea id="summery-supervision" name="sumsup" class="sumsup" rows="3">{!! $form_one->sumsup !!}</textarea>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="textarea-part">
                                                ...
                                                <br>
                                                <div class="textarea">
                                                    <textarea id="supervision-feedback" name="supfeed" class="supfeed" rows="3">{!! $form_one->supfeed !!}</textarea>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input id="action-item" type="text" name="actitem"
                                                value="{{ $form_one->actitem }}" class="actitem"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <section class="section_3">
                    <div class="box box-last_2">
                        <div class="flex-div mb_40">
                            <div class="col-item">
                                <div class="holder-div">
                                    <a href="#" data-target="#signatureModal" data-toggle="modal">Add
                                        Signature<i class="fa fa-signature"></i></a>
                                    <br>
                                    <span>
                                        <label for="bacb-sign">Supervisee/BACB ID#</label>
                                        <input maxlength="4" type="text" name="bcbaid"
                                            value="{{ $form_one->bcbaid }}" class="bcbaid">
                                    </span>
                                </div>
                            </div>
                            <div class="col-item">
                                <div class="holder-div">
                                    <input id="bacb-sign-date" type="date" name="signdate"
                                        value="{{ $form_one->signdate }}" class="signdate">
                                    <br>
                        ...
                        <div class="flex-div">
                            <div class="col-item">
                                <div class="holder-div">
                                    <a href="#" data-target="#signatureModal2" data-toggle="modal">Add
                                        Signature<i class="fa fa-signature"></i></a>
                                    <br>
                                    <span>
                                        <label for="suupervisor-sign">Supervisor/BACB ID#</label>
                                        <input maxlength="4" type="text" name="bacbid2"
                                            value="{{ $form_one->bacbid2 }}" class="bacbid2">
                                    </span>
                                </div>
                            </div>
                            <div class="col-item">
