...
<body>
    <div class="treatment-plan birp-progress">
        <div class="content">
            ...
            <form action="" method="POST" id="form_25">
                ...
                <div class="content">
                            ...
                            <div class="left">
                                    ...
                                    <div class="checkbox-area flex-div">
                                        <ul>
                                            <li class="group group_1">
                                                <input type="checkbox" {{ $data->consumer == 1 ? 'checked' : '' }}
                                                    value="1" id="Consumer" name="consumer"><label
                                                    for="Consumer">Consumer</label>
                                                <input type="hidden" name="sessionid" value="{{ $session_id }}">

                                            </li>
                                            <li class="group group_2">
                                                <input type="checkbox" {{ $data->pother == 1 ? 'checked' : '' }}
                                                    value="1" id="Other" name="pother"><label
                                                    for="Other">Other</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="checkbox" {{ $data->pparent == 1 ? 'checked' : '' }}
                                                    value="1" id="fosterp" name="pparent"><label
                                                    for="fosterp">Foster
                                                    Parents</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_4">
                                                <input type="checkbox" {{ $data->parent == 1 ? 'checked' : '' }}
                                                    value="1" id="parent" name="parent"><label
                                                    for="parent">Parent/Guardian</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="checkbox" {{ $data->pgaurdian == 1 ? 'checked' : '' }}
                                                    value="1" id="staff" name="pgaurdian"><label
                                                    for="staff">Group Home
                                                    Staff</label>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-item1 col-item mb_30">
                                    ...
                                    <div class="checkbox-area flex-div">
                                        <ul>
                                            <li class="group group_1">
                                                <input type="radio" {{ $data->affect == 1 ? 'checked' : '' }}
                                                    value="1" id="agitated" name="affect"><label
                                                    for="agitated">Agitated</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" {{ $data->affect == 2 ? 'checked' : '' }}
                                                    value="2" id="calm" name="affect"><label
                                                    for="calm">Calm</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="radio" {{ $data->affect == 3 ? 'checked' : '' }}
                                                    value="3" id="flat" name="affect"><label
                                                    for="flat">Flat</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_4">
                                                <input type="radio" {{ $data->affect == 4 ? 'checked' : '' }}
                                                    value="4" id="n-a" name="affect"><label
                                                    for="n-a">N/A</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="radio" {{ $data->affect == 5 ? 'checked' : '' }}
                                                    value="5" id="sad" name="affect"><label
                                                    for="sad">Sad</label>
                                            </li>
                                            <li class="group group_1">
                                                <input type="radio" {{ $data->affect == 6 ? 'checked' : '' }}
                                                    value="6" id="angry" name="affect"><label
                                                    for="angry">Angry</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_2">
                                                <input type="radio" {{ $data->affect == 7 ? 'checked' : '' }}
                                                    value="7" id="defiant" name="affect"><label
                                                    for="defiant">Defiant</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="radio" {{ $data->affect == 8 ? 'checked' : '' }}
                                                    value="8" id="happy" name="affect"><label
                                                    for="happy">Happy</label>
                                            </li>
                                            <li class="group group_4">
                                                <input type="radio" {{ $data->affect == 9 ? 'checked' : '' }}
                                                    value="9" id="other" name="affect"><label
                                                    for="other">Other</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_5">
                                                <input type="radio" {{ $data->affect == 10 ? 'checked' : '' }}
                                                    value="10" id="suicidal" name="affect"><label
                                                    for="suicidal">Suicidal</label>
                                            </li>
                                            <li class="group group_1">
                                                <input type="radio" {{ $data->affect == 11 ? 'checked' : '' }}
                                                    value="11" id="anxious" name="affect"><label
                                                    for="anxious">Anxious</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" {{ $data->affect == 12 ? 'checked' : '' }}
                                                    value="12" id="energetic" name="affect"><label
                                                    for="energetic">Energetic</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_3">
                                                <input type="radio" {{ $data->affect == 13 ? 'checked' : '' }}
                                                    value="13" id="moody" name="affect"><label
                                                    for="moody">Moody</label>
                                            </li>
                                            <li class="group group_4">
                                                <input type="radio" {{ $data->affect == 14 ? 'checked' : '' }}
                                                    value="14" id="playful" name="affect"><label
                                                    for="playful">Playful</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="radio" {{ $data->affect == 15 ? 'checked' : '' }}
                                                    value="15" id="tired" name="affect"><label
                                ...
                                <div class="col-item1 col-item mb_30">
                                    ...
                                    <div class="inner">
                                        <select name="proselect">
                                            <option value="-" {{ $data->proselect == '-' ? 'selected' : '' }}>-
                                            </option>
                                            <option value="Yes" {{ $data->proselect == 'Yes' ? 'selected' : '' }}>
                                                Yes</option>
                                            <option value="No" {{ $data->proselect == 'No' ? 'selected' : '' }}>No
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-item1 col-item mb_30">
                                    ...
                                    <div class="inner">
                                        <select name="newselect">
                                            <option value="Whitis"
                                                {{ $data->newselect == 'Whitis' ? 'selected' : '' }}>Whitis</option>
                                            <option value="Serenity"
                                                {{ $data->newselect == 'Serenity' ? 'selected' : '' }}>Serenity
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="right">
                                <div class="col-item1 col-item mb_30">
                                    ...
                                    <div class="checkbox-area flex-div">
                                        <ul>
                                            <li class="group group_1">
                                                <input type="radio" {{ $data->contacttype == 1 ? 'checked' : '' }}
                                                    value="1" id="f2f" name="contacttype"><label
                                                    for="f2f">Face
                                                    to
                                                    Face</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" {{ $data->contacttype == 2 ? 'checked' : '' }}
                                                    value="2" id="phone" name="contacttype"><label
                                                    for="phone">Phone</label>
                                            </li>
                                            <li class="group group_3">
                                                <input type="radio" {{ $data->contacttype == 3 ? 'checked' : '' }}
                                                    value="3" id="attempts" name="contacttype"><label
                                                    for="attempts">Attempts</label>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="group group_4">
                                                <input type="radio" {{ $data->contacttype == 4 ? 'checked' : '' }}
                                                    value="4" id="telehealth" name="contacttype"> <label
                                                    for="telehealth">Telehealth</label>
                                            </li>
                                            <li class="group group_5">
                                                <input type="radio" {{ $data->contacttype == 5 ? 'checked' : '' }}
                                                    value="5" id="na" name="contacttype"><label
                                                    for="na">N/A</label>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-item1 col-item mb_30">
                                    ...
                                    <div class="checkbox-area">
                                        <ul>
                                            <li class="group group_1"><input type="radio"
                                                    {{ $data->stressor == 1 ? 'checked' : '' }} value="1"
                                                    id="yes" name="stressor"><label for="yes">yes</label>
                                            </li>
                                            <li class="group group_2">
                                                <input type="radio" {{ $data->stressor == 2 ? 'checked' : '' }}
                                                    value="2" id="none-reported" name="stressor"><label
                                                    for="none-reported">None Reported</label>
                                            </li>
                                        </ul>
                                        <div class="inner"><label>if yes, please explain:</label><br>
                                            <textarea rows="1" name="stressexp">{{ $data->stressexp }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-item1 col-item mb_30">
                                    <h3>Comments:</h3>
                                    <div class="inner">
                                        <textarea rows="1" name="stresscomm">{{ $data->stresscomm }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="section_2">
                        <input type="checkbox" {{ $data->imi == 1 ? 'checked' : '' }} value="1" name="imi">
                        <label><strong>Include Mileage Information?</strong></label>
                        <br>
                        <br>
                            ...
                            <div class="col-item">
                                ...
                                <div class="inner">
                                    <select name="goalselect">
                                        <option value="Goal 1" {{ $data->goalselect == 'Goal 1' ? 'selected' : '' }}>
                                            Goal 1</option>
                                        <option value="Goal 2" {{ $data->goalselect == 'Goal 2' ? 'selected' : '' }}>
                                            Goal 2</option>
                                        <option value="Goal 3" {{ $data->goalselect == 'Goal 3' ? 'selected' : '' }}>
                                            Goal 3</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-item">
                                ...
                                <div class="inner">
                                    <select name="objselect">
                                        <option value="Objective 1"
                                            {{ $data->objselect == 'Objective 1' ? 'selected' : '' }}>Objective1
                                        </option>
                                        <option value="Objective 2"
                                            {{ $data->objselect == 'Objective 2' ? 'selected' : '' }}>Objective2
                                        </option>
                                        <option value="Objective 3"
                                            {{ $data->objselect == 'Objective 3' ? 'selected' : '' }}>Objective3
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-item">
                                ...
                                <div class="inner">
                                    <select name="intselect">
                                        <option value="Intervention 1"
                                            {{ $data->intselect == 'Intervention 1' ? 'selected' : '' }}>Intervention 1
                                        </option>
                                        <option value="Intervention 2"
                                            {{ $data->intselect == 'Intervention 2' ? 'selected' : '' }}>Intervention 2
                                        </option>
                                        <option value="Intervention 3"
                                            {{ $data->intselect == 'Intervention 3' ? 'selected' : '' }}>Intervention 3
                                        </option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <section class="section_3 section-common mb_30">
                        <div class="flex-div">
                            <div class="col-item">
                                ...
                                <div class="inner">
                                    <textarea rows="5" name="nonbill">{{ $data->nonbill }}</textarea>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="section_10">
                        <div class="flex-div full-width">
                            <div class="col-item1  col-item mb_30">
                                ...
                                <div class="tabs">
                                    <textarea rows="1" name="additional">{{ $data->additional }}</textarea>
                                </div>
                            </div>
                        </div>
                    </section>
                    <section class="section_bottom">
                        <div class="flex-div">
                            <div class="col-item">
                                ...
                                <div class="inner">
                                    <select name="statusselect">
                                        <option value="Active"
                                            {{ $data->statusselect == 'Active' ? 'selected' : '' }}> Active </option>
                                        <option value="Active"
                                            {{ $data->statusselect == 'Active' ? 'selected' : '' }}>Active</option>
                                        <option value="Active"
                                            {{ $data->statusselect == 'Active' ? 'selected' : '' }}>Active</option>
                            ...
                            <div class="col-item">
                                ...
                                <div class="date"><input type="date" value="{{ $data->nextapp }}"
                                        name="nextapp"></div>
                            </div>
                        </div>
                    </section>
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.25') }}" target="_blank"
                method="POST">
                @csrf
