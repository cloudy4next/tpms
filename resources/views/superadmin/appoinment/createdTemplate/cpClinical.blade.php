...
<body>
    <div class="treatment-plan">
        <div class="content">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" placeholder="Enter here..."
                                    class="form-control border border-primary" name="lengthsup"
                                    value="{{ $data->lengthsup }}">
                            </td>
                            <td>
                                <label class="text-primary mb-2">Rendering behavioral technician</label>
                                <input type="text" placeholder="Enter here..."
                                    class="form-control border border-primary" name="rendbehtech"
                                    value="{{ $data->rendbehtech }}">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <input type="text" placeholder="Enter here..."
                                    class="form-control border border-primary" name="superprovide"
                                    value="{{ $data->superprovide }}">
                            </td>
                            <td>
                                <label class="text-primary mb-2">Feedback/Constructive Criticism Provided</label>
                                <input type="text" placeholder="Enter here..."
                                    class="form-control border border-primary" name="feedbackcrit"
                                    value="{{ $data->feedbackcrit }}">
                            </td>
                        </tr>
                    </table>
                </section>
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.17') }}" target="_blank" method="POST">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_17', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('superadmin.17.form.submit') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
