                ...
                <div class="content">
                    ...
                    <section class="section_3">
                        ...
                        <div class="box box2">
                            <h3>Has the client ever been suspended or expelled from school and/or bus?: <br>
                                <span class="bracket">(Include both in-school suspensions and out-of-school
                                    suspensions)
                                    If so,
                        ...
                        <div class="box box3">
                                    ...
                                    <ul>
                                        <li>
                                            <input id="yes" type="radio"
                                                {{ $data->absences == 1 ? 'checked' : '' }} name="absences"
                                                value="1"> <label for="yes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="no" type="radio"
                                                {{ $data->absences == 2 ? 'checked' : '' }} name="absences"
                            ...
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="ryes" type="radio"
                                                {{ $data->retained == 1 ? 'checked' : '' }} name="retained"
                                                value="1"> <label for="ryes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="rno" type="radio"
                                                {{ $data->retained == 2 ? 'checked' : '' }} name="retained"
                                                value="2"> <label for="rno">No</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="eyes" type="radio"
                                                {{ $data->classes == 1 ? 'checked' : '' }} name="classes"
                                                value="1"> <label for="eyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="eno" type="radio"
                                                {{ $data->classes == 2 ? 'checked' : '' }} name="classes"
                                                value="2"> <label for="eno">No</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="box box8">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="iprob" type="checkbox"
                                                {{ $data->lhistinfo == 1 ? 'checked' : '' }} name="lhistinfo"
                                                value="1"> <label for="iprob">Informal
                                                Probation</label>
                                        </li>
                                        <li>
                                            <input id="cws" type="checkbox"
                                                {{ $data->lhistwel == 1 ? 'checked' : '' }} name="lhistwel"
                                                value="1"> <label for="cws">Child
                                                Welfare
                                                Services</label>
                                        </li>
                                        <li>
                                            <input id="rs-order" type="checkbox"
                                                {{ $data->lhistrestrain == 1 ? 'checked' : '' }} name="lhistrestrain"
                                                value="1"> <label for="rs-order">Restraining Order</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="fprob" type="checkbox"
                                                {{ $data->lhistformal == 1 ? 'checked' : '' }} name="lhistformal"
                                                value="1"> <label for="fprob">Formal
                                                Probation</label>
                                        </li>
                                        <li>
                                            <input id="conservatorship" type="checkbox"
                                                {{ $data->lhistconserv == 1 ? 'checked' : '' }} name="lhistconserv"
                                                value="1"> <label for="conservatorship">Conservatorship</label>
                                        </li>
                                        <li>
                                            <input id="non-report" type="checkbox"
                                                {{ $data->lhistnone == 1 ? 'checked' : '' }} name="lhistnone"
                                                value="1"> <label for="non-report">None reported</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="parole" type="checkbox"
                                                {{ $data->lhistparole == 1 ? 'checked' : '' }} name="lhistparole"
                                                value="1"> <label for="parole">Parole</label>
                                        </li>
                                        <li>
                                            <input id="dui" type="checkbox"
                                                {{ $data->lhistdui == 1 ? 'checked' : '' }} name="lhistdui"
                                                value="1"> <label for="dui">D. U.
                                                I.</label>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="box box10">
                            <div class="col-item ">
                                ...
                                <div class="select-area mtb_10">
                                    <ul>
                                        <li>
                                            <input id="substanceyes" type="radio"
                                                {{ $data->ssubstance == 1 ? 'checked' : '' }} name="ssubstance"
                                                value="1"> <label for="substanceyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="substanceno" type="radio"
                                                {{ $data->ssubstance == 2 ? 'checked' : '' }} name="ssubstance"
                                                value="2"> <label for="substanceno">No</label>
                                        </li>
                                    </ul>
                                </div>
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="caffeine" type="checkbox"
                                                {{ $data->caffeine == 1 ? 'checked' : '' }} name="caffeine"
                                                value="1"> <label for="caffeine">Caffeine</label>
                                        </li>
                                        <li>
                                            <input id="p-medicine" type="checkbox"
                                                {{ $data->prescr == 1 ? 'checked' : '' }} name="prescr"
                                                value="1"> <label for="p-medicine">Prescription
                                                Medication</label>
                                        </li>
                                        <li>
                                            <input id="hallucinogens" type="checkbox"
                                                {{ $data->halluc == 1 ? 'checked' : '' }} name="halluc"
                                                value="1"> <label for="hallucinogens">Hallucinogens</label>
                                        </li>
                                        ...
                                        <li>
                                            <input id="sedatives" type="checkbox"
                                                {{ $data->sdativ == 1 ? 'checked' : '' }} name="sdativ"
                                                value="1"> <label for="sedatives">Sedatives</label>
                                        </li>
                                        <li>
                                            <input id="barbituates" type="checkbox"
                                                {{ $data->barbit == 1 ? 'checked' : '' }} name="barbit"
                                                value="1"> <label for="barbituates">Barbituates</label>
                                        </li>
                                        <li>
                                            <input id="methadone" type="checkbox"
                                                {{ $data->methad == 1 ? 'checked' : '' }} name="methad"
                                                value="1"> <label for="methadone">Methadone</label>
                                        </li>
                                        <li>
                                            <input id="other" type="checkbox"
                                                {{ $data->subother == 1 ? 'checked' : '' }} name="subother"
                                                value="1"> <label for="other">Other</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="tobacco" type="checkbox"
                                                {{ $data->tobacco == 1 ? 'checked' : '' }} name="tobacco"
                                                value="1"> <label for="tobacco">Tobacco</label>
                                        </li>
                                        <li>
                                            <input id="alcohol" type="checkbox"
                                                {{ $data->alcohol == 1 ? 'checked' : '' }} name="alcohol"
                                                value="1"> <label for="alcohol">Alcohol</label>
                                        </li>
                                        <li>
                                            <input id="marijuana" type="checkbox"
                                                {{ $data->mariju == 1 ? 'checked' : '' }} name="mariju"
                                                value="1"> <label for="marijuana">Marijuana</label>
                                        </li>
                                        <li>
                                            <input id="tranqulizers" type="checkbox"
                                                {{ $data->tranqu == 1 ? 'checked' : '' }} name="tranqu"
                                                value="1"> <label for="tranqulizers">Tranqulizers</label>
                                        </li>
                                        <li>
                                            <input id="methamphetamines" type="checkbox"
                                                {{ $data->metham == 1 ? 'checked' : '' }} name="metham"
                                                value="1"> <label for="methamphetamines">Methamphetamines</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="Over-the-counter" type="checkbox"
                                                {{ $data->overcount == 1 ? 'checked' : '' }} name="overcount"
                                                value="1"> <label for="Over-the-counter">Over-the-counter
                                                Medication</label>
                                        </li>
                                        <li>
                                            <input id="inhalants" type="checkbox"
                                                {{ $data->inhalant == 1 ? 'checked' : '' }} name="inhalant"
                                                value="1"> <label for="inhalants">Inhalants</label>
                                        </li>
                                        <li>
                                            <input id="stimulants" type="checkbox"
                                                {{ $data->stimul == 1 ? 'checked' : '' }} name="stimul"
                                                value="1"> <label for="stimulants">Stimulants</label>
                                        </li>
                                        <li>
                                            <input id="cocaine" type="checkbox"
                                                {{ $data->cocain == 1 ? 'checked' : '' }} name="cocain"
                                                value="1"> <label for="cocaine">Cocaine</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="box box1 flex-div mb_0">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="unremarkable" type="checkbox"
                                                {{ $data->unremark == 1 ? 'checked' : '' }} name="unremark"
                                                value="1"> <label for="unremarkable">Unremarkable</label>
                                        </li>
                                        <li>
                                            <input id="unkempt" type="checkbox"
                                                {{ $data->unkempt == 1 ? 'checked' : '' }} name="unkempt"
                                                value="1"> <label for="unkempt">Unkempt</label>
                                        </li>
                                        <li>
                                            <input id="atclothing" type="checkbox"
                                                {{ $data->atypical == 1 ? 'checked' : '' }} name="atypical"
                                                value="1"> <label for="atclothing">Atypical Clothing</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <ul>
                                        <li>
                                            <input id="person" type="checkbox"
                                                {{ $data->person == 1 ? 'checked' : '' }} name="person"
                                                value="1"> <label for="person">Person</label>
                                        </li>
                                        <li>
                                            <input id="place" type="checkbox"
                                                {{ $data->place == 1 ? 'checked' : '' }} name="place"
                                                value="1"> <label for="place">Place</label>
                                        </li>
                                        <li>
                                            <input id="odate" type="checkbox"
                                                {{ $data->oridate == 1 ? 'checked' : '' }} name="oridate"
                                                value="1"> <label for="odate">Date</label>
                                        </li>
                                        <li>
                                            <input id="situation" type="checkbox"
                                                {{ $data->situation == 1 ? 'checked' : '' }} name="situation"
                                                value="1"> <label for="situation">Situation</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="poor" type="checkbox"
                                                {{ $data->insightpoor == 1 ? 'checked' : '' }} name="insightpoor"
                                                value="1"> <label for="poor">Poor</label>
                                        </li>
                                        <li>
                                            <input id="average" type="checkbox"
                                                {{ $data->insightaverage == 1 ? 'checked' : '' }}
                                                name="insightaverage" value="1"> <label
                                                for="average">Average</label>
                                        </li>
                                        <li>
                                            <input id="good" type="checkbox"
                                                {{ $data->insightgood == 1 ? 'checked' : '' }} name="insightgood"
                                                value="1"> <label for="good">Good</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="jpoor" type="checkbox"
                                                {{ $data->judgpoor == 1 ? 'checked' : '' }} name="judgpoor"
                                                value="1"> <label for="jpoor">Poor</label>
                                        </li>
                                        <li>
                                            <input id="javerage" type="checkbox"
                                                {{ $data->judgaver == 1 ? 'checked' : '' }} name="judgaver"
                                                value="1"> <label for="javerage">Average</label>
                                        </li>
                                        <li>
                                            <input id="jgood" type="checkbox"
                                                {{ $data->judggood == 1 ? 'checked' : '' }} name="judggood"
                                                value="1"> <label for="jgood">Good</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="unremarkable" type="checkbox"
                                                {{ $data->motorun == 1 ? 'checked' : '' }} name="motorun"
                                                value="1"> <label for="unremarkable">Unremarkable</label>
                                        </li>
                                        <li>
                                            <input id="restless" type="checkbox"
                                                {{ $data->motorrest == 1 ? 'checked' : '' }} name="motorrest"
                                                value="1"> <label for="restless">Restless</label>
                                        </li>
                                        <li>
                                            <input id="withdrawn" type="checkbox"
                                                {{ $data->motorwith == 1 ? 'checked' : '' }} name="motorwith"
                                                value="1"> <label for="withdrawn">Withdrawn</label>
                                        </li>
                                        <li>
                                            <input id="s-speech" type="checkbox"
                                                {{ $data->motorslurr == 1 ? 'checked' : '' }} name="motorslurr"
                                                value="1"> <label for="s-speech">Slurred Speech</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <section class="section_7 mb_30">
                        ...
                        <div class="select-area">
                            <ul>
                                <li>
                                    <input id="limits" type="checkbox" {{ $data->limit == 1 ? 'checked' : '' }}
                                        name="limit" value="1"> <label for="limits">All within normal
                                        limits</label>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="box box1">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="affeft1" type="checkbox"
                                                {{ $data->affun == 1 ? 'checked' : '' }} name="affun"
                                                value="1"> <label for="affeft1">Unremarkable</label>
                                        </li>
                                        <?php
                                        ...
                                        ?>
                                        <li>
                                            <input id="affeft2" type="checkbox"
                                                {{ $data->affcrit == 1 ? 'checked' : '' }} name="affcrit"
                                                value="1"> <label for="affeft2">Self
                                                Critical</label>
                                        </li>
                                        <li>
                                            <input id="affeft3" type="checkbox"
                                                {{ $data->affflat == 1 ? 'checked' : '' }} name="affflat"
                                                value="1"> <label for="affeft3">Flat</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="affeft4" type="checkbox"
                                                {{ $data->affangr == 1 ? 'checked' : '' }} name="affangr"
                                                value="1"> <label for="affeft4">Angry</label>
                                        </li>
                                        <li>
                                            <input id="affeft5" type="checkbox"
                                                {{ $data->affeuph == 1 ? 'checked' : '' }} name="affeuph"
                                                value="1"> <label for="affeft5">Euphoric</label>
                                        </li>
                                        <li>
                                            <input id="affeft6" type="checkbox"
                                                {{ $data->affsilly == 1 ? 'checked' : '' }} name="affsilly"
                                                value="1"> <label for="affeft6">Silly</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="affeft7" type="checkbox"
                                                {{ $data->affirri == 1 ? 'checked' : '' }} name="affirri"
                                                value="1"> <label for="affeft7">Irritable</label>
                                        </li>
                                        <li>
                                            <input id="affeft8" type="checkbox"
                                                {{ $data->affdepr == 1 ? 'checked' : '' }} name="affdepr"
                                                value="1"> <label for="affeft8">Depressed</label>
                                        </li>
                                        <li>
                                            <input id="affeft9" type="checkbox"
                                                {{ $data->affhope == 1 ? 'checked' : '' }} name="affhope"
                                                value="1"> <label for="affeft9">Hopelessness</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="box box2">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="d-like1" type="checkbox"
                                                {{ $data->depnone == 1 ? 'checked' : '' }} name="depnone"
                                                value="1"> <label for="d-like1">None</label>
                                        </li>
                                        <li>
                                            <input id="d-like2" type="checkbox"
                                                {{ $data->dephypo == 1 ? 'checked' : '' }} name="dephypo"
                                                value="1"> <label for="d-like2">Hypoactive</label>
                                        </li>
                                        <li>
                                            <input id="d-like3" type="checkbox"
                                                {{ $data->depfati == 1 ? 'checked' : '' }} name="depfati"
                                                value="1"> <label for="d-like3">Fatigue</label>
                                        </li>
                                        <li>
                                            <input id="d-like4" type="checkbox"
                                                {{ $data->depfee == 1 ? 'checked' : '' }} name="depfee"
                                                value="1"> <label for="d-like4">Feelings
                                                of Worthlessness</label>
                                        </li>
                                        <li>
                                            <input id="d-like5" type="checkbox"
                                                {{ $data->depguilt == 1 ? 'checked' : '' }} name="depguilt"
                                                value="1"> <label for="d-like5">Guilt
                                                Feelings</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="d-like6" type="checkbox"
                                                {{ $data->dephelpless == 1 ? 'checked' : '' }} name="dephelpless"
                                                value="1"> <label for="d-like6">Feelings
                                                of Helpless/Hopeless</label>
                                        </li>
                                        <li>
                                            <input id="d-like7" type="checkbox"
                                                {{ $data->depirrit == 1 ? 'checked' : '' }} name="depirrit"
                                                value="1"> <label for="d-like7">Irritability</label>
                                        </li>
                                        <li>
                                            <input id="d-like8" type="checkbox"
                                                {{ $data->deppoor == 1 ? 'checked' : '' }} name="deppoor"
                                                value="1"> <label for="d-like8">Poor
                                                Concentration</label>
                                        </li>
                                        <li>
                                            <input id="d-like9" type="checkbox"
                                                {{ $data->depsadn == 1 ? 'checked' : '' }} name="depsadn"
                                                value="1"> <label for="d-like9">Sadness</label>
                                        </li>
                                        <li>
                                            <input id="d-like10" type="checkbox"
                                                {{ $data->depsexual == 1 ? 'checked' : '' }} name="depsexual"
                                                value="1"> <label for="d-like10">Change
                                                in Sexaul Interest</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="d-like11" type="checkbox"
                                                {{ $data->deploss == 1 ? 'checked' : '' }} name="deploss"
                                                value="1"> <label for="d-like11">Loss
                                                of Ability to Enjoy (Anhedonia)</label>
                                        </li>
                                        <li>
                                            <input id="d-like12" type="checkbox"
                                                {{ $data->depwithdraw == 1 ? 'checked' : '' }} name="depwithdraw"
                                                value="1"> <label for="d-like12">Withdrawn</label>
                                        </li>
                                        <li>
                                            <input id="d-like13" type="checkbox"
                                                {{ $data->depself == 1 ? 'checked' : '' }} name="depself"
                                                value="1"> <label
                                                for="d-like13">Self-Blame/Self-Criticism</label>
                                        </li>
                                        <li>
                                            <input id="d-like14" type="checkbox"
                                                {{ $data->depinter == 1 ? 'checked' : '' }} name="depinter"
                                                value="1"> <label for="d-like14">Loss
                                                of Interest</label>
                                        </li>
                                        <li>
                                            <input id="d-like15" type="checkbox"
                                                {{ $data->depcry == 1 ? 'checked' : '' }} name="depcry"
                                                value="1"> <label for="d-like15">Crying</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="box box4">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="think-1" type="checkbox"
                                                {{ $data->thinun == 1 ? 'checked' : '' }} name="thinun"
                                                value="1"> <label for="think-1">Unremarkable</label>
                                        </li>
                                        <li>
                                            <input id="think-2" type="checkbox"
                                                {{ $data->thindiss == 1 ? 'checked' : '' }} name="thindiss"
                                                value="1"> <label for="think-2">Distracted</label>
                                        </li>
                                        <li>
                                            <input id="think-3" type="checkbox"
                                                {{ $data->thindel == 1 ? 'checked' : '' }} name="thindel"
                                                value="1"> <label for="think-3">Delusions</label>
                                        </li>
                                        <li>
                                            <input id="think-4" type="checkbox"
                                                {{ $data->thinhyp == 1 ? 'checked' : '' }} name="thinhyp"
                                                value="1"> <label for="think-4">Hypochondriasis</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="think-5" type="checkbox"
                                                {{ $data->thindis == 1 ? 'checked' : '' }} name="thindis"
                                                value="1"> <label for="think-5">Disorganized</label>
                                        </li>
                                        <li>
                                            <input id="think-6" type="checkbox"
                                                {{ $data->thinsus == 1 ? 'checked' : '' }} name="thinsus"
                                                value="1"> <label for="think-6">Suspicious</label>
                                        </li>
                                        <li>
                                            <input id="think-7" type="checkbox"
                                                {{ $data->thinobs == 1 ? 'checked' : '' }} name="thinobs"
                                                value="1"> <label for="think-7">Obsessions</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="think-8" type="checkbox"
                                                {{ $data->thinfli == 1 ? 'checked' : '' }} name="thinfli"
                                                value="1"> <label for="think-8">Flight of
                                                Ideas</label>
                                        </li>
                                        <li>
                                            <input id="think-9" type="checkbox"
                                                {{ $data->thinconf == 1 ? 'checked' : '' }} name="thinconf"
                                                value="1"> <label for="think-9">Confused</label>
                                        </li>
                                        <li>
                                            <input id="think-10" type="checkbox"
                                                {{ $data->thingrand == 1 ? 'checked' : '' }} name="thingrand"
                                                value="1"> <label for="think-10">Delusions Obsessions
                                                Grandiosity</label>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="box box6">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="att-1" type="checkbox"
                                                {{ $data->attun == 1 ? 'checked' : '' }} name="attun"
                                                value="1"> <label for="att-1">Unremarkable</label>
                                        </li>
                                        <li>
                                            <input id="att-2" type="checkbox"
                                                {{ $data->attego == 1 ? 'checked' : '' }} name="attego"
                                                value="1"> <label for="att-2">Egocentric</label>
                                        </li>
                                        <li>
                                            <input id="att-3" type="checkbox"
                                                {{ $data->attsar == 1 ? 'checked' : '' }} name="attsar"
                                                value="1"> <label for="att-3">Sarcastic</label>
                                        </li>
                                        <li>
                                            <input id="att-4" type="checkbox"
                                                {{ $data->attres == 1 ? 'checked' : '' }} name="attres"
                                                value="1"> <label for="att-4">Resistant</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="att-5" type="checkbox"
                                                {{ $data->attcont == 1 ? 'checked' : '' }} name="attcont"
                                                value="1"> <label for="att-5">Controlling</label>
                                        </li>
                                        <?php
                                        ...
                                        ?>
                                        <li>
                                            <input id="att-6" type="checkbox"
                                                {{ $data->atthost == 1 ? 'checked' : '' }} name="atthost"
                                                value="1"> <label for="att-6">Hostile</label>
                                        </li>
                                        <li>
                                            <input id="att-7" type="checkbox"
                                                {{ $data->attneg == 1 ? 'checked' : '' }} name="attneg"
                                                value="1"> <label for="att-7">Negativistic</label>
                                        </li>
                                        <li>
                                            <input id="att-8" type="checkbox"
                                                {{ $data->attpass == 1 ? 'checked' : '' }} name="attpass"
                                                value="1"> <label for="att-8">Passive</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="att-9" type="checkbox"
                                                {{ $data->attaggr == 1 ? 'checked' : '' }} name="attaggr"
                                                value="1"> <label for="att-9">Passive-Aggressive</label>
                                        </li>
                                        <li>
                                            <input id="att-10" type="checkbox"
                                                {{ $data->attsedu == 1 ? 'checked' : '' }} name="attsedu"
                                                value="1"> <label for="att-10">Seductive</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="box box2">
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="imyes" type="radio"
                                                {{ $data->immunizations == 1 ? 'checked' : '' }} name="immunizations"
                                                value="1"> <label for="imyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="imno" type="radio"
                                                {{ $data->immunizations == 2 ? 'checked' : '' }} name="immunizations"
                        ...
                        <div class="box box4">
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="satisfiedna" type="radio"
                                                {{ $data->satisfied == 1 ? 'checked' : '' }} name="satisfied"
                                                value="1"> <label for="satisfiedna">N/A</label>
                                        </li>
                                        <li>
                                        <li>
                                            <input id="satisfiedyes" type="radio"
                                                {{ $data->satisfied == 2 ? 'checked' : '' }} name="satisfied"
                                                value="2"> <label for="satisfiedyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="satisfiedno" type="radio"
                                                {{ $data->satisfied == 3 ? 'checked' : '' }} name="satisfied"
                                                value="3"> <label for="satisfiedno">No</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="diagnosedna" type="radio"
                                                {{ $data->diagnosed == 1 ? 'checked' : '' }} name="diagnosed"
                                                value="1"> <label for="diagnosedna">N/A</label>
                                        </li>
                                        <li>
                                            <input id="diagnosedyes" type="radio"
                                                {{ $data->diagnosed == 2 ? 'checked' : '' }} name="diagnosed"
                                                value="2"> <label for="diagnosedyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="diagnosedno" type="radio"
                                                {{ $data->diagnosed == 3 ? 'checked' : '' }} name="diagnosed"
                                                value="3"> <label for="diagnosedno">No</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area">
                                    <ul>
                                        <li>
                                            <input id="referralna" type="radio"
                                                {{ $data->referral == 1 ? 'checked' : '' }} name="referral"
                                                value="1"> <label for="referralna">N/A</label>
                                        </li>
                                        <li>
                                            <input id="referralyes" type="radio"
                                                {{ $data->referral == 2 ? 'checked' : '' }} name="referral"
                                                value="2"> <label for="referralyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="referralno" type="radio"
                                                {{ $data->referral == 3 ? 'checked' : '' }} name="referral"
                                                value="3"> <label for="referralno">No</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="box box3">
                            <div class="col-item mb_30">
                                ...
                                <div class="select-area mtb_10">
                                    <ul>
                                        <li>
                                            <input id="technologyes" type="radio"
                                                {{ $data->technology == 1 ? 'checked' : '' }} name="technology"
                                                value="1"> <label for="technologyes">Yes</label>
                                        </li>
                                        <li>
                                            <input id="technologno" type="radio"
                                                {{ $data->technology == 2 ? 'checked' : '' }} name="technology"
                                                value="2"> <label for="technologno">No</label>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->anxtime)->format('H:i:s') }}"
                                                name="anxtime"></td>
                                    </tr>
                                    <tr>
                                        <td>Panic Attacks</td>
                                        ...
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->pantime)->format('H:i:s') }}"
                                                name="pantime"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->photime)->format('H:i:s') }}"
                                                name="photime"></td>
                                    </tr>
                                    <tr>
                                        <td>Obessive</td>
                                        <td><input type="text" value="{{ $data->obesstxt }}" name="obesstxt">
                                        </td>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->obesstime)->format('H:i:s') }}"
                                                name="obesstime"></td>
                                    </tr>
                                    <tr>
                                        <td>Somatization</td>
                                        ...
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->somatime)->format('H:i:s') }}"
                                                name="somatime"></td>
                                    </tr>
                                    <tr>
                                        <td>Depression</td>
                                        ...
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->deprtime)->format('H:i:s') }}"
                                                name="deprtime"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->impatime)->format('H:i:s') }}"
                                                name="impatime"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->poortime)->format('H:i:s') }}"
                                                name="poortime"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->inttime)->format('H:i:s') }}"
                                                name="inttime"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->dystime)->format('H:i:s') }}"
                                                name="dystime"></td>
                                    </tr>
                                    <tr>
                                        <td>Weight Change</td>
                                        <td><input type="text" value="{{ $data->weighttxt }}"
                                                name="weighttxt"></td>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->weighttime)->format('H:i:s') }}"
                                                name="weighttime"></td>
                                    </tr>
                                    <tr>
                                        <td>Bizarre Ideation</td>
                                        <td><input type="text" value="{{ $data->bizarrtxt }}"
                                                name="bizarrtxt"></td>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->bizarrtime)->format('H:i:s') }}"
                                                name="bizarrtime"></td>
                                    </tr>
                                    <tr>
                                        <td>Bizarre Behavior</td>
                                        <td><input type="text" value="{{ $data->bbtxt }}" name="bbtxt">
                                        </td>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->bbtime)->format('H:i:s') }}"
                                                name="bbtime"></td>
                                    </tr>
                                    <tr>
                                        <td>Paranoid Ideation</td>
                                        <td><input type="text" value="{{ $data->pitxt }}" name="pitxt">
                                        </td>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->pitime)->format('H:i:s') }}"
                                                name="pitime"></td>
                                    </tr>
                                    <tr>
                                        <td>Poor Judgment</td>
                                        <td><input type="text" value="{{ $data->pjtxt }}" name="pjtxt">
                                        </td>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->pjtime)->format('H:i:s') }}"
                                                name="pjtime"></td>
                                    </tr>
                                    <tr>
                                        <td>Poor Interpersonal Skills</td>
                                        <td><input type="text" value="{{ $data->pistxt }}" name="pistxt">
                                        </td>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->pistime)->format('H:i:s') }}"
                                                name="pistime"></td>
                                    </tr>
                                    <tr>
                                        <td>Conduct Problems</td>
                                        <td><input type="text" value="{{ $data->cptxt }}" name="cptxt">
                                        </td>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->cptime)->format('H:i:s') }}"
                                                name="cptime"></td>
                                    </tr>
                                    <tr>
                                        <td>School Problems</td>
                                        <td><input type="text" value="{{ $data->sptxt }}" name="sptxt">
                                        </td>
                                        ...
                                        ?>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->sptime)->format('H:i:s') }}"
                                                name="sptime"></td>
                                    </tr>
                                    <tr>
                                        <td>Family Problems</td>
                                        <td><input type="text" value="{{ $data->fptxt }}" name="fptxt">
                                        </td>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->fptime)->format('H:i:s') }}"
                                                name="fptime"></td>
                                    </tr>
                                    <tr>
                                        <td>Indep Living Problems</td>
                                        <td><input type="text" value="{{ $data->indetxt }}" name="indetxt">
                                        </td>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->indetime)->format('H:i:s') }}"
                                                name="indetime"></td>
                                    </tr>
                                    <tr>
                                        <td class="other">Other <input type="text"
                                                value="{{ $data->othr }}" name="othr"></td>
                                        <td><input type="text" value="{{ $data->othtxt }}" name="othtxt">
                                        </td>
                                        <td><input type="time"
                                                value="{{ \Carbon\Carbon::parse($data->othtime)->format('H:i:s') }}"
                                                name="othtime"></td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="box box3">
                            <div class="col-item ">
                                ...
                                <div class="select-area more-select">
                                    <ul>
                                        <li>
                                            <input id="rservices-1" type="checkbox"
                                                {{ $data->rscomm == 1 ? 'checked' : '' }} name="rscomm"
                                                value="1"> <label for="rservices-1">Community referrals made,
                                                no further services
                                                needed</label>
                                        </li>
                                        <li>
                                            <input id="rservices-2" type="checkbox"
                                                {{ $data->rsmed == 1 ? 'checked' : '' }} name="rsmed"
                                                value="1"> <label for="rservices-2">Medication
                                                assessment</label>
                                        </li>
                                        <li>
                                            <input id="rservices-3" type="checkbox"
                                                {{ $data->rsind == 1 ? 'checked' : '' }} name="rsind"
                                                value="1"> <label for="rservices-3">Individual therapy</label>
                                        </li>
                                        <li>
                                            <input id="rservices-4" type="checkbox"
                                                {{ $data->rsfam == 1 ? 'checked' : '' }} name="rsfam"
                                                value="1"> <label for="rservices-4">Family therapy</label>
                                        </li>
                                        <li>
                                            <input id="rservices-5" type="checkbox"
                                                {{ $data->rstesting == 1 ? 'checked' : '' }} name="rstesting"
                                                value="1"> <label for="rservices-5">Testing</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="rservices-6" type="checkbox"
                                                {{ $data->rscare == 1 ? 'checked' : '' }} name="rscare"
                                                value="1"> <label for="rservices-6">By primary care
                                                physician</label>
                                        </li>
                                        <li>
                                            <input id="rservices-7" type="checkbox"
                                                {{ $data->rsbtl == 1 ? 'checked' : '' }} name="rsbtl"
                                                value="1"> <label for="rservices-7">Brief therapy
                                                Long-term</label>
                                        </li>
                                        <li>
                                            <input id="rservices-8" type="checkbox"
                                                {{ $data->rscoll == 1 ? 'checked' : '' }} name="rscoll"
                                                value="1"> <label for="rservices-8">Collateral</label>
                                        </li>
                                        <li>
                                            <input id="rservices-9" type="checkbox"
                                                {{ $data->rsreha == 1 ? 'checked' : '' }} name="rsreha"
                                                value="1"> <label for="rservices-9">Day rehab/treatment</label>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input id="rservices-10" type="checkbox"
                                                {{ $data->rsasoc == 1 ? 'checked' : '' }} name="rsasoc"
                                                value="1"> <label for="rservices-10">By ASOC or CSOG
                                                psychiatrist</label>
                                        </li>
                                        <li>
                                            <input id="rservices-11" type="checkbox"
                                                {{ $data->rsltt == 1 ? 'checked' : '' }} name="rsltt"
                                                value="1"> <label for="rservices-11">Long-term therapy</label>
                                        </li>
                                        <li>
                                            <input id="rservices-12" type="checkbox"
                                                {{ $data->rsgrou == 1 ? 'checked' : '' }} name="rsgrou"
                                                value="1"> <label for="rservices-12">Group</label>
                                        </li>
                                        <li>
                                            <input id="rservices-13" type="checkbox"
                                                {{ $data->rsother == 1 ? 'checked' : '' }} name="rsother"
