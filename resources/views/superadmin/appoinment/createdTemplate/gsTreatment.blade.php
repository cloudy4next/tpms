                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="1"
                                                        {{ $data->task == 1 ? 'checked' : '' }}>Analyzing Data
                                        ...
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="2"
                                                        {{ $data->task == 2 ? 'checked' : '' }}>Modifying Program
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="3"
                                                        {{ $data->task == 3 ? 'checked' : '' }}>Modifying/Adding Goals
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="4"
                                                        {{ $data->task == 4 ? 'checked' : '' }}>Developing BIP
                                                </label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="task"
                                                        value="5"
                                                        {{ $data->task == 5 ? 'checked' : '' }}>Developing Plan
                                                </label>
                                            </div>
                                        </li>
                                    </ul>
