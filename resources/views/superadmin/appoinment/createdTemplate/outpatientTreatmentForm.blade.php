...
<body>
    <div class="out-patient-treatment">
        <div class="content">
            ...
            <form action="" method="POST" id="form_10">
                        ...
                        <div class="colitem-1 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="riskharm">{{ $data->riskharm }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="colitem-2 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="funcstatus">{{ $data->funcstatus }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="colitem-3 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="comorbid">{{ $data->comorbid }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="colitem-4 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="envstress">{{ $data->envstress }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="colitem-5 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="suppenv">{{ $data->suppenv }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="colitem-6 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="rescurr">{{ $data->rescurr }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="colitem-7 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="acceng">{{ $data->acceng }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="colitem-8 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="transp">{{ $data->transp }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="colitem-9 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="present">{{ $data->present }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="colitem-10 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="currtreat">{{ $data->currtreat }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="colitem-11 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="detail30">{{ $data->detail30 }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="colitem-12 column">
                            <div class="inner">
                                ...
                                <div>
                                    ...
                                    <div class="fill-area">
                                        <textarea placeholder="" rows="1" name="currmed">{{ $data->currmed }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="colitem-13 column">
                        <div class="inner">
                            ...
                            <div>
                                ...
                                <div class="fill-area">
                                    <textarea placeholder="" rows="1" name="treat">{{ $data->treat }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="section_bottom">
                    <div class="button-row flex-div">
                        <div class="save-prog">
                            <button type="submit"><span class="cloud-icon"><i class="fas fa-cloud"></i></span> Save
                            </button>
                        </div>
                        <div class="print">
            ...
            <form class="pdf_form" action="{{ route('superadmin.print.form.10') }}" target="_blank" method="POST">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_10', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('superadmin.10.form.submit') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
