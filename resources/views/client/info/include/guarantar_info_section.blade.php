<div class="col-md-12">
    ...
    <div class="form-check mb-2">
        <label class="form-check-label">
            <input type="checkbox" class="form-check-input is_gran" id="checkg" name="is_guarantor" value="1" {{$client_info->is_guarantor == 1 ? 'checked' : ''}} disabled>Is Guarantor Available?
        </label>
    </div>
    <div id="showg" class="client_gran_info">
        ...
        <div class="row">
            <div class="col-md-3 mb-2">
                ...
                <input type="text" class="form-control form-control-sm" name="guarantor_first_name" value="{{$garanter_info->guarantor_first_name}}" disabled>
            </div>
            <div class="col-md-3 mb-2">
                <label>Last Name</label>
                <input type="text" class="form-control form-control-sm" name="guarantor_last_name" value="{{$garanter_info->guarantor_last_name}}" disabled>
            </div>
            <div class="col-md-3 mb-2">
                <label>DOB</label>
                <input type="date" class="form-control form-control-sm" name="guarantor_dob" value="{{$garanter_info->guarantor_dob}}" disabled>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-3 mb-2">
                        <input type="text" class="form-control form-control-sm gstreet" name="g_street" value="{{$garanter_info->g_street}}" placeholder="Street" disabled>
                    </div>
                    <div class="col-md-9 mb-2">
                        <button type="button" class="btn btn-sm btn-secondary" id="save_client_address" disabled>Same as Patient Address</button>
                    </div>
                    <div class="col-md-3 mb-2">
                        <input type="text" class="form-control form-control-sm g_city" name="g_city" value="{{$garanter_info->g_city}}" placeholder="City" disabled>
                    </div>
                    <div class="col-md-2 mb-2 ">
                        <select class="g_state form-control form-control-sm" name="g_state" placeholder="State" disabled>
                            <optgroup label="-US">
                                <option></option>
                    ...
                    <div class="col-md-2 mb-2">
                        <input type="text" class="form-control form-control-sm g_zip" name="g_zip" value="{{$garanter_info->g_zip}}" placeholder="Zip" disabled>
                    </div>
                </div>
            </div>
        </div>
