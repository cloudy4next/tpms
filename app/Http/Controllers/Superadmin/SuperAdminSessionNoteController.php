...
use App\Http\Lib\extended;
use Illuminate\Support\Facades\Auth;
use Intervention\Image\Facades\Image;

class SuperAdminSessionNoteController extends Controller
{
    ...
    public function session_note_create($id)
    {
        $session = Appoinment::where('id', $id)->first();
        $client = Client::select('client_full_name')->where('id', $session->client_id)->first();
        $session_note_exits = Appoinment_note::where('appoinment_id', $session->id)->first();
        if ($session_note_exits) {
            $exist_session_note = $session_note_exits;
        } else {
            $exist_session_note = new Appoinment_note();
            $exist_session_note->appoinment_id = $session->id;
            $exist_session_note->client_id = $session->client_id;
            $exist_session_note->client_name = $client->client_full_name;
            $exist_session_note->save();
        }
        return view('superadmin.appoinment.sessionNoteCreate', compact('session', 'exist_session_note'));
    }
    ...
    public function session_note_open(Request $request)
    {
        ...
        if ($notes) {
            ...
            if ($notes->template_id == 1) {
                ...
                return view('superadmin.appoinment.template.uniqueSuperVisionForm', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 2) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.directServiceParentTrainingForm', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 3) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.bcbaTraineeSupervisionMonthlyForm', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 4) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.bcbaTraineeUniqueSupervisionForm', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 5) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.monthlySuperVisionForm', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 6) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.therapistSessionForm', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 7) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.clinicalTreatmentForm', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 8) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.treatmentPlan', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 9) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.privateClientForm', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 10) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.outpatientTreatmentForm', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 11) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.catalystNote', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 12) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.parentTraining', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 13) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.sessionNotes', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 14) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.supervisionRegistered1', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 15) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.supervisionRegistered2', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 16) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.servicePlan', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 17) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cpClinical', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 18) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cpNotes', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 19) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cpSoap', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 20) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.gsAssessment', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 21) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.gsParentTraining', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 22) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.gsSupervision', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 23) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.gsTreatment', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 24) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.biopsychosocial', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 25) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.birpProgress', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 26) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.dischargeSummary', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 27) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.languageProgress', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 28) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.languageSession', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 29) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.diagnosisSummary', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 30) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.dataSheet', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 31) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhBehaviorAssessment', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 32) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhBehaviorProgress', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 33) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhServiceVerification', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 34) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhCFARS', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 35) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhDischargeSummary', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 36) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhMedFlowsheet', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 37) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhNoShow', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 38) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhPCP', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 39) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhLocusWorksheet', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 40) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhReleaseInfo', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 41) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhBiopsychosocial', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 42) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhConsentTreat', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 43) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhFARS', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 44) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhMasterTreatment', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 45) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhMedConsent', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 46) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhMedManagement', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 47) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhProgressNote', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 48) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhPsychiatricEvaluation', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 49) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhPsychiatricABA', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 50) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhRiskAssessment', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 51) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhLocusScore', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 52) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhTreatmentPlan', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 53) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhSafetyPlanning', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 54) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.cbhMentalHealth', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 60) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.supervisionAndAssessment', compact('session_id', 'name_location', 'logo'));
            } elseif ($notes->template_id == 61) {
                $session_id = $request->from_session_id;
                return view('superadmin.appoinment.template.sessionNotesTwo', compact('session_id', 'name_location', 'logo'));
            } else {
                if ($notes->html_data == null) {
                    ...
                    $sign2 = null;
                    $check = "new";
                    return view('superadmin.settingDocuemts.formBuilderView', compact('data', 'session_id', 'form_id', 'title', 'logo', 'name_location', 'sign1', 'sign2', 'check'));
                }
            }
        } else {
            return back()->with('alert', 'Template Not Found');
    ...
    public function session_created_template_open(Request $request)
    {
        ...
        if ($request->created_note_id == 1) {
            ...
            return view('superadmin.appoinment.createdTemplate.uniqueSuperVisionForm', compact('session_id', 'form_one', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.directServiceParentTrainingForm', compact('session_id', 'form_two', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.bcbaTraineeSupervisionMonthlyForm', compact('session_id', 'form_three', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.bcbaTraineeUniqueSupervisionForm', compact('session_id', 'form_four', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.monthlySuperVisionForm', compact('session_id', 'form_five', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.therapistSessionForm', compact('session_id', 'form_six', 'name_location', 'logo'));
            ...
            $session_id = $request->created_from_session_id;
            return view('superadmin.appoinment.createdTemplate.clinicalTreatmentForm', compact('session_id', 'data', 'data2', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.treatmentPlan', compact('session_id', 'form_eight', 'name_location', 'logo'));
            ...
            $session_id = $request->created_from_session_id;
            return view('superadmin.appoinment.createdTemplate.privateClientForm', compact('session_id', 'name_location', 'logo', 'data', 'data2'));
            ...
            return view('superadmin.appoinment.createdTemplate.outpatientTreatmentForm', compact('session_id', 'name_location', 'logo', 'data'));
            ...
            return view('superadmin.appoinment.createdTemplate.catalystNote', compact('session_id', 'form_eleven', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.parentTraining', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.sessionNotes', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.supervisionRegistered1', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.supervisionRegistered2', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.servicePlan', compact('session_id', 'data', 'data2', 'data3', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.cpClinical', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.cpNotes', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.cpSoap', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.gsAssessment', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.gsParentTraining', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.gsSupervision', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.gsTreatment', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.biopsychosocial', compact('session_id', 'data', 'data2', 'data3', 'data4', 'data5', 'data6', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.birpProgress', compact('session_id', 'data', 'data2', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.dischargeSummary', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.languageProgress', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.languageSession', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.diagnosisSummary', compact('session_id', 'data', 'name_location', 'logo'));
            ...
            return view('superadmin.appoinment.createdTemplate.dataSheet', compact('session_id', 'data', 'data2', 'data3', 'data4', 'data5', 'data6', 'data7', 'data8', 'data9', 'data10', 'data11', 'data12', 'name_location', 'logo'));
            ...
            $obj = $data->data_obj;
            return view('superadmin.appoinment.createdTemplate.supervisionAndAssessment', compact('session_id', 'data', 'name_location', 'logo', 'obj'));
            ...
            $obj = $data->data_obj;
            return view('superadmin.appoinment.createdTemplate.sessionNotesTwo', compact('session_id', 'data', 'name_location', 'logo', 'obj'));
        } else {
    ...
    private function session_signatures($data, $request, $session_id)
    {
        ...
        if ($request->add_pro_sig) {
            if ($request->add_pro_sig == 1) {
                $pro_sig = Appoinment_signature::select('session_id', 'signature', 'user_type')->where('session_id', $session_id)->where('user_type', 2)->first();
                if ($pro_sig) {
        ...
        if ($request->add_care_sig) {
            // dd($care_sig);
            if ($request->add_care_sig == 1) {
                $care_sig = Appoinment_signature::select('session_id', 'signature', 'user_type')->where('session_id', $request->sessionid)->where('user_type', 1)->first();
                // dd($care_sig);
    ...
    public function cn_form_eleven_byajax(Request $request)
    {
        $form_eleven_ajax = cn_eleven_form::where('admin_id', $this->admin_id)->where('sessionid', $request->sessionid)->first();
        return response()->json($form_eleven_ajax, 200);
    }

    public function form_7_byajax(Request $request)
    {
        $data = ct_seven_form::where('admin_id', $this->admin_id)->where('sessionid', $request->sessionid)->first();
        return response()->json($data, 200);
    }


    public function form_12_byajax(Request $request)
    {
        $data = pt_twelve_form::where('admin_id', $this->admin_id)->where('sessionid', $request->sessionid)->first();
        return response()->json($data, 200);
    }

    public function form_13_byajax(Request $request)
    {
        $data = sn_thirteen_form::where('admin_id', $this->admin_id)->where('sessionid', $request->sessionid)->first();
        return response()->json($data, 200);
    }

    public function form_14_byajax(Request $request)
    {
        $data = register_fourteen_form::where('admin_id', $this->admin_id)->where('sessionid', $request->sessionid)->first();
        return response()->json($data, 200);
    }

    public function form_15_byajax(Request $request)
    {
        $data = register2_fifteen_form::where('admin_id', $this->admin_id)->where('sessionid', $request->sessionid)->first();
        return response()->json($data, 200);
    }

    public function form_16_byajax(Request $request)
    {
        $data = sp_sixteen_form::where('admin_id', $this->admin_id)->where('sessionid', $request->sessionid)->first();
        return response()->json($data, 200);
    }


    public function session_note_create_save(Request $request)
    {

        return $request->note_id;
        //        $new_session_note = Appoinment_note::where('id',$request->session_id)->first();
        //        if ($new_session_note) {
        //            $new_session_note->client_name = $request->client_name;
        //            $new_session_note->note_date = $request->note_date;
        //            $new_session_note->initial = $request->initial;
        //            $new_session_note->ongoing = $request->ongoing;
        //            $new_session_note->goal1 = $request->goal1;
        //            $new_session_note->goal1_odate = $request->goal1_odate;
        //            $new_session_note->goal1_tdate = $request->goal1_tdate;
        //            $new_session_note->goal1_obj = $request->goal1_obj;
        //            $new_session_note->goal1_int = $request->goal1_int;
        //            $new_session_note->goal2 = $request->goal2;
        //            $new_session_note->goal2_odate = $request->goal2_odate;
        //            $new_session_note->goal2_tdate = $request->goal2_tdate;
        //            $new_session_note->goal2_obj = $request->goal2_obj;
        //            $new_session_note->goal2_int = $request->goal2_int;
        //            $new_session_note->goal3 = $request->goal3;
        //            $new_session_note->goal3_odate = $request->goal3_odate;
        //            $new_session_note->goal3_tdate = $request->goal3_tdate;
        //            $new_session_note->goal3_obj = $request->goal3_obj;
        //            $new_session_note->goal3_int = $request->goal3_int;
        //            $new_session_note->goal4 = $request->goal4;
        //            $new_session_note->goal4_odate = $request->goal4_odate;
        //            $new_session_note->goal4_tdate = $request->goal4_tdate;
        //            $new_session_note->goal4_obj = $request->goal4_obj;
        //            $new_session_note->goal4_int = $request->goal4_int;
        //            $new_session_note->save();
        //
        //            return back()->with('success','Session Note Successfully Created');
        //        }else{
        //            return back()->with('alert','Session Note Not Found');
        //        }


    }

    public function session_note_view($id)
    {

        $session_data = Appoinment_note::where('id', $id)->first();
        $image = public_path('assets/dashboard/images/client/statement.png');
        $pdf = new extended();
        $pdf->AddPage();
        $pdf->SetXY(5, 10);
        $pdf->SetTextColor(32, 122, 199);
        $pdf->Cell(0, 0, 'TREATMENT PLAN', 0, 1, 'R');
        $pdf->SetTextColor(0, 0, 0);
        $pdf->Image($image, 10, 7, 50, 14);

        $pdf->SetXY(10, 35);
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Cell(32, 5, 'Client Name:', 0, 1);

        $pdf->SetXY(42, 35);
        $pdf->SetFont('Arial', '', 14);
        $pdf->Cell(63, 5, $session_data->client_name, 0, 1);

        $pdf->SetXY(105, 35);
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Cell(14, 5, 'Date:', 0, 1);

        $pdf->SetXY(119, 35);
        $pdf->SetFont('Arial', '', 14);
        $pdf->Cell(81, 5, Carbon::parse($session_data->note_date)->format('m/d/Y'), 0, 1);

        $pdf->SetXY(10, 45);
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Cell(58, 5, 'Type of Treatment Plan:', 0, 1);

        $pdf->SetXY(68, 45);
        $pdf->SetFont('Arial', '', 14);
        $pdf->Cell(132, 5, $session_data->initial, 0, 1);

        //***********************************************Goal 1 Section Start
        ...
        $y = $pdf->GetY();
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Cell(28, 5, 'Open date:', 0, 0);
        $pdf->SetFont('Arial', '', 14);
        $pdf->Cell(65, 5, Carbon::parse($session_data->goal1_odate)->format('m/d/Y'), 0);
        //Target Date
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Cell(30, 5, 'Target date:', 0, 0);
        $pdf->SetFont('Arial', '', 14);
        $pdf->Cell(63, 5, Carbon::parse($session_data->goal1_tdate)->format('m/d/Y'), 0, 0);
        ...
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Ln(2);
        $pdf->Cell(18, 5, 'Goal 1:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal1);
        $pdf->MultiCell(186, 5, $session_data->goal1);
        $pdf->Heading($sign, 'Goal 1:');
        ...
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Ln(2);
        $pdf->Cell(0, 5, 'Objective 1:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal1_obj);
        $pdf->MultiCell(186, 5, $session_data->goal1_obj);
        $pdf->Heading($sign, 'Objective 1:');
        ...
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Ln(2);
        $pdf->Cell(0, 5, 'Intervention 1:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal1_int);
        $pdf->MultiCell(186, 5, $session_data->goal1_int);
        $pdf->Heading($sign, 'Intervention 1:');

        $pdf->DrawBoldLine();


        //************************************************Goal 2 Section Start
        ...
        $pdf->Cell(28, 5, 'Open date:', 0, 0);
        $pdf->SetFont('Arial', '', 14);
        $pdf->Cell(65, 5, Carbon::parse($session_data->goal2_odate)->format('m/d/Y'), 0);
        //Target Date
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Cell(30, 5, 'Target date:', 0, 0);
        $pdf->SetFont('Arial', '', 14);
        $pdf->Cell(63, 5, Carbon::parse($session_data->goal2_tdate)->format('m/d/Y'), 0, 0);
        ...
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Ln(2);
        $pdf->Cell(18, 5, 'Goal 2:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal2);
        $pdf->MultiCell(186, 5, $session_data->goal2);
        $pdf->Heading($sign, 'Goal 1:');
        ...
        $pdf->Cell(0, 5, 'Objective 1:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal2_obj);
        $pdf->MultiCell(186, 5, $session_data->goal2_obj);
        $pdf->Heading($sign, 'Objective 1:');
        ...
        $pdf->Cell(0, 5, 'Intervention 1:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal2_int);
        $pdf->MultiCell(186, 5, $session_data->goal2_int);
        $pdf->Heading($sign, 'Intervention 1:');

        $pdf->DrawBoldLine();

        //****************************************Goal 3 Section Start
        ...
        $pdf->Cell(28, 5, 'Open date:', 0, 0);
        $pdf->SetFont('Arial', '', 14);
        $pdf->Cell(65, 5, Carbon::parse($session_data->goal3_odate)->format('m/d/Y'), 0);
        //Target Date
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Cell(30, 5, 'Target date:', 0, 0);
        $pdf->SetFont('Arial', '', 14);
        $pdf->Cell(63, 5, Carbon::parse($session_data->goal3_odate)->format('m/d/Y'), 0, 0);
        ...
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Ln(2);
        $pdf->Cell(18, 5, 'Goal 3:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal3);
        $pdf->MultiCell(186, 5, $session_data->goal3);
        $pdf->Heading($sign, 'Goal 1:');
        ...
        $pdf->Cell(0, 5, 'Objective 1:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal3_obj);
        $pdf->MultiCell(186, 5, $session_data->goal3_obj);
        $pdf->Heading($sign, 'Objective 1:');
        ...
        $pdf->Cell(0, 5, 'Intervention 1:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal3_int);
        $pdf->MultiCell(186, 5, $session_data->goal3_int);
        $pdf->Heading($sign, 'Intervention 1:');

        $pdf->DrawBoldLine();

        //**********************************Goal 4 Section Start
        ...
        $pdf->Cell(28, 5, 'Open date:', 0, 0);
        $pdf->SetFont('Arial', '', 14);
        $pdf->Cell(65, 5, Carbon::parse($session_data->goal4_odate)->format('m/d/Y'), 0);
        //Target Date
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Cell(30, 5, 'Target date:', 0, 0);
        $pdf->SetFont('Arial', '', 14);
        $pdf->Cell(63, 5, Carbon::parse($session_data->goal4_tdate)->format('m/d/Y'), 0, 0);
        ...
        $pdf->SetFont('Arial', 'B', 14);
        $pdf->Ln(2);
        $pdf->Cell(18, 5, 'Goal 4:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal4);
        $pdf->MultiCell(186, 5, $session_data->goal4);
        $pdf->Heading($sign, 'Goal 1:');
        ...
        $pdf->Cell(0, 5, 'Objective 1:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal4_obj);
        $pdf->MultiCell(186, 5, $session_data->goal4_obj);
        $pdf->Heading($sign, 'Objective 1:');
        ...
        $pdf->Cell(0, 5, 'Intervention 1:', 0, 1);
        $pdf->SetFont('Arial', '', 14);
        $sign = $pdf->HeightCalculator(186, 5, $session_data->goal4_int);
        $pdf->MultiCell(186, 5, $session_data->goal4_int);
        $pdf->Heading($sign, 'Intervention 1:');
