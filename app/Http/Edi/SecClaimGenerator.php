...
class SecClaimGenerator
{
    ...
    function GenerateCharge($CH, $CLM)
    {
        ...
        if ($CLM->ClaimType == 'S') {
            $ChargeSTR .= 'SVD' . $E . $CLM->OtherPayerID . $E .
                $CH->PrimaryPaidAmt . $E . 'HC' . $C . $CH->PrimaryCPT;
